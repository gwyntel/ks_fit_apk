...
public final class FormBody extends RequestBody {
    ...
    public static final class Builder {
        ...
        public Builder add(String str, String str2) {
            ...
            this.names.add(HttpUrl.c(str, " \"':;<=>@[]^`{}|/\\?#&!$(),~", false, false, true, true, this.charset));
            this.values.add(HttpUrl.c(str2, " \"':;<=>@[]^`{}|/\\?#&!$(),~", false, false, true, true, this.charset));
            return this;
        }
        ...
        public Builder addEncoded(String str, String str2) {
            ...
            this.names.add(HttpUrl.c(str, " \"':;<=>@[]^`{}|/\\?#&!$(),~", true, false, true, true, this.charset));
            this.values.add(HttpUrl.c(str2, " \"':;<=>@[]^`{}|/\\?#&!$(),~", true, false, true, true, this.charset));
            return this;
        }
    ...
    private long writeOrCountBytes(@Nullable BufferedSink bufferedSink, boolean z2) {
    ...
    public String name(int i2) {
        return HttpUrl.h(encodedName(i2), true);
    }
    ...
    public String value(int i2) {
        return HttpUrl.h(encodedValue(i2), true);
    }
