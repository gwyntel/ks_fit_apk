...
class Huffman {
    ...
    private void addCode(int i2, int i3, byte b2) {
        ...
        while (b2 > 8) {
            ...
            node2 = node2.f26425a[i4];
        }
        int i5 = 8 - b2;
        int i6 = (i3 << i5) & 255;
        int i7 = 1 << i5;
        for (int i8 = i6; i8 < i6 + i7; i8++) {
            node2.f26425a[i8] = node;
        }
    }
    ...
    byte[] a(byte[] bArr) {
        ...
        for (byte b2 : bArr) {
            ...
            i3 += 8;
            while (i3 >= 8) {
                node = node.f26425a[(i2 >>> (i3 - 8)) & 255];
                if (node.f26425a == null) {
                    byteArrayOutputStream.write(node.f26426b);
                    i3 -= node.f26427c;
                    node = this.root;
                } else {
                    i3 -= 8;
        ...
        while (i3 > 0) {
            Node node2 = node.f26425a[(i2 << (8 - i3)) & 255];
            if (node2.f26425a != null || node2.f26427c > i3) {
                break;
            }
            byteArrayOutputStream.write(node2.f26426b);
            i3 -= node2.f26427c;
            node = this.root;
        }
    ...
    void b(ByteString byteString, BufferedSink bufferedSink) throws IOException {
        long j2 = 0;
        int i2 = 0;
