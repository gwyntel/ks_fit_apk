...
public class Base64 extends BaseNCodec {
    ...
    static final byte[] f26560h = {13, 10};
    ...
    void c(byte[] bArr, int i2, int i3) {
        ...
        if (!this.f26565e || this.f26567g == 0) {
            return;
        }
        e(this.decodeSize);
        int i11 = this.f26567g;
        if (i11 == 2) {
    ...
    void d(byte[] bArr, int i2, int i3) {
        ...
        int i26 = this.f26566f;
        int i27 = this.f26564d;
        int i28 = i26 + (i27 - i16);
        this.f26566f = i28;
        if (this.f26562b <= 0 || i28 <= 0) {
            return;
        }
        byte[] bArr9 = this.lineSeparator;
        System.arraycopy(bArr9, 0, this.f26563c, i27, bArr9.length);
        this.f26564d += this.lineSeparator.length;
    }
    ...
    public static byte[] encodeBase64(byte[] bArr, boolean z2, boolean z3, int i2) {
        ...
        Base64 base64 = z2 ? new Base64(z3) : new Base64(0, f26560h, z3);
