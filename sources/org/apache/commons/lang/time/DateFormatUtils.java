...
public class DateFormatUtils {
    ...
    public static final FastDateFormat ISO_DATE_FORMAT = FastDateFormat.getInstance(CalendarUtils.yyyy_MM_dd);
    ...
    public static String formatUTC(long j2, String str) {
        return format(new Date(j2), str, DateUtils.UTC_TIME_ZONE, (Locale) null);
    }
    ...
    public static String formatUTC(long j2, String str, Locale locale) {
        return format(new Date(j2), str, DateUtils.UTC_TIME_ZONE, locale);
    }
