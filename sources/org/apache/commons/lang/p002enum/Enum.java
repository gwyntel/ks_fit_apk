...
public abstract class Enum implements Comparable, Serializable {
    ...
    private static class Entry {
        ...
        protected Entry() {
            ...
            this.f26626a = map;
            this.f26627b = Collections.unmodifiableMap(map);
            ArrayList arrayList = new ArrayList(25);
            this.f26628c = arrayList;
            this.f26629d = Collections.unmodifiableList(arrayList);
        }
    }
    ...
    private static Entry createEntry(Class cls) {
        ...
        while (true) {
            ...
            if (entry2 != null) {
                entry.f26628c.addAll(entry2.f26628c);
                entry.f26626a.putAll(entry2.f26626a);
                break;
            }
    ...
    private void init(String str) {
        ...
        for (Class<?> superclass = getClass(); superclass != null; superclass = superclass.getSuperclass()) {
            ...
            if (superclass == enumClass) {
                ...
                if (!entryCreateEntry.f26626a.containsKey(str)) {
                    entryCreateEntry.f26626a.put(str, this);
                    entryCreateEntry.f26628c.add(this);
                    return;
                } else {
    ...
    protected Object readResolve() {
        ...
        return entry.f26626a.get(getName());
    }
