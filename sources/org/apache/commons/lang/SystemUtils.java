...
public class SystemUtils {
    ...
    static {
        ...
        boolean z2 = true;
        boolean z3 = getOSMatchesName("Linux") || getOSMatchesName("LINUX");
        IS_OS_LINUX = z3;
        ...
        IS_OS_WINDOWS_2000 = getOSMatches(OS_NAME_WINDOWS_PREFIX, DispatchConstants.VER_CODE);
    ...
    private static boolean getOSMatches(String str, String str2) {
        return b(OS_NAME, OS_VERSION, str, str2);
    }

    private static boolean getOSMatchesName(String str) {
        return c(OS_NAME, str);
    }
    ...
    private static int[] toJavaVersionIntArray(String str, int i2) {
        if (str == null) {
            return ArrayUtils.EMPTY_INT_ARRAY;
        }
        String[] strArrSplit = StringUtils.split(str, "._- ");
        int iMin = Math.min(i2, strArrSplit.length);
        int[] iArr = new int[iMin];
        int i3 = 0;
        for (int i4 = 0; i4 < strArrSplit.length && i3 < i2; i4++) {
