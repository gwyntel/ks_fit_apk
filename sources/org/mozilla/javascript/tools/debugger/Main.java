...
public class Main {
    ...
    private static class IProxy implements Runnable, ScopeProvider {
        ...
        public Scriptable getScope() throws RuntimeException {
            if (this.type != 2) {
                Kit.codeBug();
            }
            if (this.scope == null) {
    ...
    public void setBreakOnEnter(boolean z2) {
        this.dim.setBreakOnEnter(z2);
        this.debugGui.getMenubar().getBreakOnEnter().setSelected(z2);
    }

    public void setBreakOnExceptions(boolean z2) {
        this.dim.setBreakOnExceptions(z2);
        this.debugGui.getMenubar().getBreakOnExceptions().setSelected(z2);
    }

    public void setBreakOnReturn(boolean z2) {
        this.dim.setBreakOnReturn(z2);
        this.debugGui.getMenubar().getBreakOnReturn().setSelected(z2);
    }
