...
public class CachedPowers {
    ...
    static class CachedPower {
        ...
        CachedPower(long j2, short s2, short s3) {
            this.significand = j2;
    ...
    static int getCachedPower(int i2, int i3, int i4, DiyFp diyFp) {
        CachedPower cachedPower = CACHED_POWERS[((((int) Math.ceil(((i3 - i2) + 63) * kD_1_LOG2_10)) + 307) / 8) + 1];
