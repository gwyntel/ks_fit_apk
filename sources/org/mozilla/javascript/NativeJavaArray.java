...
public class NativeJavaArray extends NativeJavaObject {
    ...
    @Override // org.mozilla.javascript.NativeJavaObject, org.mozilla.javascript.Scriptable
    public void put(int i2, Scriptable scriptable, Object obj) throws ArrayIndexOutOfBoundsException, IllegalArgumentException {
    ...
    @Override // org.mozilla.javascript.NativeJavaObject, org.mozilla.javascript.Scriptable
    public Object get(int i2, Scriptable scriptable) throws ArrayIndexOutOfBoundsException, IllegalArgumentException {
        if (i2 >= 0 && i2 < this.length) {
