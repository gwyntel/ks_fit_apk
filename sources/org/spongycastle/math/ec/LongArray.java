...
public class LongArray implements Cloneable {
    ...
    public static void add(long[] jArr, int i2, long[] jArr2, int i3, int i4) {
    ...
    public static void addBoth(long[] jArr, int i2, long[] jArr2, int i3, long[] jArr3, int i4, int i5) {
    ...
    public static long addShiftedDown(long[] jArr, int i2, long[] jArr2, int i3, int i4, int i5) {
        int i6 = 64 - i5;
        long j2 = 0;
        while (true) {
            i4--;
    ...
    public static long addShiftedUp(long[] jArr, int i2, long[] jArr2, int i3, int i4, int i5) {
        int i6 = 64 - i5;
        long j2 = 0;
    ...
    public static void distribute(long[] jArr, int i2, int i3, int i4, int i5) {
        for (int i6 = 0; i6 < i5; i6++) {
            long j2 = jArr[i2 + i6];
            int i7 = i3 + i6;
            jArr[i7] = jArr[i7] ^ j2;
    ...
    public static void flipBit(long[] jArr, int i2, int i3) {
        int i4 = i2 + (i3 >>> 6);
        jArr[i4] = jArr[i4] ^ (1 << (i3 & 63));
    }

    public static void flipVector(long[] jArr, int i2, long[] jArr2, int i3, int i4, int i5) {
        int i6 = i2 + (i5 >>> 6);
        int i7 = i5 & 63;
        if (i7 == 0) {
    ...
    public static void flipWord(long[] jArr, int i2, int i3, long j2) {
        int i4 = i2 + (i3 >>> 6);
        int i5 = i3 & 63;
        if (i5 == 0) {
            jArr[i4] = jArr[i4] ^ j2;
    ...
    public static void interleave(long[] jArr, int i2, long[] jArr2, int i3, int i4, int i5) {
        if (i5 == 3) {
    ...
    public static long interleave2_32to64(int i2) {
        short[] sArr = INTERLEAVE2_TABLE;
        return ((sArr[i2 & 255] | (sArr[(i2 >>> 8) & 255] << 16)) & 4294967295L) | ((((sArr[i2 >>> 24] << 16) | sArr[(i2 >>> 16) & 255]) & 4294967295L) << 32);
    }

    public static void interleave2_n(long[] jArr, int i2, long[] jArr2, int i3, int i4, int i5) {
        for (int i6 = 0; i6 < i4; i6++) {
            jArr2[i3 + i6] = interleave2_n(jArr[i2 + i6], i5);
        }
    }

    public static void interleave3(long[] jArr, int i2, long[] jArr2, int i3, int i4) {
        for (int i5 = 0; i5 < i4; i5++) {
            jArr2[i3 + i5] = interleave3(jArr[i2 + i5]);
        }
    }

    public static long interleave3_13to65(int i2) {
        return (INTERLEAVE5_TABLE[i2 & 127] & 4294967295L) | ((r0[i2 >>> 7] & 4294967295L) << 35);
    }

    public static long interleave3_21to63(int i2) {
        return (INTERLEAVE3_TABLE[i2 & 127] & 4294967295L) | ((r0[i2 >>> 14] & 4294967295L) << 42) | ((r0[(i2 >>> 7) & 127] & 4294967295L) << 21);
    }

    public static long interleave4_16to64(int i2) {
        return (INTERLEAVE4_TABLE[i2 & 255] & 4294967295L) | ((r0[i2 >>> 8] & 4294967295L) << 32);
    }

    public static void interleave5(long[] jArr, int i2, long[] jArr2, int i3, int i4) {
        for (int i5 = 0; i5 < i4; i5++) {
            jArr2[i3 + i5] = interleave5(jArr[i2 + i5]);
        }
    }

    public static void interleave7(long[] jArr, int i2, long[] jArr2, int i3, int i4) {
        for (int i5 = 0; i5 < i4; i5++) {
            jArr2[i3 + i5] = interleave7(jArr[i2 + i5]);
        }
    }

    public static void multiplyWord(long j2, long[] jArr, int i2, long[] jArr2, int i3) {
        if ((j2 & 1) != 0) {
    ...
    public static void reduceBit(long[] jArr, int i2, int i3, int i4, int[] iArr) {
        flipBit(jArr, i2, i3);
        int i5 = i3 - i4;
    ...
    public static void reduceBitWise(long[] jArr, int i2, int i3, int i4, int[] iArr) {
        while (true) {
            i3--;
            if (i3 < i4) {
                return;
    ...
    public static int reduceInPlace(long[] jArr, int i2, int i3, int i4, int[] iArr) {
        int i5 = (i4 + 63) >>> 6;
        if (i3 < i5) {
            return i3;
        }
    ...
    public static LongArray reduceResult(long[] jArr, int i2, int i3, int i4, int[] iArr) {
        return new LongArray(jArr, i2, reduceInPlace(jArr, i2, i3, i4, iArr));
    }

    public static void reduceVectorWise(long[] jArr, int i2, int i3, int i4, int i5, int[] iArr) {
        int i6 = (i4 << 6) - i5;
        int length = iArr.length;
        while (true) {
            length--;
    ...
    public static void reduceWord(long[] jArr, int i2, int i3, long j2, int i4, int[] iArr) {
        int i5 = i3 - i4;
        int length = iArr.length;
        while (true) {
            length--;
    ...
    public static void reduceWordWise(long[] jArr, int i2, int i3, int i4, int i5, int[] iArr) {
        int i6 = i4 >>> 6;
        int i7 = i3;
        while (true) {
            int i8 = i7 - 1;
    ...
    public static long shiftUp(long[] jArr, int i2, int i3, int i4) {
        int i5 = 64 - i4;
        long j2 = 0;
    ...
    public static void squareInPlace(long[] jArr, int i2, int i3, int[] iArr) {
        int i4 = i2 << 1;
        while (true) {
            i2--;
            if (i2 < 0) {
    ...
    public static boolean testBit(long[] jArr, int i2, int i3) {
    ...
    public Object clone() {
        return new LongArray(c.a.d.a.a(this.m_ints));
    }
    ...
    public LongArray modMultiply(LongArray longArray, int i2, int[] iArr) {
        ...
        while (i18 < i8) {
            ...
            while (true) {
                i5 = i17;
                i6 = i18;
                addBoth(jArr7, i19, jArr4, iArr2[((int) j3) & 15], jArr5, iArr2[((int) (j3 >>> 4)) & 15], i11);
                j3 >>>= 8;
                if (j3 == 0) {
                    break;
                }
    ...
    public LongArray modReduce(int i2, int[] iArr) {
        long[] jArrA = c.a.d.a.a(this.m_ints);
        return new LongArray(jArrA, 0, reduceInPlace(jArrA, 0, jArrA.length, i2, iArr));
    }
    ...
    public static void add(long[] jArr, int i2, long[] jArr2, int i3, long[] jArr3, int i4, int i5) {
        for (int i6 = 0; i6 < i5; i6++) {
            jArr3[i4 + i6] = jArr[i2 + i6] ^ jArr2[i3 + i6];
        }
    }

    public static long interleave2_n(long j2, int i2) {
        while (i2 > 1) {
            i2 -= 2;
    ...
    public static long interleave3(long j2) {
    ...
    public static long interleave5(long j2) {
    ...
    public static long interleave7(long j2) {
    ...
    public static long shiftUp(long[] jArr, int i2, long[] jArr2, int i3, int i4, int i5) {
        int i6 = 64 - i5;
        long j2 = 0;
        for (int i7 = 0; i7 < i4; i7++) {
            long j3 = jArr[i2 + i7];
