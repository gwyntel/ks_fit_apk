...
public class DiscoverEndomorphisms {
    ...
    public static BigInteger[] extEuclidBezout(BigInteger[] bigIntegerArr) {
        ...
        while (bigInteger7.compareTo(ECConstants.ONE) > 0) {
            ...
            BigInteger bigIntegerSubtract = bigInteger6.subtract(bigInteger9.multiply(bigInteger4));
            BigInteger bigIntegerSubtract2 = bigInteger5.subtract(bigInteger9.multiply(bigInteger3));
            BigInteger bigInteger11 = bigInteger7;
            bigInteger7 = bigInteger10;
            bigInteger8 = bigInteger11;
            bigInteger5 = bigInteger3;
            bigInteger3 = bigIntegerSubtract2;
    ...
    public static ECFieldElement[] findBetaValues(ECCurve eCCurve) {
        ...
        do {
            ...
            bigIntegerModPow = b.a(bigInteger, characteristic.subtract(bigInteger), secureRandom).modPow(bigIntegerDivide, characteristic);
    ...
    public static BigInteger[] solveQuadraticEquation(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3) {
    ...
    public static void printGLVTypeBParameters(X9ECParameters x9ECParameters, BigInteger bigInteger, ECFieldElement[] eCFieldElementArr) {
        ...
        if (eCPointNormalize.getYCoord().equals(eCPointNormalize2.getYCoord())) {
            ...
            printProperty(c.f9865c, "{ " + bigIntegerArr[0].toString(16) + ", " + bigIntegerArr[1].toString(16) + " }");
