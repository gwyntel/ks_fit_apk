...
public class FragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
    ...
    static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            return "FragmentTabHost.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " curTab=" + this.f4226a + com.alipay.sdk.m.u.i.f9804d;
        }
    ...
    private FragmentTransaction doTabChanged(@Nullable String str, @Nullable FragmentTransaction fragmentTransaction) {
        ...
        if (this.mLastTab != tabInfoForTag) {
            ...
            if (tabInfo != null && (fragment = tabInfo.f4230d) != null) {
                fragmentTransaction.detach(fragment);
            }
            if (tabInfoForTag != null) {
                Fragment fragment2 = tabInfoForTag.f4230d;
                if (fragment2 == null) {
                    Fragment fragmentInstantiate = this.mFragmentManager.getFragmentFactory().instantiate(this.mContext.getClassLoader(), tabInfoForTag.f4228b.getName());
                    tabInfoForTag.f4230d = fragmentInstantiate;
                    fragmentInstantiate.setArguments(tabInfoForTag.f4229c);
                    fragmentTransaction.add(this.mContainerId, tabInfoForTag.f4230d, tabInfoForTag.f4227a);
                } else {
    ...
    public void addTab(@NonNull TabHost.TabSpec tabSpec, @NonNull Class<?> cls, @Nullable Bundle bundle) {
        ...
        if (this.mAttached) {
            ...
            tabInfo.f4230d = fragmentFindFragmentByTag;
            if (fragmentFindFragmentByTag != null && !fragmentFindFragmentByTag.isDetached()) {
                ...
                fragmentTransactionBeginTransaction.detach(tabInfo.f4230d);
    ...
    protected void onAttachedToWindow() {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            TabInfo tabInfo = this.mTabs.get(i2);
            Fragment fragmentFindFragmentByTag = this.mFragmentManager.findFragmentByTag(tabInfo.f4227a);
            tabInfo.f4230d = fragmentFindFragmentByTag;
            if (fragmentFindFragmentByTag != null && !fragmentFindFragmentByTag.isDetached()) {
                if (tabInfo.f4227a.equals(currentTabTag)) {
    ...
    protected void onRestoreInstanceState(Parcelable parcelable) {
        ...
        setCurrentTabByTag(savedState.f4226a);
    }

    @Override // android.view.View
    protected Parcelable onSaveInstanceState() {
        SavedState savedState = new SavedState(super.onSaveInstanceState());
        savedState.f4226a = getCurrentTabTag();
        return savedState;
    }
