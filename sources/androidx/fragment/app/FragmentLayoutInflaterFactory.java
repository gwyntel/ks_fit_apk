...
class FragmentLayoutInflaterFactory implements LayoutInflater.Factory2 {
    ...
    public View onCreateView(@Nullable View view, @NonNull String str, @NonNull Context context, @NonNull AttributeSet attributeSet) {
        final FragmentStateManager fragmentStateManagerQ;
        if (FragmentContainerView.class.getName().equals(str)) {
            return new FragmentContainerView(context, attributeSet, this.f4169a);
        }
        ...
        Fragment fragmentFindFragmentById = resourceId != -1 ? this.f4169a.findFragmentById(resourceId) : null;
        if (fragmentFindFragmentById == null && string != null) {
            fragmentFindFragmentById = this.f4169a.findFragmentByTag(string);
        }
        if (fragmentFindFragmentById == null && id != -1) {
            fragmentFindFragmentById = this.f4169a.findFragmentById(id);
        }
        if (fragmentFindFragmentById == null) {
            fragmentFindFragmentById = this.f4169a.getFragmentFactory().instantiate(context.getClassLoader(), attributeValue);
            ...
            FragmentManager fragmentManager = this.f4169a;
            fragmentFindFragmentById.mFragmentManager = fragmentManager;
            fragmentFindFragmentById.mHost = fragmentManager.getHost();
            fragmentFindFragmentById.onInflate(this.f4169a.getHost().b(), attributeSet, fragmentFindFragmentById.mSavedFragmentState);
            fragmentStateManagerQ = this.f4169a.j(fragmentFindFragmentById);
        ...
        fragmentStateManagerQ.l();
        fragmentStateManagerQ.j();
        ...
        fragmentFindFragmentById.mView.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: androidx.fragment.app.FragmentLayoutInflaterFactory.1
            ...
            public void onViewAttachedToWindow(View view3) {
                Fragment fragmentK = fragmentStateManagerQ.k();
                fragmentStateManagerQ.l();
                SpecialEffectsController.getOrCreateController((ViewGroup) fragmentK.mView.getParent(), FragmentLayoutInflaterFactory.this.f4169a).forceCompleteAllOperations();
            }
