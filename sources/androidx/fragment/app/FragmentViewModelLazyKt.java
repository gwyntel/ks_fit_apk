...
public final class FragmentViewModelLazyKt {
    ...
    public static final class C02902 extends Lambda implements Function0<ViewModelStore> {
        final /* synthetic */ Lazy<ViewModelStoreOwner> $owner$delegate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C02902(Lazy<? extends ViewModelStoreOwner> lazy) {
            super(0);
        ...
        @NotNull
        public final ViewModelStore invoke() {
            return FragmentViewModelLazyKt.m12viewModels$lambda0(this.$owner$delegate).getViewModelStore();
        }
    }
    ...
    public static final class C02913 extends Lambda implements Function0<CreationExtras> {
        final /* synthetic */ Lazy<ViewModelStoreOwner> $owner$delegate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C02913(Lazy<? extends ViewModelStoreOwner> lazy) {
            super(0);
            this.$owner$delegate = lazy;
        }
        ...
        public final CreationExtras invoke() {
            ...
            ViewModelStoreOwner viewModelStoreOwnerM12viewModels$lambda0 = FragmentViewModelLazyKt.m12viewModels$lambda0(this.$owner$delegate);
            HasDefaultViewModelProviderFactory hasDefaultViewModelProviderFactory = viewModelStoreOwnerM12viewModels$lambda0 instanceof HasDefaultViewModelProviderFactory ? (HasDefaultViewModelProviderFactory) viewModelStoreOwnerM12viewModels$lambda0 : null;
    ...
    public static final class C02924 extends Lambda implements Function0<ViewModelProvider.Factory> {
        final /* synthetic */ Lazy<ViewModelStoreOwner> $owner$delegate;
        final /* synthetic */ Fragment $this_viewModels;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C02924(Fragment fragment, Lazy<? extends ViewModelStoreOwner> lazy) {
            super(0);
    ...
    public static final class C02946 extends Lambda implements Function0<ViewModelStore> {
        final /* synthetic */ Lazy<ViewModelStoreOwner> $owner$delegate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C02946(Lazy<? extends ViewModelStoreOwner> lazy) {
            super(0);
            this.$owner$delegate = lazy;
        }
        ...
        @NotNull
        public final ViewModelStore invoke() {
            return FragmentViewModelLazyKt.m13viewModels$lambda1(this.$owner$delegate).getViewModelStore();
        }
    }
    ...
    public static final class AnonymousClass7 extends Lambda implements Function0<CreationExtras> {
        ...
        public final CreationExtras invoke() {
            ...
            ViewModelStoreOwner viewModelStoreOwnerM13viewModels$lambda1 = FragmentViewModelLazyKt.m13viewModels$lambda1(this.$owner$delegate);
            HasDefaultViewModelProviderFactory hasDefaultViewModelProviderFactory = viewModelStoreOwnerM13viewModels$lambda1 instanceof HasDefaultViewModelProviderFactory ? (HasDefaultViewModelProviderFactory) viewModelStoreOwnerM13viewModels$lambda1 : null;
    ...
    public static final /* synthetic */ <VM extends ViewModel> Lazy<VM> viewModels(Fragment fragment, Function0<? extends ViewModelStoreOwner> ownerProducer, Function0<? extends ViewModelProvider.Factory> function0) {
        ...
        Intrinsics.reifiedOperationMarker(4, "VM");
        KClass orCreateKotlinClass = Reflection.getOrCreateKotlinClass(ViewModel.class);
        C02902 c02902 = new C02902(lazy);
        C02913 c02913 = new C02913(lazy);
        if (function0 == null) {
            function0 = new C02924(fragment, lazy);
        }
        return createViewModelLazy(fragment, orCreateKotlinClass, c02902, c02913, function0);
    }
    ...
    public static final /* synthetic */ <VM extends ViewModel> Lazy<VM> viewModels(Fragment fragment, Function0<? extends ViewModelStoreOwner> ownerProducer, Function0<? extends CreationExtras> function0, Function0<? extends ViewModelProvider.Factory> function02) {
        ...
        Intrinsics.reifiedOperationMarker(4, "VM");
        KClass orCreateKotlinClass = Reflection.getOrCreateKotlinClass(ViewModel.class);
        C02946 c02946 = new C02946(lazy);
        AnonymousClass7 anonymousClass7 = new AnonymousClass7(function0, lazy);
        if (function02 == null) {
            function02 = new AnonymousClass8(fragment, lazy);
        }
        return createViewModelLazy(fragment, orCreateKotlinClass, c02946, anonymousClass7, function02);
    }
