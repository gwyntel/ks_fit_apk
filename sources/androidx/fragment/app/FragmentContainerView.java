...
public final class FragmentContainerView extends FrameLayout {
    ...
    public final <F extends Fragment> F getFragment() {
        return (F) FragmentManager.T(this).findFragmentById(getId());
    }
    ...
    public FragmentContainerView(@NotNull Context context, @NotNull AttributeSet attrs, @NotNull FragmentManager fm) {
        ...
        if (classAttribute != null && fragmentFindFragmentById == null) {
            ...
            fm.beginTransaction().setReorderingAllowed(true).a(this, fragmentInstantiate, string).commitNowAllowingStateLoss();
        }
        fm.r0(this);
    }
}
