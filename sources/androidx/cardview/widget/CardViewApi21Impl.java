...
class CardViewApi21Impl implements CardViewImpl {
    ...
    public void updatePadding(CardViewDelegate cardViewDelegate) {
        ...
        int iCeil = (int) Math.ceil(RoundRectDrawableWithShadow.a(maxElevation, radius, cardViewDelegate.getPreventCornerOverlap()));
        int iCeil2 = (int) Math.ceil(RoundRectDrawableWithShadow.b(maxElevation, radius, cardViewDelegate.getPreventCornerOverlap()));
