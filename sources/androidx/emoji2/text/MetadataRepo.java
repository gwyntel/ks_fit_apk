...
public final class MetadataRepo {
    ...
    static class Node {
        ...
        void c(EmojiMetadata emojiMetadata, int i2, int i3) {
            Node nodeA = a(emojiMetadata.getCodepointAt(i2));
            if (nodeA == null) {
                nodeA = new Node();
                this.mChildren.put(emojiMetadata.getCodepointAt(i2), nodeA);
            }
            if (i3 > i2) {
                nodeA.c(emojiMetadata, i2 + 1, i3);
            } else {
    ...
    void d(EmojiMetadata emojiMetadata) {
