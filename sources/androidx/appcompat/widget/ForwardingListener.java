...
public abstract class ForwardingListener implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    private class DisallowIntercept implements Runnable {
        ...
        public void run() {
            ViewParent parent = ForwardingListener.this.f2267a.getParent();
            if (parent != null) {
    ...
    private void clearCallbacks() {
        ...
        if (runnable2 != null) {
            this.f2267a.removeCallbacks(runnable2);
        }
    }
    ...
    */
    private boolean onTouchObserved(android.view.MotionEvent r6) {
        /*
            r5 = this;
            android.view.View r0 = r5.f2267a
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (z3) {
            ...
            if (z2) {
                long jUptimeMillis = SystemClock.uptimeMillis();
                MotionEvent motionEventObtain = MotionEvent.obtain(jUptimeMillis, jUptimeMillis, 3, 0.0f, 0.0f, 0);
                this.f2267a.onTouchEvent(motionEventObtain);
                motionEventObtain.recycle();
            }
        }
        this.mForwarding = z2;
