...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
    ...
    MenuBuilder.Callback f2215a;

    /* renamed from: b, reason: collision with root package name */
    OnMenuItemClickListener f2216b;
    ...
    private class MenuBuilderCallback implements MenuBuilder.Callback {
        ...
        public boolean onMenuItemSelected(@NonNull MenuBuilder menuBuilder, @NonNull MenuItem menuItem) {
            OnMenuItemClickListener onMenuItemClickListener = ActionMenuView.this.f2216b;
            return onMenuItemClickListener != null && onMenuItemClickListener.onMenuItemClick(menuItem);
        }

        @Override // androidx.appcompat.view.menu.MenuBuilder.Callback
        public void onMenuModeChange(@NonNull MenuBuilder menuBuilder) {
            MenuBuilder.Callback callback = ActionMenuView.this.f2215a;
            if (callback != null) {
    ...
    private void onMeasureExactFormat(int i2, int i3) {
        ...
        while (i14 < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                int iU = u(childAt, i13, layoutParams.isOverflowButton ? 1 : i11, childMeasureSpec, paddingTop);
    ...
    */
    static int u(android.view.View r5, int r6, int r7, int r8, int r9) {
        /*
        ...
        L54:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.ActionMenuView.u(android.view.View, int, int, int, int):int");
    }
    ...
    public void setMenuCallbacks(MenuPresenter.Callback callback, MenuBuilder.Callback callback2) {
        ...
        this.f2215a = callback2;
    }

    public void setOnMenuItemClickListener(OnMenuItemClickListener onMenuItemClickListener) {
        this.f2216b = onMenuItemClickListener;
    }
