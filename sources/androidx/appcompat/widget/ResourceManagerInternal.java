...
public final class ResourceManagerInternal {
    ...
    public static synchronized PorterDuffColorFilter getPorterDuffColorFilter(int i2, PorterDuff.Mode mode) {
        PorterDuffColorFilter porterDuffColorFilterD;
        ColorFilterLruCache colorFilterLruCache = COLOR_FILTER_CACHE;
        porterDuffColorFilterD = colorFilterLruCache.d(i2, mode);
        if (porterDuffColorFilterD == null) {
            porterDuffColorFilterD = new PorterDuffColorFilter(i2, mode);
            colorFilterLruCache.e(i2, mode, porterDuffColorFilterD);
        }
        return porterDuffColorFilterD;
    }
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int i2, boolean z2, @NonNull Drawable drawable) {
        ...
        if (colorStateListB == null) {
            ResourceManagerHooks resourceManagerHooks = this.mHooks;
            if ((resourceManagerHooks == null || !resourceManagerHooks.tintDrawable(context, i2, drawable)) && !f(context, i2, drawable) && z2) {
                return null;
            }
            return drawable;
        }
        ...
        PorterDuff.Mode modeC = c(i2);
        if (modeC == null) {
            return drawableWrap;
        }
        DrawableCompat.setTintMode(drawableWrap, modeC);
        return drawableWrap;
    }

    synchronized Drawable a(Context context, int i2, boolean z2) {
    ...
    synchronized Drawable d(Context context, VectorEnabledTintResources vectorEnabledTintResources, int i2) {
        try {
            Drawable drawableLoadDrawableFromDelegates = loadDrawableFromDelegates(context, i2);
            if (drawableLoadDrawableFromDelegates == null) {
                drawableLoadDrawableFromDelegates = vectorEnabledTintResources.a(i2);
            }
            if (drawableLoadDrawableFromDelegates == null) {
                return null;
            }
    ...
    boolean f(Context context, int i2, Drawable drawable) {
        ResourceManagerHooks resourceManagerHooks = this.mHooks;
