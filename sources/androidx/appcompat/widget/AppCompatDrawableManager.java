...
public final class AppCompatDrawableManager {
    ...
    static void d(Drawable drawable, TintInfo tintInfo, int[] iArr) {
        ...
        if (INSTANCE == null) {
            ...
            INSTANCE.mResourceManager.setHooks(new ResourceManagerInternal.ResourceManagerHooks() { // from class: androidx.appcompat.widget.AppCompatDrawableManager.1
                ...
                private ColorStateList createButtonColorStateList(@NonNull Context context, @ColorInt int i2) {
                    ...
                    return new ColorStateList(new int[][]{ThemeUtils.f2331a, ThemeUtils.f2334d, ThemeUtils.f2332b, ThemeUtils.f2338h}, new int[]{ThemeUtils.getDisabledThemeAttrColor(context, R.attr.colorButtonNormal), ColorUtils.compositeColors(themeAttrColor, i2), ColorUtils.compositeColors(themeAttrColor, i2), i2});
                }
                ...
                private ColorStateList createSwitchThumbColorStateList(Context context) {
                    ...
                    if (themeAttrColorStateList == null || !themeAttrColorStateList.isStateful()) {
                        iArr[0] = ThemeUtils.f2331a;
                        iArr2[0] = ThemeUtils.getDisabledThemeAttrColor(context, R.attr.colorSwitchThumbNormal);
                        iArr[1] = ThemeUtils.f2335e;
                        iArr2[1] = ThemeUtils.getThemeAttrColor(context, R.attr.colorControlActivated);
                        iArr[2] = ThemeUtils.f2338h;
                        iArr2[2] = ThemeUtils.getThemeAttrColor(context, R.attr.colorSwitchThumbNormal);
                    } else {
                        int[] iArr3 = ThemeUtils.f2331a;
                        iArr[0] = iArr3;
    ...
    synchronized Drawable b(Context context, int i2, boolean z2) {
        return this.mResourceManager.a(context, i2, z2);
    }

    synchronized ColorStateList c(Context context, int i2) {
