...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menuBuilder, MenuItemImpl menuItemImpl) {
            ...
            if (parent2 != toolbar3) {
                ...
                layoutParamsGenerateDefaultLayoutParams.f2346a = 2;
        ...
        public void initForMenu(Context context, MenuBuilder menuBuilder) {
            ...
            MenuBuilder menuBuilder2 = this.f2343a;
            if (menuBuilder2 != null && (menuItemImpl = this.f2344b) != null) {
                menuBuilder2.collapseItemActionView(menuItemImpl);
            }
            this.f2343a = menuBuilder;
        }
        ...
        public void updateMenuView(boolean z2) {
            if (this.f2344b != null) {
                MenuBuilder menuBuilder = this.f2343a;
                if (menuBuilder != null) {
                    int size = menuBuilder.size();
                    for (int i2 = 0; i2 < size; i2++) {
                        if (this.f2343a.getItem(i2) == this.f2344b) {
                            return;
                        }
                    }
                }
                collapseItemActionView(this.f2343a, this.f2344b);
            }
        }
    }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            parcel.writeInt(this.f2348b ? 1 : 0);
        }

        public SavedState(Parcel parcel, ClassLoader classLoader) {
            super(parcel, classLoader);
            this.f2347a = parcel.readInt();
            this.f2348b = parcel.readInt() != 0;
        }
    ...
    private void addCustomViewsWithGravity(List<View> list, int i2) {
        ...
        if (!z2) {
            for (int i3 = 0; i3 < childCount; i3++) {
                ...
                if (layoutParams.f2346a == 0 && shouldLayout(childAt) && getChildHorizontalGravity(layoutParams.gravity) == absoluteGravity) {
                    list.add(childAt);
                }
            }
            return;
        ...
        for (int i4 = childCount - 1; i4 >= 0; i4--) {
            ...
            if (layoutParams2.f2346a == 0 && shouldLayout(childAt2) && getChildHorizontalGravity(layoutParams2.gravity) == absoluteGravity) {
                list.add(childAt2);
            }
        }
    }
    ...
    private void addSystemView(View view, boolean z2) {
        ...
        layoutParamsGenerateDefaultLayoutParams.f2346a = 1;
    ...
    public void collapseActionView() {
        ...
        MenuItemImpl menuItemImpl = expandedActionViewMenuPresenter == null ? null : expandedActionViewMenuPresenter.f2344b;
    ...
    public boolean hasExpandedActionView() {
        ExpandedActionViewMenuPresenter expandedActionViewMenuPresenter = this.mExpandedMenuPresenter;
        return (expandedActionViewMenuPresenter == null || expandedActionViewMenuPresenter.f2344b == null) ? false : true;
    }
    ...
    */
    ...
    protected void onMeasure(int i2, int i3) {
        ...
        for (int i5 = 0; i5 < childCount; i5++) {
            ...
            if (((LayoutParams) childAt.getLayoutParams()).f2346a == 0 && shouldLayout(childAt)) {
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        ExpandedActionViewMenuPresenter expandedActionViewMenuPresenter = this.mExpandedMenuPresenter;
        if (expandedActionViewMenuPresenter != null && (menuItemImpl = expandedActionViewMenuPresenter.f2344b) != null) {
            savedState.f2347a = menuItemImpl.getItemId();
        }
        savedState.f2348b = isOverflowMenuShowing();
        return savedState;
    }
    ...
    void removeChildrenForExpandedActionView() {
        for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
            ...
            if (((LayoutParams) childAt.getLayoutParams()).f2346a != 2 && childAt != this.mMenuView) {
    ...
    void updateBackInvokedCallbackState() {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            ...
            boolean z2 = hasExpandedActionView() && onBackInvokedDispatcherA != null && ViewCompat.isAttachedToWindow(this) && this.mBackInvokedCallbackEnabled;
            if (z2 && this.mBackInvokedDispatcher == null) {
                if (this.mBackInvokedCallback == null) {
                    this.mBackInvokedCallback = Api33Impl.b(new Runnable() { // from class: androidx.appcompat.widget.g
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f2358a.collapseActionView();
                        }
                    });
                }
                Api33Impl.c(onBackInvokedDispatcherA, this.mBackInvokedCallback);
    ...
    public static class LayoutParams extends ActionBar.LayoutParams {
        ...
        public LayoutParams(LayoutParams layoutParams) {
            ...
            this.f2346a = 0;
            this.f2346a = layoutParams.f2346a;
        }
