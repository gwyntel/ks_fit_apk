...
class DropDownListView extends ListView {
    ...
    static class Api30Impl {
        ...
        static void b(DropDownListView dropDownListView, int i2, View view) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            try {
    ...
    private void setSelectorEnabled(boolean z2) {
        ...
        if (gateKeeperDrawable != null) {
            gateKeeperDrawable.a(z2);
        }
    }

    @OptIn(markerClass = {BuildCompat.PrereleaseSdkCheck.class})
    private boolean superIsSelectedChildViewEnabled() {
        return BuildCompat.isAtLeastT() ? Api33Impl.a(this) : PreApi33Impl.a(this);
    }
    ...
    */
    ...
    public boolean onHoverEvent(@NonNull MotionEvent motionEvent) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        if (actionMasked == 10 && this.f2265a == null) {
            ResolveHoverRunnable resolveHoverRunnable = new ResolveHoverRunnable();
            this.f2265a = resolveHoverRunnable;
            ...
            if (iPointToPosition != -1 && iPointToPosition != getSelectedItemPosition()) {
                ...
                if (childAt.isEnabled()) {
                    ...
                    if (i2 < 30 || !Api30Impl.a()) {
                        ...
                        Api30Impl.b(this, iPointToPosition, childAt);
                    }
                }
                updateSelectorStateCompat();
            }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        ResolveHoverRunnable resolveHoverRunnable = this.f2265a;
