...
public class SupportMenuInflater extends MenuInflater {
    ...
    static final Class[] f2112d;

    /* renamed from: e, reason: collision with root package name */
    static final Class[] f2113e;
    ...
    private class MenuState {
        ...
        private <T> T newInstance(String str, Class<?>[] clsArr, Object[] objArr) throws NoSuchMethodException, SecurityException {
            try {
                Constructor<?> constructor = Class.forName(str, false, SupportMenuInflater.this.f2116c.getClassLoader()).getConstructor(clsArr);
        ...
        private void setItem(MenuItem menuItem) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            ...
            if (this.itemListenerMethodName != null) {
                if (SupportMenuInflater.this.f2116c.isRestricted()) {
            ...
            if (str != null) {
                menuItem.setActionView((View) newInstance(str, SupportMenuInflater.f2112d, SupportMenuInflater.this.f2114a));
                z2 = true;
            }
            ...
            ActionProvider actionProvider = this.f2117a;
        ...
        public void readGroup(AttributeSet attributeSet) {
            TypedArray typedArrayObtainStyledAttributes = SupportMenuInflater.this.f2116c.obtainStyledAttributes(attributeSet, R.styleable.MenuGroup);
        ...
        public void readItem(AttributeSet attributeSet) {
            TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(SupportMenuInflater.this.f2116c, attributeSet, R.styleable.MenuItem);
            ...
            if (z2 && this.itemActionViewLayout == 0 && this.itemActionViewClassName == null) {
                this.f2117a = (ActionProvider) newInstance(string, SupportMenuInflater.f2113e, SupportMenuInflater.this.f2115b);
            } else {
                if (z2) {
                ...
                if (eventType == 3) {
                    ...
                    if (z3 && name2.equals(str)) {
                        ...
                        if (!menuState.hasAddedItem()) {
                            ActionProvider actionProvider = menuState.f2117a;
    ...
    Object a() {
        if (this.mRealOwner == null) {
            this.mRealOwner = findRealOwner(this.f2116c);
        }
    ...
    public void inflate(@LayoutRes int i2, Menu menu) {
        ...
        try {
            try {
                try {
                    layout = this.f2116c.getResources().getLayout(i2);
