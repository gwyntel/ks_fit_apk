...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    char a() {
        return this.f2161a.isQwertyMode() ? this.mShortcutAlphabeticChar : this.mShortcutNumericChar;
    }
    ...
    String b() {
        ...
        if (ViewConfiguration.get(this.f2161a.getContext()).hasPermanentMenuKey()) {
            sb.append(resources.getString(R.string.abc_prepend_shortcut_label));
        }
        int i2 = this.f2161a.isQwertyMode() ? this.mShortcutAlphabeticModifiers : this.mShortcutNumericModifiers;
    ...
    CharSequence c(MenuView.ItemView itemView) {
    ...
    public boolean collapseActionView() {
        ...
        if (onActionExpandListener == null || onActionExpandListener.onMenuItemActionCollapse(this)) {
            return this.f2161a.collapseItemActionView(this);
        }
        return false;
    }
    ...
    void d(boolean z2) {
        ...
        this.mFlags = i3;
        if (i2 != i3) {
            this.f2161a.onItemsChanged(false);
        }
    }

    void e(ContextMenu.ContextMenuInfo contextMenuInfo) {
    ...
    public boolean expandActionView() {
        ...
        if (onActionExpandListener == null || onActionExpandListener.onMenuItemActionExpand(this)) {
            return this.f2161a.expandItemActionView(this);
        }
        return false;
    }
    ...
    boolean g() {
        return this.f2161a.isShortcutsVisible() && a() != 0;
    }
    ...
    public Drawable getIcon() {
        ...
        Drawable drawable2 = AppCompatResources.getDrawable(this.f2161a.getContext(), this.mIconResId);
        this.mIconResId = 0;
    ...
    public boolean invoke() {
        ...
        MenuBuilder menuBuilder = this.f2161a;
        ...
        if (this.mIntent != null) {
            try {
                this.f2161a.getContext().startActivity(this.mIntent);
                return true;
    ...
    public SupportMenuItem setSupportActionProvider(ActionProvider actionProvider) {
        ...
        this.f2161a.onItemsChanged(true);
        ...
        if (actionProvider3 != null) {
            actionProvider3.setVisibilityListener(new ActionProvider.VisibilityListener() { // from class: androidx.appcompat.view.menu.MenuItemImpl.1
                ...
                public void onActionProviderVisibilityChanged(boolean z2) {
                    ...
                    menuItemImpl.f2161a.h(menuItemImpl);
                }
            });
        }
        return this;
    ...
    public MenuItem setTitle(int i2) {
        return setTitle(this.f2161a.getContext().getString(i2));
    }
