...
public class MenuBuilder implements SupportMenu {
    ...
    private void setHeaderInternal(int i2, CharSequence charSequence, int i3, Drawable drawable, View view) {
        ...
        if (view != null) {
            ...
            if (i2 > 0) {
                this.f2157a = resourcesF.getText(i2);
            } else if (charSequence != null) {
                this.f2157a = charSequence;
            }
            if (i3 > 0) {
                this.f2158b = ContextCompat.getDrawable(getContext(), i3);
            } else if (drawable != null) {
                this.f2158b = drawable;
            }
            this.f2159c = null;
        }
    ...
    */
    ...
    protected MenuItem a(int i2, int i3, int i4, CharSequence charSequence) {
        ...
        if (contextMenuInfo != null) {
            menuItemImplCreateNewMenuItem.e(contextMenuInfo);
        }
    ...
    void g(MenuItemImpl menuItemImpl) {
    ...
    void h(MenuItemImpl menuItemImpl) {
    ...
    protected MenuBuilder j(int i2) {
        setHeaderInternal(0, null, i2, null, null);
        return this;
    }

    protected MenuBuilder k(Drawable drawable) {
        setHeaderInternal(0, null, 0, drawable, null);
        return this;
    }

    protected MenuBuilder l(int i2) {
        setHeaderInternal(i2, null, 0, null, null);
        return this;
    }

    protected MenuBuilder m(CharSequence charSequence) {
        setHeaderInternal(0, charSequence, 0, null, null);
        return this;
    }

    protected MenuBuilder n(View view) {
    ...
    public boolean performShortcut(int i2, KeyEvent keyEvent, int i3) {
        MenuItemImpl menuItemImplC = c(i2, keyEvent);
        boolean zPerformItemAction = menuItemImplC != null ? performItemAction(menuItemImplC, i3) : false;
        if ((i3 & 2) != 0) {
            close(true);
        }
    ...
    public void setGroupVisible(int i2, boolean z2) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            MenuItemImpl menuItemImpl = this.mItems.get(i3);
            if (menuItemImpl.getGroupId() == i2 && menuItemImpl.f(z2)) {
                z3 = true;
            }
        }
        if (z3) {
