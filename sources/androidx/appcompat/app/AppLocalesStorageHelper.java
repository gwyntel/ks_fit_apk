...
class AppLocalesStorageHelper {
    ...
    static class SerialExecutor implements Executor {
        ...
        final Queue f2036a = new ArrayDeque();
        ...
        protected void b() {
            synchronized (this.mLock) {
                try {
                    Runnable runnable = (Runnable) this.f2036a.poll();
                    this.f2038c = runnable;
                    if (runnable != null) {
                        this.f2037b.execute(runnable);
                    }
                } catch (Throwable th) {
                    throw th;
                }
        ...
        public void execute(final Runnable runnable) {
            synchronized (this.mLock) {
                try {
                    this.f2036a.add(new Runnable() { // from class: androidx.appcompat.app.r
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f2077a.lambda$execute$0(runnable);
                        }
                    });
                    if (this.f2038c == null) {
                        b();
            ...
            if (context.getPackageManager().getComponentEnabledSetting(componentName) != 1) {
                if (AppCompatDelegate.getApplicationLocales().isEmpty()) {
                    ...
                    if (systemService != null) {
                        AppCompatDelegate.Api33Impl.b(systemService, AppCompatDelegate.Api24Impl.a(strB));
                    }
                }
