...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    public static class Builder {
        ...
        public AlertDialog create() {
            ...
            this.P.apply(alertDialog.f1972a);
        ...
        public Builder(@NonNull Context context, @StyleRes int i2) {
            this.P = new AlertController.AlertParams(new ContextThemeWrapper(context, AlertDialog.c(context, i2)));
            this.mTheme = i2;
        }
    ...
    protected AlertDialog(Context context, int i2) {
        ...
        this.f1972a = new AlertController(getContext(), this, getWindow());
    }
    ...
    public Button getButton(int i2) {
        return this.f1972a.getButton(i2);
    }

    public ListView getListView() {
        return this.f1972a.getListView();
    }

    @Override // androidx.appcompat.app.AppCompatDialog, androidx.activity.ComponentDialog, android.app.Dialog
    protected void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        this.f1972a.installContent();
    }

    @Override // android.app.Dialog, android.view.KeyEvent.Callback
    public boolean onKeyDown(int i2, KeyEvent keyEvent) {
        if (this.f1972a.onKeyDown(i2, keyEvent)) {
            return true;
        }
    ...
    public boolean onKeyUp(int i2, KeyEvent keyEvent) {
        if (this.f1972a.onKeyUp(i2, keyEvent)) {
            return true;
        }
    ...
    public void setButton(int i2, CharSequence charSequence, Message message) {
        this.f1972a.setButton(i2, charSequence, null, message, null);
    }

    public void setCustomTitle(View view) {
        this.f1972a.setCustomTitle(view);
    }

    public void setIcon(int i2) {
        this.f1972a.setIcon(i2);
    }

    public void setIconAttribute(int i2) {
        TypedValue typedValue = new TypedValue();
        getContext().getTheme().resolveAttribute(i2, typedValue, true);
        this.f1972a.setIcon(typedValue.resourceId);
    }

    public void setMessage(CharSequence charSequence) {
        this.f1972a.setMessage(charSequence);
    }
    ...
    public void setView(View view) {
        this.f1972a.setView(view);
    }

    public void setButton(int i2, CharSequence charSequence, DialogInterface.OnClickListener onClickListener) {
        this.f1972a.setButton(i2, charSequence, onClickListener, null, null);
    }

    public void setIcon(Drawable drawable) {
        this.f1972a.setIcon(drawable);
    }

    public void setView(View view, int i2, int i3, int i4, int i5) {
        this.f1972a.setView(view, i2, i3, i4, i5);
    }

    public void setButton(int i2, CharSequence charSequence, Drawable drawable, DialogInterface.OnClickListener onClickListener) {
        this.f1972a.setButton(i2, charSequence, onClickListener, null, drawable);
    }
}
