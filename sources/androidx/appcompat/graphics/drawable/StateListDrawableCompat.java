...
public class StateListDrawableCompat extends DrawableContainerCompat {
    ...
    static class StateListState extends DrawableContainerCompat.DrawableContainerState {
        ...
        int h(int[] iArr, Drawable drawable) {
            int iAddChild = addChild(drawable);
            this.J[iAddChild] = iArr;
            return iAddChild;
        }
    ...
    private void inflateChildElements(Context context, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next2 == 2 && depth2 <= depth && xmlPullParser.getName().equals("item")) {
                ...
                stateListState.h(iArrI, drawable);
            }
        }
    }
    ...
    private void updateStateFromTypedArray(TypedArray typedArray) {
        StateListState stateListState = this.mStateListState;
        stateListState.f2083d |= Compatibility.Api21Impl.getChangingConfigurations(typedArray);
        stateListState.f2088i = typedArray.getBoolean(R.styleable.StateListDrawable_android_variablePadding, stateListState.f2088i);
        stateListState.f2091l = typedArray.getBoolean(R.styleable.StateListDrawable_android_constantSize, stateListState.f2091l);
        ...
        stateListState.f2103x = typedArray.getBoolean(R.styleable.StateListDrawable_android_dither, stateListState.f2103x);
    }
    ...
    @Override // androidx.appcompat.graphics.drawable.DrawableContainerCompat
    public StateListState h() {
        return new StateListState(this.mStateListState, this, null);
    }

    int[] i(AttributeSet attributeSet) {
