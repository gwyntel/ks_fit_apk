    ...
    */
    private void measureChildren(androidx.constraintlayout.core.widgets.ConstraintWidgetContainer r13) {
        ...
        L30:
            ...
            if (r7 == 0) goto L48
            androidx.constraintlayout.core.widgets.analyzer.DimensionDependency r6 = r6.f2958d
            boolean r6 = r6.resolved
            if (r6 == 0) goto L48
            androidx.constraintlayout.core.widgets.analyzer.DimensionDependency r6 = r7.f2958d
            boolean r6 = r6.resolved
            if (r6 == 0) goto L48
            goto Lac
        L48:
        ...
        if (size2 > 0) {
            ...
            while (i24 < i23) {
                ...
                while (i25 < size2) {
                    ...
                    if (((constraintWidget3 instanceof Helper) && !(constraintWidget3 instanceof VirtualLayout)) || (constraintWidget3 instanceof Guideline) || constraintWidget3.getVisibility() == 8 || ((z6 && constraintWidget3.horizontalRun.f2958d.resolved && constraintWidget3.verticalRun.f2958d.resolved) || (constraintWidget3 instanceof VirtualLayout))) {
                        z2 = z6;
                        i13 = size2;
                        measurer = measurer2;
                    } else {
