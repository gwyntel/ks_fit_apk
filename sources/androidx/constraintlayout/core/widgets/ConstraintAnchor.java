...
public class ConstraintAnchor {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f2889a[Type.LEFT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f2889a[Type.RIGHT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f2889a[Type.TOP.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f2889a[Type.BOTTOM.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f2889a[Type.BASELINE.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f2889a[Type.CENTER_X.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f2889a[Type.CENTER_Y.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f2889a[Type.NONE.ordinal()] = 9;
    ...
    public void copyFrom(ConstraintAnchor constraintAnchor, HashMap<ConstraintWidget, ConstraintWidget> map) {
        ...
        this.f2887a = constraintAnchor.f2887a;
    }
    ...
    public int getMargin() {
        ...
        return (this.f2887a == Integer.MIN_VALUE || (constraintAnchor = this.mTarget) == null || constraintAnchor.mOwner.getVisibility() != 8) ? this.mMargin : this.f2887a;
    }

    public final ConstraintAnchor getOpposite() {
        switch (AnonymousClass1.f2889a[this.mType.ordinal()]) {
            case 1:
            case 6:
            case 7:
            case 8:
    ...
    public boolean isSimilarDimensionConnection(ConstraintAnchor constraintAnchor) {
        ...
        switch (AnonymousClass1.f2889a[type2.ordinal()]) {
            case 1:
    ...
    public void resetSolverVariable(Cache cache) {
        SolverVariable solverVariable = this.f2888b;
        if (solverVariable == null) {
            this.f2888b = new SolverVariable(SolverVariable.Type.UNRESTRICTED, (String) null);
        } else {
