                ...
                switch (mAttrMap.get(index)) {
                    ...
                    case 10:
                        if (MotionLayout.IS_IN_EDIT_MODE) {
                            int resourceId = typedArray.getResourceId(index, keyTimeCycle.f2998b);
                            keyTimeCycle.f2998b = resourceId;
                            if (resourceId == -1) {
                                keyTimeCycle.f2999c = typedArray.getString(index);
                                break;
                            } else {
                                break;
                            }
                            ...
                            keyTimeCycle.f2998b = typedArray.getResourceId(index, keyTimeCycle.f2998b);
                            break;
                        }
                    case 12:
                        keyTimeCycle.f2997a = typedArray.getInt(index, keyTimeCycle.f2997a);
                        break;
                    case 13:
            ...
            if (viewTimeCycle != null) {
                if (!str.startsWith("CUSTOM")) {
                    switch (str) {
                        case "rotationX":
                            if (Float.isNaN(this.mRotationX)) {
                                ...
                                viewTimeCycle.setPoint(this.f2997a, this.mRotationX, this.mWavePeriod, this.mWaveShape, this.mWaveOffset);
                                break;
                            }
                        case "rotationY":
                            if (Float.isNaN(this.mRotationY)) {
                                ...
                                viewTimeCycle.setPoint(this.f2997a, this.mRotationY, this.mWavePeriod, this.mWaveShape, this.mWaveOffset);
                                break;
                            }
                        case "translationX":
                            if (Float.isNaN(this.mTranslationX)) {
                                ...
                                viewTimeCycle.setPoint(this.f2997a, this.mTranslationX, this.mWavePeriod, this.mWaveShape, this.mWaveOffset);
                                break;
                            }
                        case "translationY":
                            if (Float.isNaN(this.mTranslationY)) {
                                ...
                                viewTimeCycle.setPoint(this.f2997a, this.mTranslationY, this.mWavePeriod, this.mWaveShape, this.mWaveOffset);
                                break;
                            }
                        case "translationZ":
                            if (Float.isNaN(this.mTranslationZ)) {
                                ...
                                viewTimeCycle.setPoint(this.f2997a, this.mTranslationZ, this.mWavePeriod, this.mWaveShape, this.mWaveOffset);
                                break;
                            }
                        case "progress":
                            if (Float.isNaN(this.mProgress)) {
                                ...
                                viewTimeCycle.setPoint(this.f2997a, this.mProgress, this.mWavePeriod, this.mWaveShape, this.mWaveOffset);
                                break;
                            }
                        case "scaleX":
                            if (Float.isNaN(this.mScaleX)) {
                                ...
                                viewTimeCycle.setPoint(this.f2997a, this.mScaleX, this.mWavePeriod, this.mWaveShape, this.mWaveOffset);
                                break;
                            }
                        case "scaleY":
                            if (Float.isNaN(this.mScaleY)) {
                                ...
                                viewTimeCycle.setPoint(this.f2997a, this.mScaleY, this.mWavePeriod, this.mWaveShape, this.mWaveOffset);
                                break;
                            }
                        case "rotation":
                            if (Float.isNaN(this.mRotation)) {
                                ...
                                viewTimeCycle.setPoint(this.f2997a, this.mRotation, this.mWavePeriod, this.mWaveShape, this.mWaveOffset);
                                break;
                            }
                        case "elevation":
                            if (Float.isNaN(this.mElevation)) {
                                ...
                                viewTimeCycle.setPoint(this.f2997a, this.mElevation, this.mWavePeriod, this.mWaveShape, this.mWaveOffset);
                                break;
                            }
                        case "transitionPathRotate":
                            if (Float.isNaN(this.mTransitionPathRotate)) {
                                ...
                                viewTimeCycle.setPoint(this.f2997a, this.mTransitionPathRotate, this.mWavePeriod, this.mWaveShape, this.mWaveOffset);
                                break;
                            }
                        case "alpha":
                            if (Float.isNaN(this.mAlpha)) {
                                ...
                                viewTimeCycle.setPoint(this.f2997a, this.mAlpha, this.mWavePeriod, this.mWaveShape, this.mWaveOffset);
                                break;
                            }
                        default:
                    ...
                    if (constraintAttribute != null) {
                        ((ViewTimeCycle.CustomSet) viewTimeCycle).setPoint(this.f2997a, constraintAttribute, this.mWavePeriod, this.mWaveShape, this.mWaveOffset);
                    }
                }
            }
        }
