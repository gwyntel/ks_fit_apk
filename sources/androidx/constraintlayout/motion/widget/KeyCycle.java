...
public class KeyCycle extends Key {
                ...
                switch (mAttrMap.get(index)) {
                    case 1:
                        if (MotionLayout.IS_IN_EDIT_MODE) {
                            int resourceId = typedArray.getResourceId(index, keyCycle.f2998b);
                            keyCycle.f2998b = resourceId;
                            if (resourceId == -1) {
                                keyCycle.f2999c = typedArray.getString(index);
                                break;
                            } else {
                                break;
                            }
                            ...
                            keyCycle.f2998b = typedArray.getResourceId(index, keyCycle.f2998b);
                            break;
                        }
                    case 2:
                        keyCycle.f2997a = typedArray.getInt(index, keyCycle.f2997a);
                        break;
                    case 3:
                    ...
                    case 21:
                        ...
                        break;
                    default:
                        Log.e(KeyCycle.TAG, "unused attribute 0x" + Integer.toHexString(index) + "   " + mAttrMap.get(index));
                        break;
                }
            }
        }
        ...
        for (String str : map.keySet()) {
            if (str.startsWith("CUSTOM")) {
                ...
                if (constraintAttribute != null && constraintAttribute.getType() == ConstraintAttribute.AttributeType.FLOAT_TYPE && (viewOscillator = map.get(str)) != null) {
                    viewOscillator.setPoint(this.f2997a, this.mWaveShape, this.mCustomWaveShape, this.mWaveVariesBy, this.mWavePeriod, this.mWaveOffset, this.mWavePhase, constraintAttribute.getValueToInterpolate(), constraintAttribute);
                }
            } else {
                float value = getValue(str);
                if (!Float.isNaN(value) && (viewOscillator2 = map.get(str)) != null) {
                    viewOscillator2.setPoint(this.f2997a, this.mWaveShape, this.mCustomWaveShape, this.mWaveVariesBy, this.mWavePeriod, this.mWaveOffset, this.mWavePhase, value);
                }
            }
        }
    }
    ...
    public void addValues(HashMap<String, ViewSpline> map) {
        Debug.logStack(TAG, "add " + map.size() + " values", 2);
        for (String str : map.keySet()) {
            ...
            if (viewSpline != null) {
                ...
                switch (c2) {
                    ...
                    case 11:
                        ...
                        break;
                    case '\f':
                        viewSpline.setPoint(this.f2997a, this.mWaveOffset);
                        break;
                    case '\r':
                        viewSpline.setPoint(this.f2997a, this.mWavePhase);
                        break;
                    default:
                        if (str.startsWith("CUSTOM")) {
                            break;
