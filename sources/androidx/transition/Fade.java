...
public class Fade extends Visibility {
    ...
    private Animator createAnimation(final View view, float f2, float f3) {
        ...
        ViewUtils.h(view, f2);
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(view, (Property<View, Float>) ViewUtils.f6354a, f3);
    ...
    public Fade(@NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, Styleable.f6310f);
