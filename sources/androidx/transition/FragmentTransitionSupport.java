...
public class FragmentTransitionSupport extends FragmentTransitionImpl {
    private static boolean hasSimpleTarget(Transition transition) {
        return (FragmentTransitionImpl.c(transition.getTargetIds()) && FragmentTransitionImpl.c(transition.getTargetNames()) && FragmentTransitionImpl.c(transition.getTargetTypes())) ? false : true;
    }
    ...
    public void addTargets(Object obj, ArrayList<View> arrayList) {
        ...
        if (hasSimpleTarget(transition) || !FragmentTransitionImpl.c(transition.getTargets())) {
            return;
        }
