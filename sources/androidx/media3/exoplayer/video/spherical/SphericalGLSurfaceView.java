...
public final class SphericalGLSurfaceView extends GLSurfaceView {
    ...
    public void onSurfaceTextureAvailable(final SurfaceTexture surfaceTexture) {
        this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.video.spherical.c
            ...
            public final void run() {
                this.f5577a.lambda$onSurfaceTextureAvailable$1(surfaceTexture);
            }
        });
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.video.spherical.b
            @Override // java.lang.Runnable
            public final void run() {
                this.f5576a.lambda$onDetachedFromWindow$0();
            }
        });
    }
    ...
    public SphericalGLSurfaceView(Context context, @Nullable AttributeSet attributeSet) {
        ...
        SensorManager sensorManager = (SensorManager) Assertions.checkNotNull(context.getSystemService(bc.ac));
