...
public final class SpliceInfoDecoder extends SimpleMetadataDecoder {
    ...
    protected Metadata a(MetadataInputBuffer metadataInputBuffer, ByteBuffer byteBuffer) {
        ...
        Metadata.Entry entryA = bits3 != 0 ? bits3 != 255 ? bits3 != 4 ? bits3 != 5 ? bits3 != 6 ? null : TimeSignalCommand.a(this.sectionData, bits, this.timestampAdjuster) : SpliceInsertCommand.a(this.sectionData, bits, this.timestampAdjuster) : SpliceScheduleCommand.a(this.sectionData) : PrivateCommand.a(this.sectionData, bits2, bits) : new SpliceNullCommand();
