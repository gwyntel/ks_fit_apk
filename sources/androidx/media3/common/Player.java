...
public interface Player {
    ...
    public static final class PositionInfo {
        ...
        static final String f4747a = Util.intToStringMaxRadix(0);
        private static final String FIELD_MEDIA_ITEM = Util.intToStringMaxRadix(1);

        /* renamed from: b, reason: collision with root package name */
        static final String f4748b = Util.intToStringMaxRadix(2);

        /* renamed from: c, reason: collision with root package name */
        static final String f4749c = Util.intToStringMaxRadix(3);

        /* renamed from: d, reason: collision with root package name */
        static final String f4750d = Util.intToStringMaxRadix(4);
        ...
        public static PositionInfo fromBundle(Bundle bundle) {
            int i2 = bundle.getInt(f4747a, 0);
            Bundle bundle2 = bundle.getBundle(FIELD_MEDIA_ITEM);
            return new PositionInfo(null, i2, bundle2 == null ? null : MediaItem.fromBundle(bundle2), null, bundle.getInt(f4748b, 0), bundle.getLong(f4749c, 0L), bundle.getLong(f4750d, 0L), bundle.getInt(FIELD_AD_GROUP_INDEX, -1), bundle.getInt(FIELD_AD_INDEX_IN_AD_GROUP, -1));
        }
        ...
        public Bundle toBundle(int i2) {
            ...
            if (i2 < 3 || this.mediaItemIndex != 0) {
                bundle.putInt(f4747a, this.mediaItemIndex);
            }
            ...
            if (i2 < 3 || this.periodIndex != 0) {
                bundle.putInt(f4748b, this.periodIndex);
            }
            if (i2 < 3 || this.positionMs != 0) {
                bundle.putLong(f4749c, this.positionMs);
            }
            if (i2 < 3 || this.contentPositionMs != 0) {
                bundle.putLong(f4750d, this.contentPositionMs);
            }
            int i3 = this.adGroupIndex;
            if (i3 != -1) {
                bundle.putInt(FIELD_AD_GROUP_INDEX, i3);
            }
            int i4 = this.adIndexInAdGroup;
            if (i4 != -1) {
                bundle.putInt(FIELD_AD_INDEX_IN_AD_GROUP, i4);
            }
            return bundle;
        }
    ...
    void setDeviceVolume(@IntRange(from = 0) int i2, int i3);
    ...
    void setVolume(@FloatRange(from = 0.0d, to = HeartRateVariabilityRmssdRecord.MIN_HRV_RMSSD) float f2);
