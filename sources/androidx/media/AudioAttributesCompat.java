...
public class AudioAttributesCompat implements VersionedParcelable {
    ...
    static boolean f4621b;

    /* renamed from: a, reason: collision with root package name */
    AudioAttributesImpl f4622a;
    ...
    public static AudioAttributesCompat wrap(@NonNull Object obj) {
        ...
        audioAttributesCompat.f4622a = audioAttributesImplApi21;
    ...
    public boolean equals(Object obj) {
        ...
        AudioAttributesImpl audioAttributesImpl = this.f4622a;
        return audioAttributesImpl == null ? audioAttributesCompat.f4622a == null : audioAttributesImpl.equals(audioAttributesCompat.f4622a);
    }

    public int getContentType() {
        return this.f4622a.getContentType();
    }

    public int getFlags() {
        return this.f4622a.getFlags();
    }

    public int getLegacyStreamType() {
        return this.f4622a.getLegacyStreamType();
    }

    int getRawLegacyStreamType() {
        return this.f4622a.getRawLegacyStreamType();
    }

    public int getUsage() {
        return this.f4622a.getUsage();
    }

    public int getVolumeControlStream() {
        return this.f4622a.getVolumeControlStream();
    }
    ...
    public Object unwrap() {
        return this.f4622a.getAudioAttributes();
    }

    AudioAttributesCompat(AudioAttributesImpl audioAttributesImpl) {
        this.f4622a = audioAttributesImpl;
    }
    ...
    public static class Builder {
        ...
        public AudioAttributesCompat build() {
            ...
            if (AudioAttributesCompat.f4621b) {
        ...
        public Builder setUsage(int i2) {
            switch (i2) {
                ...
                case 15:
                    ...
                    return this;
                case 16:
                    if (AudioAttributesCompat.f4621b || Build.VERSION.SDK_INT <= 25) {
                        this.mUsage = 12;
                    } else {
                        this.mUsage = i2;
                    }
