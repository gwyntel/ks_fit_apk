...
public final class BodyTemperatureRecord implements InstantaneousRecord {
    ...
    public BodyTemperatureRecord(@NotNull Instant time, @Nullable ZoneOffset zoneOffset, @NotNull Temperature temperature, int i2, @NotNull androidx.health.connect.client.records.metadata.Metadata metadata) {
    ...
    public /* synthetic */ BodyTemperatureRecord(Instant instant, ZoneOffset zoneOffset, Temperature temperature, int i2, androidx.health.connect.client.records.metadata.Metadata metadata, int i3, DefaultConstructorMarker defaultConstructorMarker) {
