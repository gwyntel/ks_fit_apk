...
public final class StepsCadenceRecord implements SeriesRecord<Sample> {
    ...
    @Metadata(d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0006\n\u0002\b\u0006\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\u0018\u00002\u00020\u0001B\u0017\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\b\b\u0001\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\u0013\u0010\u000b\u001a\u00020\f2\b\u0010\r\u001a\u0004\u0018\u00010\u0001H\u0096\u0002J\b\u0010\u000e\u001a\u00020\u000fH\u0016R\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\n¨\u0006\u0010"}, d2 = {"Landroidx/health/connect/client/records/StepsCadenceRecord$Sample;", "", "time", "Ljava/time/Instant;", StepsCadenceRecord.RATE_FIELD, "", "(Ljava/time/Instant;D)V", "getRate", "()D", "getTime", "()Ljava/time/Instant;", "equals", "", "other", "hashCode", "", "connect-client_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    public static final class Sample {
        ...
        public Sample(@NotNull Instant time, @FloatRange(from = 0.0d, to = 10000.0d) double d2) {
            ...
            this.time = time;
            this.rate = d2;
            UtilsKt.requireNonNegative(d2, StepsCadenceRecord.RATE_FIELD);
            UtilsKt.requireNotMore(Double.valueOf(d2), Double.valueOf(10000.0d), StepsCadenceRecord.RATE_FIELD);
        }
        ...
        public int hashCode() {
            return (this.time.hashCode() * 31) + c.a(this.rate);
        }
    }

    static {
        AggregateMetric.Companion companion = AggregateMetric.INSTANCE;
        RATE_AVG = companion.doubleMetric$connect_client_release(TYPE, AggregateMetric.AggregationType.AVERAGE, RATE_FIELD);
        RATE_MIN = companion.doubleMetric$connect_client_release(TYPE, AggregateMetric.AggregationType.MINIMUM, RATE_FIELD);
        RATE_MAX = companion.doubleMetric$connect_client_release(TYPE, AggregateMetric.AggregationType.MAXIMUM, RATE_FIELD);
    }

    public StepsCadenceRecord(@NotNull Instant startTime, @Nullable ZoneOffset zoneOffset, @NotNull Instant endTime, @Nullable ZoneOffset zoneOffset2, @NotNull List<Sample> samples, @NotNull androidx.health.connect.client.records.metadata.Metadata metadata) {
    ...
    public /* synthetic */ StepsCadenceRecord(Instant instant, ZoneOffset zoneOffset, Instant instant2, ZoneOffset zoneOffset2, List list, androidx.health.connect.client.records.metadata.Metadata metadata, int i2, DefaultConstructorMarker defaultConstructorMarker) {
