...
public final class AggregateDataCallback extends IAggregateDataCallback.Stub {
    ...
    public AggregateDataCallback(@NotNull SettableFuture<ResponseProto.AggregateDataResponse> resultFuture) {
    ...
    @Override // androidx.health.platform.client.service.IAggregateDataCallback
    public void onSuccess(@NotNull AggregateDataResponse response) {
