...
public final class Permission extends ProtoParcelable<PermissionProto.Permission> {
    ...
    public static final Parcelable.Creator<Permission> CREATOR = new Parcelable.Creator<Permission>() { // from class: androidx.health.platform.client.permission.Permission$special$$inlined$newCreator$connect_client_release$1
        ...
        @SuppressLint({"NewApi"})
        @Nullable
        public Permission createFromParcel(@NotNull Parcel source) throws InvalidProtocolBufferException {
            ...
            if (i2 != 0) {
                if (i2 == 1) {
                    return (ProtoParcelable) SharedMemory27Impl.INSTANCE.parseParcelUsingSharedMemory(source, new Function1<byte[], Permission>() { // from class: androidx.health.platform.client.permission.Permission$special$$inlined$newCreator$connect_client_release$1.1
                        ...
                        @NotNull
                        public final Permission invoke(@NotNull byte[] it) throws InvalidProtocolBufferException {
