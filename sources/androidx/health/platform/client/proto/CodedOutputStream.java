...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    CodedOutputStreamWriter f4409a;
    private boolean serializationDeterministic;
    private static final Logger logger = Logger.getLogger(CodedOutputStream.class.getName());
    private static final boolean HAS_UNSAFE_ARRAY_OPERATIONS = UnsafeUtil.z();
    ...
    private static abstract class AbstractBufferedEncoder extends CodedOutputStream {
        ...
        final void t(int i2) {
            ...
            long j2 = this.f4412d;
            while ((i2 & (-128)) != 0) {
                byte[] bArr3 = this.f4410b;
                int i5 = this.f4412d;
                this.f4412d = i5 + 1;
                UnsafeUtil.E(bArr3, i5, (byte) ((i2 & 127) | 128));
                i2 >>>= 7;
            }
            byte[] bArr4 = this.f4410b;
            int i6 = this.f4412d;
            this.f4412d = i6 + 1;
            UnsafeUtil.E(bArr4, i6, (byte) i2);
            this.f4413e += (int) (this.f4412d - j2);
        }
        ...
        final void u(long j2) {
            ...
            while ((j2 & (-128)) != 0) {
                ...
                int i4 = this.f4412d;
                this.f4412d = i4 + 1;
                UnsafeUtil.E(bArr3, i4, (byte) ((((int) j2) & 127) | 128));
                j2 >>>= 7;
            }
            byte[] bArr4 = this.f4410b;
            int i5 = this.f4412d;
            this.f4412d = i5 + 1;
            UnsafeUtil.E(bArr4, i5, (byte) j2);
            this.f4413e += (int) (this.f4412d - j3);
        }
    }
    ...
    private static class ArrayEncoder extends CodedOutputStream {
        ...
        final void n(int i2, MessageLite messageLite, Schema schema) throws IOException {
            ...
            schema.writeTo(messageLite, this.f4409a);
        }
        ...
        public final void writeUInt64NoTag(long j2) throws IOException {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS && spaceLeft() >= 10) {
                while ((j2 & (-128)) != 0) {
                    ...
                    int i2 = this.position;
                    this.position = i2 + 1;
                    UnsafeUtil.E(bArr, i2, (byte) ((((int) j2) & 127) | 128));
                    j2 >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i3 = this.position;
                this.position = 1 + i3;
                UnsafeUtil.E(bArr2, i3, (byte) j2);
                return;
            }
            while ((j2 & (-128)) != 0) {
                try {
    ...
    private static final class ByteOutputEncoder extends AbstractBufferedEncoder {
        ...
        private void doFlush() throws IOException {
            this.out.write(this.f4410b, 0, this.f4412d);
            this.f4412d = 0;
        }

        private void flushIfNotAvailable(int i2) throws IOException {
            if (this.f4411c - this.f4412d < i2) {
                doFlush();
            }
        }
        ...
        public void writeStringNoTag(String str) throws IOException {
            ...
            try {
                ...
                if (iComputeUInt32SizeNoTag2 == iComputeUInt32SizeNoTag) {
                    ...
                    this.f4412d = i6;
                    int i7 = Utf8.i(str, this.f4410b, i6, this.f4411c - i6);
                    this.f4412d = i5;
                    ...
                    int iK = Utf8.k(str);
                    t(iK);
                    this.f4412d = Utf8.i(str, this.f4410b, this.f4412d, iK);
                    this.f4413e += iK;
                }
            } catch (Utf8.UnpairedSurrogateException e2) {
                this.f4413e -= this.f4412d - i5;
                this.f4412d = i5;
                h(str, e2);
            } catch (IndexOutOfBoundsException e3) {
                throw new OutOfSpaceException(e3);
    ...
    private static final class OutputStreamEncoder extends AbstractBufferedEncoder {
        ...
        public void write(byte[] bArr, int i2, int i3) throws IOException {
            ...
            int i5 = this.f4412d;
            if (i4 - i5 >= i3) {
                System.arraycopy(bArr, i2, this.f4410b, i5, i3);
                this.f4412d += i3;
                this.f4413e += i3;
                return;
            }
            int i6 = i4 - i5;
            System.arraycopy(bArr, i2, this.f4410b, i5, i6);
            int i7 = i2 + i6;
            int i8 = i3 - i6;
            this.f4412d = this.f4411c;
            this.f4413e += i6;
            doFlush();
            if (i8 <= this.f4411c) {
                System.arraycopy(bArr, i7, this.f4410b, 0, i8);
                this.f4412d = i8;
            } else {
        ...
        public void write(ByteBuffer byteBuffer) throws IOException {
            ...
            int i3 = this.f4412d;
            if (i2 - i3 >= iRemaining) {
                byteBuffer.get(this.f4410b, i3, iRemaining);
                this.f4412d += iRemaining;
                this.f4413e += iRemaining;
                return;
            }
            int i4 = i2 - i3;
            byteBuffer.get(this.f4410b, i3, i4);
            ...
            while (true) {
                int i6 = this.f4411c;
                if (i5 > i6) {
                    byteBuffer.get(this.f4410b, 0, i6);
                    this.out.write(this.f4410b, 0, this.f4411c);
                    int i7 = this.f4411c;
                    i5 -= i7;
                    this.f4413e += i7;
                } else {
                    byteBuffer.get(this.f4410b, 0, i5);
                    this.f4412d = i5;
                    this.f4413e += i5;
                    return;
                }
        ...
        public void writeUInt32NoTag(int i2) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((i2 & (-128)) != 0) {
                    long j2 = this.position;
                    this.position = j2 + 1;
                    UnsafeUtil.D(j2, (byte) ((i2 & 127) | 128));
                    i2 >>>= 7;
                }
                long j3 = this.position;
                this.position = 1 + j3;
                UnsafeUtil.D(j3, (byte) i2);
                return;
            }
            while (true) {
        ...
        public void writeUInt64NoTag(long j2) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((j2 & (-128)) != 0) {
                    long j3 = this.position;
                    this.position = j3 + 1;
                    UnsafeUtil.D(j3, (byte) ((((int) j2) & 127) | 128));
                    j2 >>>= 7;
                }
                long j4 = this.position;
                this.position = 1 + j4;
                UnsafeUtil.D(j4, (byte) j2);
                return;
            }
            while (true) {
                ...
                if ((j2 & (-128)) == 0) {
                    this.position = 1 + j5;
                    UnsafeUtil.D(j5, (byte) j2);
                    return;
                } else {
                    this.position = j5 + 1;
                    UnsafeUtil.D(j5, (byte) ((((int) j2) & 127) | 128));
                    j2 >>>= 7;
                }
            }
        }
    ...
    @InlineMe(imports = {"androidx.health.platform.client.proto.CodedOutputStream"}, replacement = "CodedOutputStream.computeUInt32SizeNoTag(value)")
    @Deprecated
    public static int computeRawVarint32Size(int i2) {
        return computeUInt32SizeNoTag(i2);
    }

    @InlineMe(imports = {"androidx.health.platform.client.proto.CodedOutputStream"}, replacement = "CodedOutputStream.computeUInt64SizeNoTag(value)")
    @Deprecated
    ...
    public static int computeStringSizeNoTag(String str) {
        ...
        try {
            ...
            length = str.getBytes(Internal.f4458b).length;
        }
        return d(length);
    }
    ...
    final void h(String str, Utf8.UnpairedSurrogateException unpairedSurrogateException) throws IOException {
        ...
        byte[] bytes = str.getBytes(Internal.f4458b);
        try {
