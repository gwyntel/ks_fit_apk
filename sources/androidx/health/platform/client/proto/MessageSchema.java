...
final class MessageSchema<T> implements Schema<T> {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f4468a[WireFormat.FieldType.BYTES.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f4468a[WireFormat.FieldType.DOUBLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f4468a[WireFormat.FieldType.FIXED32.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f4468a[WireFormat.FieldType.SFIXED32.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f4468a[WireFormat.FieldType.FIXED64.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f4468a[WireFormat.FieldType.SFIXED64.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f4468a[WireFormat.FieldType.FLOAT.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f4468a[WireFormat.FieldType.ENUM.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f4468a[WireFormat.FieldType.INT32.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f4468a[WireFormat.FieldType.UINT32.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f4468a[WireFormat.FieldType.INT64.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f4468a[WireFormat.FieldType.UINT64.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f4468a[WireFormat.FieldType.MESSAGE.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f4468a[WireFormat.FieldType.SINT32.ordinal()] = 15;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                f4468a[WireFormat.FieldType.SINT64.ordinal()] = 16;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                f4468a[WireFormat.FieldType.STRING.ordinal()] = 17;
        ...
        while (i5 < fields.length) {
            ...
            if (fieldInfo2.getType() == FieldType.MAP) {
                ...
                if (fieldInfo2.getType().id() >= 18 && fieldInfo2.getType().id() <= 49) {
                    i2 = i6;
                    iArr3[i9] = (int) UnsafeUtil.B(fieldInfo2.getField());
                    i9++;
                }
                i5++;
                i6 = i2 + 3;
    ...
    */
    static androidx.health.platform.client.proto.MessageSchema d(androidx.health.platform.client.proto.RawMessageInfo r33, androidx.health.platform.client.proto.NewInstanceSchema r34, androidx.health.platform.client.proto.ListFieldSchema r35, androidx.health.platform.client.proto.UnknownFieldSchema r36, androidx.health.platform.client.proto.ExtensionSchema r37, androidx.health.platform.client.proto.MapFieldSchema r38) {
        /*
            Method dump skipped, instructions count: 994
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.health.platform.client.proto.MessageSchema.d(androidx.health.platform.client.proto.RawMessageInfo, androidx.health.platform.client.proto.NewInstanceSchema, androidx.health.platform.client.proto.ListFieldSchema, androidx.health.platform.client.proto.UnknownFieldSchema, androidx.health.platform.client.proto.ExtensionSchema, androidx.health.platform.client.proto.MapFieldSchema):androidx.health.platform.client.proto.MessageSchema");
    }
    ...
    private int decodeMapEntryValue(byte[] bArr, int i2, int i3, WireFormat.FieldType fieldType, Class<?> cls, ArrayDecoders.Registers registers) throws IOException {
        switch (AnonymousClass1.f4468a[fieldType.ordinal()]) {
            case 1:
    ...
    /* JADX WARN: Code restructure failed: missing block: B:49:0x00b7, code lost:
        ...
        return;
     */
    /* JADX WARN: Removed duplicated region for block: B:172:0x064f A[Catch: all -> 0x0675, TRY_LEAVE, TryCatch #8 {all -> 0x0675, blocks: (B:170:0x0649, B:172:0x064f, B:184:0x0679, B:185:0x067e), top: B:212:0x0649 }] */
    ...
    */
    ...
    private final <K, V> void mergeMap(Object obj, int i2, Object obj2, ExtensionRegistryLite extensionRegistryLite, Reader reader) throws IOException {
        ...
        if (objX == null) {
            ...
            UnsafeUtil.J(obj, jOffset, objNewMapField);
            objX = objNewMapField;
        }
    ...
    private void mergeSingleField(T t2, T t3, int i2) {
        ...
        switch (type(iTypeAndOffsetAt)) {
            case 0:
                if (isFieldPresent(t3, i2)) {
                    UnsafeUtil.F(t2, jOffset, UnsafeUtil.s(t3, jOffset));
                    setFieldPresent(t2, i2);
                    break;
                }
                break;
            case 1:
                if (isFieldPresent(t3, i2)) {
                    UnsafeUtil.G(t2, jOffset, UnsafeUtil.t(t3, jOffset));
                    setFieldPresent(t2, i2);
                    break;
                }
                break;
            case 2:
                if (isFieldPresent(t3, i2)) {
                    UnsafeUtil.I(t2, jOffset, UnsafeUtil.w(t3, jOffset));
                    setFieldPresent(t2, i2);
                    break;
                }
                break;
            ...
            case 4:
                if (isFieldPresent(t3, i2)) {
                    UnsafeUtil.H(t2, jOffset, UnsafeUtil.u(t3, jOffset));
                    setFieldPresent(t2, i2);
                    break;
                }
                break;
            ...
            case 8:
                if (isFieldPresent(t3, i2)) {
                    UnsafeUtil.J(t2, jOffset, UnsafeUtil.x(t3, jOffset));
                    setFieldPresent(t2, i2);
                    break;
                }
                break;
            ...
            case 59:
                if (i6 == 2) {
                    ...
                    if (i14 == 0) {
                        ...
                        unsafe.putObject(t2, j2, new String(bArr, I2, i14, Internal.f4458b));
                        I2 += i14;
                    }
                    unsafe.putInt(t2, j3, i5);
                    return I2;
    ...
    */
    ...
    private void setFieldPresent(T t2, int i2) {
        ...
        UnsafeUtil.H(t2, j2, (1 << (iPresenceMaskAndOffsetAt >>> 20)) | UnsafeUtil.u(t2, j2));
    }

    private void setOneofPresent(T t2, int i2, int i3) {
        UnsafeUtil.H(t2, presenceMaskAndOffsetAt(i3) & 1048575, i2);
    }
    ...
    */
    private static void storeFieldData(androidx.health.platform.client.proto.FieldInfo r8, int[] r9, int r10, java.lang.Object[] r11) {
        /*
            ...
            long r3 = androidx.health.platform.client.proto.UnsafeUtil.B(r3)
            int r3 = (int) r3
            java.lang.reflect.Field r0 = r0.getCaseField()
            long r4 = androidx.health.platform.client.proto.UnsafeUtil.B(r0)
        L22:
            int r0 = (int) r4
            r4 = r1
            goto L6c
        L25:
            ...
            long r2 = androidx.health.platform.client.proto.UnsafeUtil.B(r2)
            int r3 = (int) r2
            int r2 = r0.id()
                        ...
                        switch (iType) {
                            case 0:
                                ...
                                if (i32 != 1) {
                                    ...
                                    UnsafeUtil.F(t2, jOffset, ArrayDecoders.d(bArr2, i30));
                                    iG = i30 + 8;
                                    i27 = i16 | i36;
                                    i24 = i4;
                                    i25 = i20;
                            ...
                            case 1:
                                ...
                                if (i32 != 5) {
                                    ...
                                    UnsafeUtil.G(t2, jOffset, ArrayDecoders.l(bArr2, i30));
                                    iG = i30 + 4;
                                    i27 = i16 | i36;
                                    i24 = i4;
                                    i25 = i20;
                            ...
                            case 7:
                                ...
                                if (i32 != 0) {
                                    ...
                                    UnsafeUtil.C(t2, jOffset, registers2.long1 != 0);
                                    i27 = i16 | i36;
                                    i24 = i4;
                                    i25 = i20;
                                    i26 = i19;
    ...
    */
    public final boolean isInitialized(T r18) {
        ...
        Lb1:
            ...
            androidx.health.platform.client.proto.FieldSet r0 = r0.c(r7)
    ...
    private boolean equals(T t2, T t3, int i2) {
        ...
        switch (type(iTypeAndOffsetAt)) {
            ...
            case 7:
                ...
                break;
            case 8:
                if (arePresentForEquals(t2, t3, i2) && SchemaUtil.E(UnsafeUtil.x(t2, jOffset), UnsafeUtil.x(t3, jOffset))) {
                    break;
                }
                break;
            case 9:
            ...
            case 67:
            case 68:
                if (isOneofCaseEqual(t2, t3, i2) && SchemaUtil.E(UnsafeUtil.x(t2, jOffset), UnsafeUtil.x(t3, jOffset))) {
                    break;
                }
                break;
        }
