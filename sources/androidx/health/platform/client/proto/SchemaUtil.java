...
final class SchemaUtil {
        ...
        if (list instanceof RandomAccess) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                ...
                if (enumVerifier.isInRange(iIntValue)) {
                    ...
                    obj2 = F(obj, i2, iIntValue, obj2, unknownFieldSchema);
                }
            }
            if (i3 != size) {
            ...
            while (it.hasNext()) {
                ...
                if (!enumVerifier.isInRange(iIntValue2)) {
                    obj2 = F(obj, i2, iIntValue2, obj2, unknownFieldSchema);
                    it.remove();
                }
            }
        }
    ...
    static void C(MapFieldSchema mapFieldSchema, Object obj, Object obj2, long j2) {
        UnsafeUtil.J(obj, j2, mapFieldSchema.mergeFrom(UnsafeUtil.x(obj, j2), UnsafeUtil.x(obj2, j2)));
    }
    ...
    static Object F(Object obj, int i2, int i3, Object obj2, UnknownFieldSchema unknownFieldSchema) {
        if (obj2 == null) {
