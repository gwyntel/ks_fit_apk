...
final class Utf8 {
        ...
        */
        final int m(int r7, java.nio.ByteBuffer r8, int r9, int r10) {
            ...
            L1e:
                ...
                byte r9 = r8.get(r9)
                if (r7 < r10) goto L35
                int r7 = androidx.health.platform.client.proto.Utf8.a(r0, r9)
                return r7
            L35:
                r5 = r9
                r9 = r7
            ...
            L4f:
                ...
                byte r1 = r8.get(r9)
                if (r7 < r10) goto L62
                int r7 = androidx.health.platform.client.proto.Utf8.a(r0, r1)
                return r7
            L62:
                r9 = 0
                goto L6a
            ...
            L6a:
                ...
                byte r7 = r8.get(r7)
                if (r9 < r10) goto L79
                int r7 = androidx.health.platform.client.proto.Utf8.b(r0, r1, r7)
                return r7
            L79:
                r5 = r9
                r9 = r7
            ...
            L92:
                ...
                return r7
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.health.platform.client.proto.Utf8.Processor.m(int, java.nio.ByteBuffer, int, int):int");
        }
        ...
        */
        int l(int r7, byte[] r8, int r9, int r10) {
            ...
            L86:
                ...
                return r7
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.health.platform.client.proto.Utf8.SafeProcessor.l(int, byte[], int, int):int");
        }
    ...
    static final class UnsafeProcessor extends Processor {
        ...
        static boolean o() {
            return UnsafeUtil.z() && UnsafeUtil.A();
        }
        ...
        */
        private static int partialIsValidUtf8(byte[] r10, long r11, int r13) {
            ...
            L9:
                ...
                if (r13 <= 0) goto L1a
                long r4 = r11 + r2
                byte r1 = androidx.health.platform.client.proto.UnsafeUtil.r(r10, r11)
                if (r1 < 0) goto L19
                int r13 = r13 + (-1)
                r11 = r4
                goto L9
            ...
            L29:
                ...
                if (r1 < r0) goto L39
                long r2 = r2 + r11
                byte r11 = androidx.health.platform.client.proto.UnsafeUtil.r(r10, r11)
                if (r11 <= r6) goto L37
                goto L39
            L37:
                r11 = r2
            ...
            L48:
                int r13 = r13 + (-3)
                long r2 = r2 + r11
                byte r0 = androidx.health.platform.client.proto.UnsafeUtil.r(r10, r11)
                if (r0 > r6) goto L64
                r7 = -96
                if (r1 != r4) goto L57
                if (r0 < r7) goto L64
            ...
            L5d:
                long r11 = r11 + r8
                byte r0 = androidx.health.platform.client.proto.UnsafeUtil.r(r10, r2)
                if (r0 <= r6) goto L7
            L64:
                return r5
            L65:
            ...
            L6d:
                ...
                r0 = 3
                long r11 = r11 + r0
                byte r0 = androidx.health.platform.client.proto.UnsafeUtil.r(r10, r8)
                if (r0 <= r6) goto L7
            L8f:
                return r5
            */
        ...
        private static int unsafeEstimateConsecutiveAscii(byte[] bArr, long j2, int i2) {
            ...
            while (true) {
                int i5 = i3 + 8;
                if (i5 > i2 || (UnsafeUtil.w(bArr, UnsafeUtil.f4505a + j2) & Utf8.ASCII_MASK_LONG) != 0) {
                    break;
                }
                j2 += 8;
                i3 = i5;
        ...
        @Override // androidx.health.platform.client.proto.Utf8.Processor
        String b(byte[] bArr, int i2, int i3) throws InvalidProtocolBufferException {
            Charset charset = Internal.f4458b;
        ...
        int e(CharSequence charSequence, byte[] bArr, int i2, int i3) {
            ...
            while (true) {
                ...
                UnsafeUtil.E(bArr, j5, (byte) cCharAt);
                i5++;
                j5 = 1 + j5;
            }
            if (i5 == length) {
            ...
            while (i5 < length) {
                ...
                if (cCharAt2 >= 128 || j5 >= j6) {
                    if (cCharAt2 >= 2048 || j5 > j6 - 2) {
                        ...
                        if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || j5 > j6 - 3) {
                            ...
                            if (i6 != length) {
                                ...
                                if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                    int codePoint = Character.toCodePoint(cCharAt2, cCharAt3);
                                    j3 = 1;
                                    UnsafeUtil.E(bArr, j5, (byte) ((codePoint >>> 18) | 240));
                                    j4 = j6;
                                    UnsafeUtil.E(bArr, j5 + 1, (byte) (((codePoint >>> 12) & 63) | 128));
                                    long j7 = j5 + 3;
                                    UnsafeUtil.E(bArr, j5 + 2, (byte) (((codePoint >>> 6) & 63) | 128));
                                    j5 += 4;
                                    UnsafeUtil.E(bArr, j7, (byte) ((codePoint & 63) | 128));
                                    i5 = i6;
                                } else {
                                    i5 = i6;
                                }
                        ...
                        UnsafeUtil.E(bArr, j5, (byte) ((cCharAt2 >>> '\f') | 480));
                        long j8 = j5 + 2;
                        UnsafeUtil.E(bArr, j5 + 1, (byte) (((cCharAt2 >>> 6) & 63) | 128));
                        j5 += 3;
                        UnsafeUtil.E(bArr, j8, (byte) ((cCharAt2 & '?') | 128));
                    } else {
                        str = str3;
                        str2 = str4;
                        long j9 = j5 + j2;
                        UnsafeUtil.E(bArr, j5, (byte) ((cCharAt2 >>> 6) | 960));
                        j5 += 2;
                        UnsafeUtil.E(bArr, j9, (byte) ((cCharAt2 & '?') | 128));
                    }
                    j4 = j6;
                    j3 = 1;
                } else {
                    UnsafeUtil.E(bArr, j5, (byte) cCharAt2);
                    j4 = j6;
                    str2 = str4;
                    j3 = j2;
                    j5 += j2;
        ...
        void h(CharSequence charSequence, ByteBuffer byteBuffer) {
            ...
            while (true) {
                ...
                UnsafeUtil.D(jPosition, (byte) cCharAt);
                i4++;
                jPosition = 1 + jPosition;
            }
            if (i4 == length) {
                byteBuffer.position((int) (jPosition - jK));
                return;
            }
            while (i4 < length) {
                    ...
                    if (cCharAt2 >= 2048 || jPosition > jLimit - 2) {
                        ...
                        if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || jPosition > jLimit - 3) {
                            ...
                            if (i3 != length) {
                                ...
                                if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                    int codePoint = Character.toCodePoint(cCharAt2, cCharAt3);
                                    UnsafeUtil.D(jPosition, (byte) ((codePoint >>> 18) | 240));
                                    c3 = 128;
                                    UnsafeUtil.D(jPosition + 1, (byte) (((codePoint >>> 12) & 63) | 128));
                                    long j4 = jPosition + 3;
                                    UnsafeUtil.D(jPosition + 2, (byte) (((codePoint >>> 6) & 63) | 128));
                                    jPosition += 4;
                                    UnsafeUtil.D(j4, (byte) ((codePoint & 63) | 128));
                                } else {
                                    i4 = i3;
                                }
                            }
                        ...
                        UnsafeUtil.D(jPosition, (byte) ((cCharAt2 >>> '\f') | 480));
                        long j6 = jPosition + 2;
                        UnsafeUtil.D(j5, (byte) (((cCharAt2 >>> 6) & 63) | 128));
                        jPosition += 3;
                        UnsafeUtil.D(j6, (byte) ((cCharAt2 & '?') | 128));
                    } else {
                        j3 = jK;
                        long j7 = jPosition + j2;
                        UnsafeUtil.D(jPosition, (byte) ((cCharAt2 >>> 6) | 960));
                        jPosition += 2;
                        UnsafeUtil.D(j7, (byte) ((cCharAt2 & '?') | 128));
                    }
                    i3 = i4;
                    c3 = 128;
                } else {
                    UnsafeUtil.D(jPosition, (byte) cCharAt2);
                    j3 = jK;
                    i3 = i4;
                    c3 = c2;
                    jPosition += j2;
        ...
        /* JADX WARN: Code restructure failed: missing block: B:35:0x0059, code lost:
            ...
            if (androidx.health.platform.client.proto.UnsafeUtil.r(r13, r1) > (-65)) goto L38;
         */
        /* JADX WARN: Code restructure failed: missing block: B:58:0x009e, code lost:
        
            if (androidx.health.platform.client.proto.UnsafeUtil.r(r13, r1) > (-65)) goto L59;
         */
        @Override // androidx.health.platform.client.proto.Utf8.Processor
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        ...
        */
        int l(int r12, byte[] r13, int r14, int r15) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.health.platform.client.proto.Utf8.UnsafeProcessor.l(int, byte[], int, int):int");
        }

        /* JADX WARN: Code restructure failed: missing block: B:14:0x002e, code lost:
        
            if (androidx.health.platform.client.proto.UnsafeUtil.q(r1) > (-65)) goto L17;
         */
        /* JADX WARN: Code restructure failed: missing block: B:35:0x0062, code lost:
        
            if (androidx.health.platform.client.proto.UnsafeUtil.q(r1) > (-65)) goto L36;
         */
        /* JADX WARN: Code restructure failed: missing block: B:56:0x00a3, code lost:
        
            if (androidx.health.platform.client.proto.UnsafeUtil.q(r1) > (-65)) goto L57;
         */
        @Override // androidx.health.platform.client.proto.Utf8.Processor
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        ...
        */
        int n(int r11, java.nio.ByteBuffer r12, int r13, int r14) {
            /*
                ...
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.health.platform.client.proto.Utf8.UnsafeProcessor.n(int, java.nio.ByteBuffer, int, int):int");
        }
        ...
        */
        private static int partialIsValidUtf8(long r10, int r12) {
            ...
            L9:
                ...
                if (r12 <= 0) goto L1a
                long r4 = r10 + r2
                byte r1 = androidx.health.platform.client.proto.UnsafeUtil.q(r10)
                if (r1 < 0) goto L19
                int r12 = r12 + (-1)
                r10 = r4
                goto L9
            ...
            L29:
                ...
                if (r1 < r0) goto L39
                long r2 = r2 + r10
                byte r10 = androidx.health.platform.client.proto.UnsafeUtil.q(r10)
                if (r10 <= r6) goto L37
                goto L39
            L37:
                r10 = r2
            ...
            L48:
                int r12 = r12 + (-3)
                long r2 = r2 + r10
                byte r0 = androidx.health.platform.client.proto.UnsafeUtil.q(r10)
                if (r0 > r6) goto L64
                r7 = -96
                if (r1 != r4) goto L57
                if (r0 < r7) goto L64
            ...
            L5d:
                long r10 = r10 + r8
                byte r0 = androidx.health.platform.client.proto.UnsafeUtil.q(r2)
                if (r0 <= r6) goto L7
            L64:
                return r5
            L65:
            ...
            L6d:
                ...
                r0 = 3
                long r10 = r10 + r0
                byte r0 = androidx.health.platform.client.proto.UnsafeUtil.q(r8)
                if (r0 <= r6) goto L7
            L8f:
                return r5
            */
