...
public abstract class CodedInputStream {
    ...
    private static final class ArrayDecoder extends CodedInputStream {
        ...
        public String readString() throws IOException {
            ...
            if (rawVarint32 > 0) {
                ...
                int i3 = this.pos;
                if (rawVarint32 <= i2 - i3) {
                    String str = new String(this.buffer, i3, rawVarint32, Internal.f4458b);
                    this.pos += rawVarint32;
                    return str;
                }
            }
        ...
        public String readString() throws IOException {
            ...
            if (rawVarint32 > 0) {
                ...
                if (j2 <= j3 - j4) {
                    byte[] bArr = new byte[rawVarint32];
                    UnsafeUtil.m(j4, bArr, 0L, j2);
                    String str = new String(bArr, Internal.f4458b);
                    this.currentByteBufferPos += j2;
                    return str;
                }
            }
            if (rawVarint32 > 0 && rawVarint32 <= remaining()) {
                byte[] bArr2 = new byte[rawVarint32];
                readRawBytesTo(bArr2, 0, rawVarint32);
                return new String(bArr2, Internal.f4458b);
            }
            if (rawVarint32 == 0) {
                return "";
            }
    ...
    private static final class StreamDecoder extends CodedInputStream {
        ...
        private void refillBuffer(int i2) throws IOException {
            ...
            if (i2 <= (this.f4405c - this.totalBytesRetired) - this.pos) {
                throw InvalidProtocolBufferException.truncatedMessage();
            }
            throw InvalidProtocolBufferException.sizeLimitExceeded();
        }
        ...
        private boolean tryRefillBuffer(int i2) throws IOException {
            ...
            int i9 = read(inputStream, bArr2, i8, Math.min(bArr2.length - i8, (this.f4405c - this.totalBytesRetired) - i8));
        ...
        public String readString() throws IOException {
            ...
            if (rawVarint32 > this.bufferSize) {
                return new String(readRawBytesSlowPath(rawVarint32, false), Internal.f4458b);
            }
            refillBuffer(rawVarint32);
            String str2 = new String(this.buffer, this.pos, rawVarint32, Internal.f4458b);
            this.pos += rawVarint32;
            return str2;
        }
    ...
    private static final class UnsafeDirectNioDecoder extends CodedInputStream {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:33:0x008c, code lost:
            ...
            if (androidx.health.platform.client.proto.UnsafeUtil.q(r3) < 0) goto L34;
         */
        @Override // androidx.health.platform.client.proto.CodedInputStream
        /*
        ...
        */
        public int readRawVarint32() throws java.io.IOException {
            ...
            La:
                r2 = 1
                long r2 = r2 + r0
                byte r4 = androidx.health.platform.client.proto.UnsafeUtil.q(r0)
                if (r4 < 0) goto L16
                r9.pos = r2
                return r4
            L16:
            ...
            L21:
                r5 = 2
                long r5 = r5 + r0
                byte r2 = androidx.health.platform.client.proto.UnsafeUtil.q(r2)
                int r2 = r2 << 7
                r2 = r2 ^ r4
                if (r2 >= 0) goto L31
            ...
            L31:
                r3 = 3
                long r3 = r3 + r0
                byte r5 = androidx.health.platform.client.proto.UnsafeUtil.q(r5)
                int r5 = r5 << 14
                r2 = r2 ^ r5
                if (r2 < 0) goto L41
            ...
            L41:
                r5 = 4
                long r5 = r5 + r0
                byte r3 = androidx.health.platform.client.proto.UnsafeUtil.q(r3)
                int r3 = r3 << 21
                r2 = r2 ^ r3
                if (r2 >= 0) goto L52
            ...
            L52:
                ...
                r5 = 10
                long r5 = r5 + r0
                byte r0 = androidx.health.platform.client.proto.UnsafeUtil.q(r3)
                if (r0 >= 0) goto L94
            L8e:
                long r0 = r9.f()
                int r0 = (int) r0
    ...
    private CodedInputStream() {
        this.f4404b = defaultRecursionLimit;
        this.f4405c = Integer.MAX_VALUE;
