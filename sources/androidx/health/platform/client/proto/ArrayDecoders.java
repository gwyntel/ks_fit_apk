...
final class ArrayDecoders {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f4394a[WireFormat.FieldType.FLOAT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f4394a[WireFormat.FieldType.INT64.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f4394a[WireFormat.FieldType.UINT64.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f4394a[WireFormat.FieldType.INT32.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f4394a[WireFormat.FieldType.UINT32.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f4394a[WireFormat.FieldType.FIXED64.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f4394a[WireFormat.FieldType.SFIXED64.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f4394a[WireFormat.FieldType.FIXED32.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f4394a[WireFormat.FieldType.SFIXED32.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f4394a[WireFormat.FieldType.BOOL.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f4394a[WireFormat.FieldType.SINT32.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f4394a[WireFormat.FieldType.SINT64.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f4394a[WireFormat.FieldType.ENUM.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f4394a[WireFormat.FieldType.BYTES.ordinal()] = 15;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                f4394a[WireFormat.FieldType.STRING.ordinal()] = 16;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                f4394a[WireFormat.FieldType.GROUP.ordinal()] = 17;
            } catch (NoSuchFieldError unused17) {
            }
            try {
                f4394a[WireFormat.FieldType.MESSAGE.ordinal()] = 18;
    ...
    static int C(byte[] bArr, int i2, Registers registers) throws InvalidProtocolBufferException {
        ...
        registers.object1 = new String(bArr, I, i3, Internal.f4458b);
        return I + i3;
    }
    ...
    static int D(int i2, byte[] bArr, int i3, int i4, Internal.ProtobufList protobufList, Registers registers) throws InvalidProtocolBufferException {
        ...
        if (i5 == 0) {
            ...
            protobufList.add(new String(bArr, I, i5, Internal.f4458b));
            I += i5;
        }
        while (I < i4) {
            int I2 = I(bArr, I, registers);
            ...
            if (i6 == 0) {
                ...
                protobufList.add(new String(bArr, I, i6, Internal.f4458b));
                I += i6;
            }
        }
        return I;
    ...
    static int E(int i2, byte[] bArr, int i3, int i4, Internal.ProtobufList protobufList, Registers registers) throws InvalidProtocolBufferException {
        ...
        while (I < i4) {
            ...
            if (i7 == 0) {
                ...
                protobufList.add(new String(bArr, I, i7, Internal.f4458b));
                I = i8;
            }
        }
        return I;
    ...
    static int f(int i2, byte[] bArr, int i3, int i4, GeneratedMessageLite.ExtendableMessage extendableMessage, GeneratedMessageLite.GeneratedExtension generatedExtension, UnknownFieldSchema unknownFieldSchema, Registers registers) throws IOException {
        ...
        if (generatedExtension.f4454d.isRepeated() && generatedExtension.f4454d.isPacked()) {
            switch (AnonymousClass1.f4394a[generatedExtension.getLiteType().ordinal()]) {
                case 1:
                    DoubleArrayList doubleArrayList = new DoubleArrayList();
                    int iS = s(bArr, i3, doubleArrayList, registers);
                    fieldSet.setField(generatedExtension.f4454d, doubleArrayList);
                    return iS;
                case 2:
                    FloatArrayList floatArrayList = new FloatArrayList();
                    int iV = v(bArr, i3, floatArrayList, registers);
                    fieldSet.setField(generatedExtension.f4454d, floatArrayList);
                    return iV;
                case 3:
                case 4:
                    LongArrayList longArrayList = new LongArrayList();
                    int iZ = z(bArr, i3, longArrayList, registers);
                    fieldSet.setField(generatedExtension.f4454d, longArrayList);
                    return iZ;
                case 5:
                case 6:
                    IntArrayList intArrayList = new IntArrayList();
                    int iY = y(bArr, i3, intArrayList, registers);
                    fieldSet.setField(generatedExtension.f4454d, intArrayList);
                    return iY;
                case 7:
                case 8:
                    LongArrayList longArrayList2 = new LongArrayList();
                    int iU = u(bArr, i3, longArrayList2, registers);
                    fieldSet.setField(generatedExtension.f4454d, longArrayList2);
                    return iU;
                case 9:
                case 10:
                    IntArrayList intArrayList2 = new IntArrayList();
                    int iT = t(bArr, i3, intArrayList2, registers);
                    fieldSet.setField(generatedExtension.f4454d, intArrayList2);
                    return iT;
                case 11:
                    BooleanArrayList booleanArrayList = new BooleanArrayList();
                    int iR = r(bArr, i3, booleanArrayList, registers);
                    fieldSet.setField(generatedExtension.f4454d, booleanArrayList);
                    return iR;
                case 12:
                    IntArrayList intArrayList3 = new IntArrayList();
                    int iW = w(bArr, i3, intArrayList3, registers);
                    fieldSet.setField(generatedExtension.f4454d, intArrayList3);
                    return iW;
                case 13:
                    LongArrayList longArrayList3 = new LongArrayList();
                    int iX = x(bArr, i3, longArrayList3, registers);
                    fieldSet.setField(generatedExtension.f4454d, longArrayList3);
                    return iX;
                case 14:
                    IntArrayList intArrayList4 = new IntArrayList();
                    int iY2 = y(bArr, i3, intArrayList4, registers);
                    SchemaUtil.z(extendableMessage, i5, intArrayList4, generatedExtension.f4454d.getEnumType(), null, unknownFieldSchema);
                    fieldSet.setField(generatedExtension.f4454d, intArrayList4);
                    return iY2;
                default:
        ...
        if (generatedExtension.getLiteType() == WireFormat.FieldType.ENUM) {
            i3 = I(bArr, i3, registers);
            if (generatedExtension.f4454d.getEnumType().findValueByNumber(registers.int1) == null) {
                SchemaUtil.F(extendableMessage, i5, registers.int1, null, unknownFieldSchema);
                return i3;
            }
            ...
            switch (AnonymousClass1.f4394a[generatedExtension.getLiteType().ordinal()]) {
                ...
                case 17:
                    ...
                    if (generatedExtension.isRepeated()) {
                        ...
                        fieldSet.addRepeatedField(generatedExtension.f4454d, registers.object1);
                        return iN;
                    }
                    Object field = fieldSet.getField(generatedExtension.f4454d);
                    if (field == null) {
                        field = schemaSchemaFor.newInstance();
                        fieldSet.setField(generatedExtension.f4454d, field);
                    }
                ...
                case 18:
                    ...
                    if (field2 == null) {
                        ...
                        fieldSet.setField(generatedExtension.f4454d, field2);
                    }
