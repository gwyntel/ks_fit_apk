...
public final class Internal {
    ...
    static final Charset f4457a = Charset.forName("US-ASCII");

    /* renamed from: b, reason: collision with root package name */
    static final Charset f4458b = Charset.forName("UTF-8");

    /* renamed from: c, reason: collision with root package name */
    static final Charset f4459c = Charset.forName("ISO-8859-1");
    ...
    public static ByteString bytesDefaultValue(String str) {
        return ByteString.copyFrom(str.getBytes(f4459c));
    }
    ...
    public static String stringDefaultValue(String str) {
        return new String(str.getBytes(f4459c), f4458b);
    }

    public static byte[] toByteArray(String str) {
        return str.getBytes(f4458b);
    }

    public static String toStringUtf8(byte[] bArr) {
        return new String(bArr, f4458b);
    }
