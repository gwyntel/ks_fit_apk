...
public final class UnregisterFromDataNotificationsRequest extends ProtoParcelable<RequestProto.UnregisterFromDataNotificationsRequest> {
    ...
    public static final Parcelable.Creator<UnregisterFromDataNotificationsRequest> CREATOR = new Parcelable.Creator<UnregisterFromDataNotificationsRequest>() { // from class: androidx.health.platform.client.request.UnregisterFromDataNotificationsRequest$special$$inlined$newCreator$connect_client_release$1
        ...
        @SuppressLint({"NewApi"})
        @Nullable
        public UnregisterFromDataNotificationsRequest createFromParcel(@NotNull Parcel source) throws InvalidProtocolBufferException {
            ...
            if (i2 != 0) {
                if (i2 == 1) {
                    return (ProtoParcelable) SharedMemory27Impl.INSTANCE.parseParcelUsingSharedMemory(source, new Function1<byte[], UnregisterFromDataNotificationsRequest>() { // from class: androidx.health.platform.client.request.UnregisterFromDataNotificationsRequest$special$$inlined$newCreator$connect_client_release$1.1
                        ...
                        @NotNull
                        public final UnregisterFromDataNotificationsRequest invoke(@NotNull byte[] it) throws InvalidProtocolBufferException {
    ...
    public UnregisterFromDataNotificationsRequest(@NotNull RequestProto.UnregisterFromDataNotificationsRequest proto) {
