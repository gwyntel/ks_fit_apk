...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    final DifferentialMotionFlingTargetImpl f3843a;

    /* renamed from: b, reason: collision with root package name */
    DifferentialMotionFlingController f3844b;
        ...
        public boolean performAccessibilityAction(View view, int i2, Bundle bundle) {
            ...
            if (i2 != 4096) {
                if (i2 == 8192 || i2 == 16908344) {
                    ...
                    nestedScrollView.f(0, iMax, true);
                    return true;
                }
                if (i2 != 16908346) {
                    return false;
            ...
            nestedScrollView.f(0, iMin, true);
            return true;
        }
    }
    ...
    static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            return "HorizontalScrollView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " scrollPosition=" + this.scrollPosition + i.f9804d;
        }
    ...
    */
    ...
    private int scrollBy(int i2, int i3, int i4, boolean z2) {
        ...
        boolean z5 = d(0, i5, 0, scrollY, 0, scrollRange, 0, 0, true) && !hasNestedScrollingParent(i4);
        int scrollY2 = getScrollY() - scrollY;
    ...
    public boolean arrowScroll(int i2) {
        ...
        if (viewFindNextFocus == null || !isWithinDeltaOfScreen(viewFindNextFocus, maxScrollAmount, getHeight())) {
            ...
            scrollBy(b(this.mTempRect), 0, 1, true);
    ...
    public void computeScroll() {
        ...
        int iC = c(currY - this.mLastScrollerY);
        this.mLastScrollerY = currY;
        int[] iArr = this.mScrollConsumed;
        iArr[1] = 0;
        dispatchNestedPreScroll(0, iC, iArr, null, 1);
        int i2 = iC - this.mScrollConsumed[1];
        int scrollRange = getScrollRange();
        if (i2 != 0) {
            int scrollY = getScrollY();
    ...
    boolean d(int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, boolean z2) {
        boolean z3;
        boolean z4;
        int overScrollMode = getOverScrollMode();
    ...
    public boolean onGenericMotionEvent(@NonNull MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 8 && !this.mIsBeingDragged) {
            ...
            if (axisValue != 0.0f) {
                ...
                if (i2 != 0) {
                    this.f3844b.onMotionEvent(motionEvent, i2);
                }
                return true;
            }
        }
    ...
    */
    ...
    public NestedScrollView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        this.f3843a = differentialMotionFlingTargetImpl;
        this.f3844b = new DifferentialMotionFlingController(getContext(), differentialMotionFlingTargetImpl);
