...
public abstract class AutoScrollHelper implements View.OnTouchListener {
    ...
    final ClampedScroller f3833a = new ClampedScroller();
    ...
    private static class ClampedScroller {
        ...
        private float getValueAt(long j2) {
            ...
            if (j3 < 0 || j2 < j3) {
                return AutoScrollHelper.b((j2 - r0) / this.mRampUpDuration, 0.0f, 1.0f) * 0.5f;
            }
            float f2 = this.mStopValue;
            return (1.0f - f2) + (f2 * AutoScrollHelper.b((j2 - j3) / this.mEffectiveRampDown, 0.0f, 1.0f));
        }
        ...
        public void requestStop() {
            long jCurrentAnimationTimeMillis = AnimationUtils.currentAnimationTimeMillis();
            this.mEffectiveRampDown = AutoScrollHelper.c((int) (jCurrentAnimationTimeMillis - this.mStartTime), 0, this.mRampDownDuration);
    ...
    private class ScrollAnimationRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (autoScrollHelper.f3837e) {
                if (autoScrollHelper.f3835c) {
                    autoScrollHelper.f3835c = false;
                    autoScrollHelper.f3833a.start();
                }
                ClampedScroller clampedScroller = AutoScrollHelper.this.f3833a;
                if (clampedScroller.isFinished() || !AutoScrollHelper.this.d()) {
                    AutoScrollHelper.this.f3837e = false;
                    return;
                }
                AutoScrollHelper autoScrollHelper2 = AutoScrollHelper.this;
                if (autoScrollHelper2.f3836d) {
                    autoScrollHelper2.f3836d = false;
                    autoScrollHelper2.a();
                }
                clampedScroller.computeScrollDelta();
                AutoScrollHelper.this.scrollTargetBy(clampedScroller.getDeltaX(), clampedScroller.getDeltaY());
                ViewCompat.postOnAnimation(AutoScrollHelper.this.f3834b, this);
            }
        }
    }
    ...
    private float computeTargetVelocity(int i2, float f2, float f3, float f4) {
        ...
        float f8 = f5 * f4;
        return edgeValue > 0.0f ? b(edgeValue * f8, f6, f7) : -b((-edgeValue) * f8, f6, f7);
    }
    ...
    private float getEdgeValue(float f2, float f3, float f4, float f5) {
        float interpolation;
        float fB = b(f2 * f3, 0.0f, f4);
        float fConstrainEdgeValue = constrainEdgeValue(f3 - f5, fB) - constrainEdgeValue(f5, fB);
    ...
    private void startAnimating() {
        ...
        if (this.mAlreadyDelayed || (i2 = this.mActivationDelay) <= 0) {
            ...
            ViewCompat.postOnAnimationDelayed(this.f3834b, this.mRunnable, i2);
        }
    ...
    void a() {
        ...
        this.f3834b.onTouchEvent(motionEventObtain);
    ...
    boolean d() {
        ClampedScroller clampedScroller = this.f3833a;
    ...
    */
    public boolean onTouch(android.view.View r6, android.view.MotionEvent r7) {
        ...
        L1e:
            ...
            int r3 = r6.getWidth()
            float r3 = (float) r3
            android.view.View r4 = r5.f3834b
            int r4 = r4.getWidth()
            float r4 = (float) r4
            ...
            int r6 = r6.getHeight()
            float r6 = (float) r6
            android.view.View r3 = r5.f3834b
            int r3 = r3.getHeight()
            float r3 = (float) r3
            float r6 = r5.computeTargetVelocity(r2, r7, r6, r3)
            androidx.core.widget.AutoScrollHelper$ClampedScroller r7 = r5.f3833a
            r7.setTargetVelocity(r0, r6)
            boolean r6 = r5.f3837e
            if (r6 != 0) goto L58
            boolean r6 = r5.d()
            if (r6 == 0) goto L58
            r5.startAnimating()
    ...
    public AutoScrollHelper setRampDownDuration(int i2) {
        this.f3833a.setRampDownDuration(i2);
        return this;
    }

    @NonNull
    public AutoScrollHelper setRampUpDuration(int i2) {
        this.f3833a.setRampUpDuration(i2);
        return this;
    }
