...
public final class PointerIconCompat {
    ...
    public static PointerIconCompat create(@NonNull Bitmap bitmap, float f2, float f3) {
        return Build.VERSION.SDK_INT >= 24 ? new PointerIconCompat(Api24Impl.a(bitmap, f2, f3)) : new PointerIconCompat(null);
    }

    @NonNull
    public static PointerIconCompat getSystemIcon(@NonNull Context context, int i2) {
        return Build.VERSION.SDK_INT >= 24 ? new PointerIconCompat(Api24Impl.b(context, i2)) : new PointerIconCompat(null);
    }

    @NonNull
    public static PointerIconCompat load(@NonNull Resources resources, int i2) {
        return Build.VERSION.SDK_INT >= 24 ? new PointerIconCompat(Api24Impl.c(resources, i2)) : new PointerIconCompat(null);
    }
