...
public abstract class NotificationCompatSideChannelService extends Service {
    ...
    private class NotificationSideChannelStub extends INotificationSideChannel.Stub {
        ...
        final /* synthetic */ NotificationCompatSideChannelService f3464a;

        @Override // android.support.v4.app.INotificationSideChannel
        public void cancel(String str, int i2, String str2) throws RemoteException {
            this.f3464a.a(Binder.getCallingUid(), str);
            long jClearCallingIdentity = Binder.clearCallingIdentity();
            try {
                this.f3464a.cancel(str, i2, str2);
            } finally {
        ...
        public void notify(String str, int i2, String str2, Notification notification) throws RemoteException {
            ...
            long jClearCallingIdentity = Binder.clearCallingIdentity();
            try {
                this.f3464a.notify(str, i2, str2, notification);
            } finally {
                Binder.restoreCallingIdentity(jClearCallingIdentity);
            }
        }
