...
public final class RemoteInput {
    ...
    static class Api20Impl {
        ...
        static RemoteInput b(Object obj) {
            ...
            if (Build.VERSION.SDK_INT >= 29) {
                builderAddExtras.setEditChoicesBeforeSending(Api29Impl.a(remoteInput));
            }
        ...
        public static android.app.RemoteInput fromCompat(RemoteInput remoteInput) {
            ...
            if (Build.VERSION.SDK_INT >= 29) {
                Api29Impl.b(builderAddExtras, remoteInput.getEditChoicesBeforeSending());
            }
            return builderAddExtras.build();
        }
    }
    ...
    RemoteInput(String str, CharSequence charSequence, CharSequence[] charSequenceArr, boolean z2, int i2, Bundle bundle, Set set) {
        this.mResultKey = str;
        this.mLabel = charSequence;
        this.mChoices = charSequenceArr;
        this.mAllowFreeFormTextInput = z2;
    ...
    public static void addResultsToIntent(@NonNull RemoteInput[] remoteInputArr, @NonNull Intent intent, @NonNull Bundle bundle) {
        if (Build.VERSION.SDK_INT >= 26) {
            Api20Impl.a(b(remoteInputArr), intent, bundle);
            return;
        }
        ...
        for (RemoteInput remoteInput : remoteInputArr) {
            ...
            Api20Impl.a(b(new RemoteInput[]{remoteInput}), intent, bundle);
