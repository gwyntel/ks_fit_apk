...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static PrecomputedTextCompat create(@NonNull CharSequence charSequence, @NonNull Params params) {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= 29 && (params2 = params.f3699a) != null) {
    ...
    private PrecomputedTextCompat(@NonNull PrecomputedText precomputedText, @NonNull Params params) {
        this.mText = Api28Impl.a(precomputedText);
        this.mParams = params;
    ...
    public static final class Params {
        ...
        final PrecomputedText.Params f3699a;
        ...
        Params(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i2, int i3) {
            if (Build.VERSION.SDK_INT >= 29) {
                this.f3699a = k.a(textPaint).setBreakStrategy(i2).setHyphenationFrequency(i3).setTextDirection(textDirectionHeuristic).build();
            } else {
                this.f3699a = null;
            }
            this.mPaint = textPaint;
        ...
        public Params(@NonNull PrecomputedText.Params params) {
            ...
            this.f3699a = Build.VERSION.SDK_INT < 29 ? null : params;
        }
    }
}
