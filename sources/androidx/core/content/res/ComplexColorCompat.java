...
public final class ComplexColorCompat {
    ...
    static ComplexColorCompat a(int i2) {
    ...
    static ComplexColorCompat c(Shader shader) {
    ...
    private static ComplexColorCompat createFromXml(@NonNull Resources resources, @ColorRes int i2, @Nullable Resources.Theme theme) throws XmlPullParserException, Resources.NotFoundException, IOException {
        ...
        if (name.equals("gradient")) {
            return c(GradientColorInflaterCompat.a(resources, xml, attributeSetAsAttributeSet, theme));
        }
        if (name.equals("selector")) {
            return b(ColorStateListInflaterCompat.createFromXmlInner(resources, xml, attributeSetAsAttributeSet, theme));
        }
