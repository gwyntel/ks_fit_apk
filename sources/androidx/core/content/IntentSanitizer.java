...
public class IntentSanitizer {
    ...
    */
    static void r(android.content.Intent r7, android.content.Intent r8, androidx.core.util.Predicate r9, boolean r10, androidx.core.util.Predicate r11, androidx.core.util.Consumer r12) {
        /*
        ...
        Lde:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.content.IntentSanitizer.r(android.content.Intent, android.content.Intent, androidx.core.util.Predicate, boolean, androidx.core.util.Predicate, androidx.core.util.Consumer):void");
    }
    ...
    public Intent sanitize(@NonNull Intent intent, @NonNull Consumer<String> consumer) {
        ...
        r(intent, intent2, this.mAllowedClipData, this.mAllowClipDataText, this.mAllowedClipDataUri, consumer);
