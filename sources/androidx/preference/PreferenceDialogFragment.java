...
public abstract class PreferenceDialogFragment extends DialogFragment implements DialogInterface.OnClickListener {
    ...
    public DialogPreference getPreference() {
        if (this.mPreference == null) {
            this.mPreference = (DialogPreference) ((DialogPreference.TargetFragment) getTargetFragment()).findPreference(getArguments().getString(KsProperty.Key));
        }
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        String string = getArguments().getString(KsProperty.Key);
        if (bundle != null) {
    ...
    public Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        View viewC = c(activity);
        if (viewC != null) {
            b(viewC);
            negativeButton.setView(viewC);
        } else {
