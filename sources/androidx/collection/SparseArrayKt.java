...
public final class SparseArrayKt {
    ...
    public static final class C02661<T> implements Iterator<T>, KMappedMarker {
        ...
        public boolean hasNext() {
            return this.index < this.f2517a.size();
        }

        @Override // java.util.Iterator
        public T next() {
            SparseArrayCompat sparseArrayCompat = this.f2517a;
            int i2 = this.index;
            this.index = i2 + 1;
    ...
    public static final <T> void forEach(@NotNull SparseArrayCompat<T> receiver$0, @NotNull Function2<? super Integer, ? super T, Unit> action) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            action.mo1invoke(Integer.valueOf(receiver$0.keyAt(i2)), receiver$0.valueAt(i2));
        }
    }
