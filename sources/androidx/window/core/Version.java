...
public final class Version implements Comparable<Version> {
    ...
    public String toString() {
        return this.major + '.' + this.minor + '.' + this.patch + (StringsKt.isBlank(this.description) ^ true ? Intrinsics.stringPlus(Constants.ACCEPT_TIME_SEPARATOR_SERVER, this.description) : "");
    }
