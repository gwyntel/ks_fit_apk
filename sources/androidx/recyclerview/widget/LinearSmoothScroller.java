...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    protected PointF f5994c;
    private final DisplayMetrics mDisplayMetrics;
    private float mMillisPerPixel;

    /* renamed from: a, reason: collision with root package name */
    protected final LinearInterpolator f5992a = new LinearInterpolator();

    /* renamed from: b, reason: collision with root package name */
    protected final DecelerateInterpolator f5993b = new DecelerateInterpolator();
    private boolean mHasCalculatedMillisPerPixel = false;

    /* renamed from: d, reason: collision with root package name */
    protected int f5995d = 0;

    /* renamed from: e, reason: collision with root package name */
    protected int f5996e = 0;
    ...
    protected void d(int i2, int i3, RecyclerView.State state, RecyclerView.SmoothScroller.Action action) {
        ...
        this.f5995d = clampApplyScroll(this.f5995d, i2);
        int iClampApplyScroll = clampApplyScroll(this.f5996e, i3);
        this.f5996e = iClampApplyScroll;
        if (this.f5995d == 0 && iClampApplyScroll == 0) {
            o(action);
        }
    }
    ...
    protected void g(View view, RecyclerView.State state, RecyclerView.SmoothScroller.Action action) {
        int iCalculateDxToMakeVisible = calculateDxToMakeVisible(view, m());
        int iCalculateDyToMakeVisible = calculateDyToMakeVisible(view, n());
        ...
        if (iK > 0) {
            action.update(-iCalculateDxToMakeVisible, -iCalculateDyToMakeVisible, iK, this.f5993b);
        }
    }
    ...
    protected void o(RecyclerView.SmoothScroller.Action action) {
        ...
        this.f5994c = pointFComputeScrollVectorForPosition;
        this.f5995d = (int) (pointFComputeScrollVectorForPosition.x * 10000.0f);
        this.f5996e = (int) (pointFComputeScrollVectorForPosition.y * 10000.0f);
        action.update((int) (this.f5995d * TARGET_SEEK_EXTRA_SCROLL_RATIO), (int) (this.f5996e * TARGET_SEEK_EXTRA_SCROLL_RATIO), (int) (l(10000) * TARGET_SEEK_EXTRA_SCROLL_RATIO), this.f5992a);
    }
}
