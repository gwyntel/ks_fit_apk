...
public class PagerSnapHelper extends SnapHelper {
    ...
    private OrientationHelper getHorizontalHelper(@NonNull RecyclerView.LayoutManager layoutManager) {
        ...
        if (orientationHelper == null || orientationHelper.f6013a != layoutManager) {
    ...
    protected RecyclerView.SmoothScroller a(RecyclerView.LayoutManager layoutManager) {
        if (layoutManager instanceof RecyclerView.SmoothScroller.ScrollVectorProvider) {
            return new LinearSmoothScroller(this.f6101a.getContext()) { // from class: androidx.recyclerview.widget.PagerSnapHelper.1
                ...
                protected void g(View view, RecyclerView.State state, RecyclerView.SmoothScroller.Action action) {
                    ...
                    int[] iArrCalculateDistanceToFinalSnap = pagerSnapHelper.calculateDistanceToFinalSnap(pagerSnapHelper.f6101a.getLayoutManager(), view);
