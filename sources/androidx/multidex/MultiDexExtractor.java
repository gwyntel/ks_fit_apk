...
final class MultiDexExtractor implements Closeable {
        ...
        try {
            ...
            while (entry != null) {
                ...
                while (i3 < 3 && !z3) {
                    ...
                    sb.append(z2 ? AnalyticsEvents.PARAMETER_SHARE_OUTCOME_SUCCEEDED : h.f9784j);
                    sb.append(" '");
    ...
    List a(Context context, String str, boolean z2) throws IOException {
