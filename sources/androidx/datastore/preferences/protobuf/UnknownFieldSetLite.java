...
public final class UnknownFieldSetLite {
    ...
    static UnknownFieldSetLite e(UnknownFieldSetLite unknownFieldSetLite, UnknownFieldSetLite unknownFieldSetLite2) {
    ...
    UnknownFieldSetLite c(int i2, ByteString byteString) {
        a();
        if (i2 == 0) {
    ...
    UnknownFieldSetLite d(int i2, int i3) {
        a();
        if (i2 == 0) {
            throw new IllegalArgumentException("Zero is not a valid field number.");
        }
