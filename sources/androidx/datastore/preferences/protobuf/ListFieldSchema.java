...
abstract class ListFieldSchema {
    ...
    private static final class ListFieldSchemaFull extends ListFieldSchema {
        ...
        private static <L> List<L> mutableListAt(Object obj, long j2, int i2) {
            ...
            if (listF.isEmpty()) {
                ...
                UnsafeUtil.G(obj, j2, lazyStringArrayList2);
            ...
            if (UNMODIFIABLE_LIST_CLASS.isAssignableFrom(listF.getClass())) {
                ...
                if (!(listF instanceof UnmodifiableLazyStringList)) {
                    ...
                    UnsafeUtil.G(obj, j2, protobufListMutableCopyWithCapacity2);
                ...
                UnsafeUtil.G(obj, j2, lazyStringArrayList3);
        ...
        void c(Object obj, long j2) {
            ...
            UnsafeUtil.G(obj, j2, objUnmodifiableList);
        }
    ...
    private static final class ListFieldSchemaLite extends ListFieldSchema {
        ...
        void d(Object obj, Object obj2, long j2) {
            ...
            UnsafeUtil.G(obj, j2, protobufListF2);
        }
