...
final class RopeByteString extends ByteString {
    ...
    public Iterator<Byte> iterator2() {
        return new ByteString.AbstractByteIterator() { // from class: androidx.datastore.preferences.protobuf.RopeByteString.1
            ...
            final PieceIterator f3961a;

            /* renamed from: b, reason: collision with root package name */
            ByteString.ByteIterator f3962b = nextPiece();

            {
                this.f3961a = new PieceIterator(RopeByteString.this);
            }

            /* JADX WARN: Type inference failed for: r0v5, types: [androidx.datastore.preferences.protobuf.ByteString$ByteIterator] */
            private ByteString.ByteIterator nextPiece() {
                if (this.f3961a.hasNext()) {
                    return this.f3961a.next().iterator2();
                }
                return null;
            }
            ...
            public byte nextByte() {
                ByteString.ByteIterator byteIterator = this.f3962b;
                if (byteIterator == null) {
                    throw new NoSuchElementException();
                }
                byte bNextByte = byteIterator.nextByte();
                if (!this.f3962b.hasNext()) {
                    this.f3962b = nextPiece();
                }
                return bNextByte;
            }
        };
