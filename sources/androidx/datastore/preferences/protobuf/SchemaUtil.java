...
final class SchemaUtil {
    ...
    static Object A(int i2, List list, Internal.EnumVerifier enumVerifier, Object obj, UnknownFieldSchema unknownFieldSchema) {
        ...
        if (list instanceof RandomAccess) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                ...
                if (enumVerifier.isInRange(iIntValue)) {
                    ...
                    obj = F(i2, iIntValue, obj, unknownFieldSchema);
                }
            }
            if (i3 != size) {
            ...
            while (it.hasNext()) {
                ...
                if (!enumVerifier.isInRange(iIntValue2)) {
                    obj = F(i2, iIntValue2, obj, unknownFieldSchema);
                    it.remove();
                }
            }
        }
    ...
    static void B(ExtensionSchema extensionSchema, Object obj, Object obj2) {
        FieldSet fieldSetC = extensionSchema.c(obj2);
        if (fieldSetC.l()) {
            return;
        }
        extensionSchema.d(obj).mergeFrom(fieldSetC);
    }

    static void C(MapFieldSchema mapFieldSchema, Object obj, Object obj2, long j2) {
        UnsafeUtil.G(obj, j2, mapFieldSchema.mergeFrom(UnsafeUtil.u(obj, j2), UnsafeUtil.u(obj2, j2)));
    }

    static void D(UnknownFieldSchema unknownFieldSchema, Object obj, Object obj2) {
    ...
    static Object F(int i2, int i3, Object obj, UnknownFieldSchema unknownFieldSchema) {
        if (obj == null) {
    ...
    static Object z(int i2, List list, Internal.EnumLiteMap enumLiteMap, Object obj, UnknownFieldSchema unknownFieldSchema) {
        if (enumLiteMap == null) {
            return obj;
        }
        if (list instanceof RandomAccess) {
