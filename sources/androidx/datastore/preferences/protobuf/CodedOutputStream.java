...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    CodedOutputStreamWriter f3905a;
    ...
    private static abstract class AbstractBufferedEncoder extends CodedOutputStream {
        ...
        final void t(int i2) {
            ...
            long j2 = this.f3908d;
            while ((i2 & (-128)) != 0) {
                byte[] bArr3 = this.f3906b;
                int i5 = this.f3908d;
                this.f3908d = i5 + 1;
                UnsafeUtil.B(bArr3, i5, (byte) ((i2 & 127) | 128));
                i2 >>>= 7;
            }
            byte[] bArr4 = this.f3906b;
            int i6 = this.f3908d;
            this.f3908d = i6 + 1;
            UnsafeUtil.B(bArr4, i6, (byte) i2);
            this.f3909e += (int) (this.f3908d - j2);
        }
        ...
        final void u(long j2) {
            ...
            this.f3909e += (int) (this.f3908d - j3);
        }
    }
    ...
    private static class ArrayEncoder extends CodedOutputStream {
        ...
        final void n(int i2, MessageLite messageLite, Schema schema) throws IOException {
            ...
            schema.writeTo(messageLite, this.f3905a);
        }
        ...
        public final void writeUInt32NoTag(int i2) throws IOException {
            ...
            this.position = 1 + i16;
            UnsafeUtil.B(bArr11, i16, (byte) (i2 >>> 28));
        }
    ...
    private static final class ByteOutputEncoder extends AbstractBufferedEncoder {
        ...
        private void doFlush() throws IOException {
            this.out.write(this.f3906b, 0, this.f3908d);
            this.f3908d = 0;
        }

        private void flushIfNotAvailable(int i2) throws IOException {
            if (this.f3907c - this.f3908d < i2) {
                doFlush();
            }
        }
        ...
        public void writeStringNoTag(String str) throws IOException {
            ...
            try {
                ...
                if (iComputeUInt32SizeNoTag2 == iComputeUInt32SizeNoTag) {
                    ...
                    this.f3908d = i6;
                    int i7 = Utf8.i(str, this.f3906b, i6, this.f3907c - i6);
                    this.f3908d = i5;
                    ...
                    int iK = Utf8.k(str);
                    t(iK);
                    this.f3908d = Utf8.i(str, this.f3906b, this.f3908d, iK);
                    this.f3909e += iK;
                }
            } catch (Utf8.UnpairedSurrogateException e2) {
                this.f3909e -= this.f3908d - i5;
                this.f3908d = i5;
                h(str, e2);
            } catch (IndexOutOfBoundsException e3) {
                throw new OutOfSpaceException(e3);
    ...
    private static final class OutputStreamEncoder extends AbstractBufferedEncoder {
        ...
        public void write(byte[] bArr, int i2, int i3) throws IOException {
            ...
            int i5 = this.f3908d;
            if (i4 - i5 >= i3) {
                System.arraycopy(bArr, i2, this.f3906b, i5, i3);
                this.f3908d += i3;
                this.f3909e += i3;
                return;
            }
            int i6 = i4 - i5;
            System.arraycopy(bArr, i2, this.f3906b, i5, i6);
            int i7 = i2 + i6;
            int i8 = i3 - i6;
            ...
            doFlush();
            if (i8 <= this.f3907c) {
                System.arraycopy(bArr, i7, this.f3906b, 0, i8);
                this.f3908d = i8;
            } else {
        ...
        public void write(ByteBuffer byteBuffer) throws IOException {
            ...
            int i3 = this.f3908d;
            if (i2 - i3 >= iRemaining) {
                byteBuffer.get(this.f3906b, i3, iRemaining);
                this.f3908d += iRemaining;
                this.f3909e += iRemaining;
                return;
            }
            int i4 = i2 - i3;
            byteBuffer.get(this.f3906b, i3, i4);
            ...
            while (true) {
                int i6 = this.f3907c;
                if (i5 > i6) {
                    byteBuffer.get(this.f3906b, 0, i6);
                    this.out.write(this.f3906b, 0, this.f3907c);
                    int i7 = this.f3907c;
                    i5 -= i7;
                    this.f3909e += i7;
                } else {
                    byteBuffer.get(this.f3906b, 0, i5);
                    this.f3908d = i5;
                    this.f3909e += i5;
                    return;
                }
    ...
    private static final class UnsafeDirectNioEncoder extends CodedOutputStream {
        ...
        UnsafeDirectNioEncoder(ByteBuffer byteBuffer) {
            ...
            long jLimit = jI + byteBuffer.limit();
            this.limit = jLimit;
    ...
    public static int computeStringSizeNoTag(String str) {
        ...
        try {
            ...
            length = str.getBytes(Internal.f3944a).length;
        }
        return d(length);
    }
    ...
    final void h(String str, Utf8.UnpairedSurrogateException unpairedSurrogateException) throws IOException {
        ...
        byte[] bytes = str.getBytes(Internal.f3944a);
        try {
