...
/* synthetic */ class AudioplayersPlugin$onAttachedToEngine$1$1 extends FunctionReferenceImpl implements Function2<MethodCall, MethodChannel.Result, Unit> {
    ...
    public final void invoke2(@NotNull MethodCall p02, @NotNull MethodChannel.Result p1) {
        ...
        ((AudioplayersPlugin) this.receiver).methodHandler(p02, p1);
    }
}
