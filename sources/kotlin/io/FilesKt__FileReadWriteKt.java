    ...
    public static byte[] readBytes(@NotNull File file) {
        ...
        try {
            ...
            if (i3 > 0) {
                ...
                if (i6 != -1) {
                    ExposingBufferByteArrayOutputStream exposingBufferByteArrayOutputStream = new ExposingBufferByteArrayOutputStream(q.a.f21896r);
    ...
    public static final void forEachBlock(@NotNull File file, int i2, @NotNull Function2<? super byte[], ? super Integer, Unit> action) {
        ...
        while (true) {
            try {
                ...
                action.mo1invoke(r2, Integer.valueOf(i3));
            } finally {
            }
        }
    }
