...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final UIntProgression m2057fromClosedRangeNkh28Cs(int rangeStart, int rangeEnd, int step) {
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) UInt.m978toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) UInt.m978toStringimpl(this.last));
            sb.append(" step ");
            i2 = this.step;
        } else {
            sb = new StringBuilder();
    ...
    private UIntProgression(int i2, int i3, int i4) {
        ...
        this.first = i2;
        this.last = UProgressionUtilKt.m2041getProgressionLastElementNkh28Cs(i2, i3, i4);
        this.step = i4;
    }
}
