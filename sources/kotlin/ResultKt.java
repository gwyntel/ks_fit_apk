...
public final class ResultKt {
    ...
    private static final <R, T> R fold(Object obj, Function1<? super T, ? extends R> onSuccess, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        Throwable thM840exceptionOrNullimpl = Result.m840exceptionOrNullimpl(obj);
        return thM840exceptionOrNullimpl == null ? onSuccess.invoke(obj) : onFailure.invoke(thM840exceptionOrNullimpl);
    }
    ...
    private static final <R, T extends R> R getOrDefault(Object obj, R r2) {
        return Result.m843isFailureimpl(obj) ? r2 : obj;
    }
    ...
    private static final <R, T extends R> R getOrElse(Object obj, Function1<? super Throwable, ? extends R> onFailure) {
        Intrinsics.checkNotNullParameter(onFailure, "onFailure");
        Throwable thM840exceptionOrNullimpl = Result.m840exceptionOrNullimpl(obj);
        return thM840exceptionOrNullimpl == null ? obj : onFailure.invoke(thM840exceptionOrNullimpl);
    }
    ...
    private static final <R, T> Object map(Object obj, Function1<? super T, ? extends R> transform) {
        ...
        return Result.m844isSuccessimpl(obj) ? Result.m837constructorimpl(transform.invoke(obj)) : Result.m837constructorimpl(obj);
    }
    ...
    private static final <R, T> Object mapCatching(Object obj, Function1<? super T, ? extends R> transform) {
        ...
        try {
            return Result.m837constructorimpl(transform.invoke(obj));
        } catch (Throwable th) {
            Result.Companion companion = Result.INSTANCE;
            return Result.m837constructorimpl(createFailure(th));
        }
    }
    ...
    private static final <T> Object onFailure(Object obj, Function1<? super Throwable, Unit> action) {
        ...
        if (thM840exceptionOrNullimpl != null) {
            action.invoke(thM840exceptionOrNullimpl);
        }
        return obj;
    }
    ...
    private static final <R, T extends R> Object recover(Object obj, Function1<? super Throwable, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        Throwable thM840exceptionOrNullimpl = Result.m840exceptionOrNullimpl(obj);
        return thM840exceptionOrNullimpl == null ? obj : Result.m837constructorimpl(transform.invoke(thM840exceptionOrNullimpl));
    }
    ...
    private static final <R, T extends R> Object recoverCatching(Object obj, Function1<? super Throwable, ? extends R> transform) {
        ...
        try {
            return Result.m837constructorimpl(transform.invoke(thM840exceptionOrNullimpl));
        } catch (Throwable th) {
            Result.Companion companion = Result.INSTANCE;
            return Result.m837constructorimpl(createFailure(th));
        }
    ...
    private static final <R> Object runCatching(Function0<? extends R> block) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            return Result.m837constructorimpl(block.invoke());
        } catch (Throwable th) {
    ...
    private static final <T, R> Object runCatching(T t2, Function1<? super T, ? extends R> block) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            return Result.m837constructorimpl(block.invoke(t2));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.m837constructorimpl(createFailure(th));
        }
