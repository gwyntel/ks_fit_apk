...
public final class MeasureTimeKt {
    ...
    public static final long measureTime(@NotNull Function0<Unit> block) {
        ...
        long jM2290markNowz9LOYto = TimeSource.Monotonic.INSTANCE.m2290markNowz9LOYto();
        block.invoke();
        return TimeSource.Monotonic.ValueTimeMark.m2295elapsedNowUwyO8pc(jM2290markNowz9LOYto);
    }
    ...
    public static final <T> TimedValue<T> measureTimedValue(@NotNull Function0<? extends T> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        return new TimedValue<>(block.invoke(), TimeSource.Monotonic.ValueTimeMark.m2295elapsedNowUwyO8pc(TimeSource.Monotonic.INSTANCE.m2290markNowz9LOYto()), null);
    }
    ...
    public static final long measureTime(@NotNull TimeSource timeSource, @NotNull Function0<Unit> block) {
        ...
        block.invoke();
        return timeMarkMarkNow.mo2141elapsedNowUwyO8pc();
    }
    ...
    public static final long measureTime(@NotNull TimeSource.Monotonic monotonic, @NotNull Function0<Unit> block) {
        ...
        Intrinsics.checkNotNullParameter(block, "block");
        long jM2290markNowz9LOYto = monotonic.m2290markNowz9LOYto();
        block.invoke();
        return TimeSource.Monotonic.ValueTimeMark.m2295elapsedNowUwyO8pc(jM2290markNowz9LOYto);
    }
    ...
    public static final <T> TimedValue<T> measureTimedValue(@NotNull TimeSource.Monotonic monotonic, @NotNull Function0<? extends T> block) {
        Intrinsics.checkNotNullParameter(monotonic, "<this>");
        Intrinsics.checkNotNullParameter(block, "block");
        return new TimedValue<>(block.invoke(), TimeSource.Monotonic.ValueTimeMark.m2295elapsedNowUwyO8pc(monotonic.m2290markNowz9LOYto()), null);
    }
}
