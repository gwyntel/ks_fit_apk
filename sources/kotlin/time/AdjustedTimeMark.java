...
final class AdjustedTimeMark implements TimeMark {
    ...
    public long mo2141elapsedNowUwyO8pc() {
        return Duration.m2186minusLRDsOJo(this.mark.mo2141elapsedNowUwyO8pc(), this.adjustment);
    }
    ...
    public TimeMark mo2142minusLRDsOJo(long j2) {
        return TimeMark.DefaultImpls.m2288minusLRDsOJo(this, j2);
    }

    @Override // kotlin.time.TimeMark
    @NotNull
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo2144plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m2187plusLRDsOJo(this.adjustment, duration), null);
    }
