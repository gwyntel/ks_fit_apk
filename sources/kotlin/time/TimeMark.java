...
public interface TimeMark {
    ...
    public static final class DefaultImpls {
        public static boolean hasNotPassedNow(@NotNull TimeMark timeMark) {
            return Duration.m2184isNegativeimpl(timeMark.mo2141elapsedNowUwyO8pc());
        }
        ...
        public static TimeMark m2288minusLRDsOJo(@NotNull TimeMark timeMark, long j2) {
            return timeMark.mo2144plusLRDsOJo(Duration.m2204unaryMinusUwyO8pc(j2));
        }

        @NotNull
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m2289plusLRDsOJo(@NotNull TimeMark timeMark, long j2) {
            return new AdjustedTimeMark(timeMark, j2, null);
        }
    }

    /* renamed from: elapsedNow-UwyO8pc */
    long mo2141elapsedNowUwyO8pc();
    ...
    TimeMark mo2142minusLRDsOJo(long duration);

    @NotNull
    /* renamed from: plus-LRDsOJo */
    TimeMark mo2144plusLRDsOJo(long duration);
}
