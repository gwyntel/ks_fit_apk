...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    public static final class DefaultImpls {
        public static int compareTo(@NotNull ComparableTimeMark comparableTimeMark, @NotNull ComparableTimeMark other) {
            ...
            return Duration.m2150compareToLRDsOJo(comparableTimeMark.mo2143minusUwyO8pc(other), Duration.INSTANCE.m2254getZEROUwyO8pc());
        }
        ...
        public static ComparableTimeMark m2146minusLRDsOJo(@NotNull ComparableTimeMark comparableTimeMark, long j2) {
            return comparableTimeMark.mo2144plusLRDsOJo(Duration.m2204unaryMinusUwyO8pc(j2));
        }
    }
    ...
    ComparableTimeMark mo2142minusLRDsOJo(long duration);

    /* renamed from: minus-UwyO8pc */
    long mo2143minusUwyO8pc(@NotNull ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    @NotNull
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo2144plusLRDsOJo(long duration);
}
