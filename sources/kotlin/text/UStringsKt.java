...
public final class UStringsKt {
    ...
    public static final String m2137toStringJSWoG40(long j2, int i2) {
    ...
    public static final String m2138toStringLxnNnR4(byte b2, int i2) {
        String string = Integer.toString(b2 & 255, CharsKt.checkRadix(i2));
    ...
    public static final String m2139toStringV7xB4Y4(int i2, int i3) {
        String string = Long.toString(i2 & 4294967295L, CharsKt.checkRadix(i3));
        Intrinsics.checkNotNullExpressionValue(string, "toString(...)");
        return string;
    }
    ...
    public static final String m2140toStringolVBNx4(short s2, int i2) {
        String string = Integer.toString(s2 & UShort.MAX_VALUE, CharsKt.checkRadix(i2));
        Intrinsics.checkNotNullExpressionValue(string, "toString(...)");
        return string;
    }
    ...
    public static final UByte toUByteOrNull(@NotNull String str, int i2) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m932constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m849boximpl(UByte.m855constructorimpl((byte) data));
    }
    ...
    public static final UInt toUIntOrNull(@NotNull String str, int i2) {
        ...
        int iM932constructorimpl = UInt.m932constructorimpl(i2);
        int iA = 119304647;
        while (i3 < length) {
            ...
            if (Integer.compare(i4 ^ Integer.MIN_VALUE, iA ^ Integer.MIN_VALUE) > 0) {
                if (iA == 119304647) {
                    iA = a.a(-1, iM932constructorimpl);
                    if (Integer.compare(i4 ^ Integer.MIN_VALUE, iA ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM932constructorimpl2 = UInt.m932constructorimpl(i4 * iM932constructorimpl);
            int iM932constructorimpl3 = UInt.m932constructorimpl(UInt.m932constructorimpl(iDigitOf) + iM932constructorimpl2);
            if (Integer.compare(iM932constructorimpl3 ^ Integer.MIN_VALUE, iM932constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i3++;
            i4 = iM932constructorimpl3;
        }
        return UInt.m926boximpl(i4);
    }
    ...
    public static final ULong toULongOrNull(@NotNull String str, int i2) {
        ...
        long jM1011constructorimpl = ULong.m1011constructorimpl(i2);
        long j2 = 0;
        ...
        while (i3 < length) {
            ...
            if (Long.compare(j2 ^ Long.MIN_VALUE, jA ^ Long.MIN_VALUE) > 0) {
                if (jA == 512409557603043100L) {
                    jA = d.a(-1L, jM1011constructorimpl);
                    if (Long.compare(j2 ^ Long.MIN_VALUE, jA ^ Long.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            long jM1011constructorimpl2 = ULong.m1011constructorimpl(j2 * jM1011constructorimpl);
            long jM1011constructorimpl3 = ULong.m1011constructorimpl(ULong.m1011constructorimpl(UInt.m932constructorimpl(r13) & 4294967295L) + jM1011constructorimpl2);
            if (Long.compare(jM1011constructorimpl3 ^ Long.MIN_VALUE, jM1011constructorimpl2 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i3++;
            j2 = jM1011constructorimpl3;
        }
        return ULong.m1005boximpl(j2);
    }
    ...
    public static final UShort toUShortOrNull(@NotNull String str, int i2) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m932constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m1112boximpl(UShort.m1118constructorimpl((short) data));
    }
}
