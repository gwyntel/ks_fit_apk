...
public class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    static /* synthetic */ Sequence b(CharSequence charSequence, char[] cArr, int i2, boolean z2, int i3, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            i2 = 0;
        }
        if ((i4 & 4) != 0) {
    ...
    static /* synthetic */ Sequence c(CharSequence charSequence, String[] strArr, int i2, boolean z2, int i3, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            i2 = 0;
        }
        if ((i4 & 4) != 0) {
    ...
    public static final boolean contains(@NotNull CharSequence charSequence, @NotNull CharSequence other, boolean z2) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(other, "other");
        ...
        } else if (a(charSequence, other, 0, charSequence.length(), z2, false, 16, null) < 0) {
            return false;
        }
        return true;
    }
    ...
    public static final boolean endsWith(@NotNull CharSequence charSequence, char c2, boolean z2) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
    ...
    public static final Pair<Integer, String> findAnyOf$StringsKt__StringsKt(CharSequence charSequence, Collection<String> collection, int i2, boolean z2, boolean z3) {
        ...
        IntProgression intRange = !z3 ? new IntRange(RangesKt.coerceAtLeast(i2, 0), charSequence.length()) : RangesKt.downTo(RangesKt.coerceAtMost(i2, StringsKt.getLastIndex(charSequence)), 0);
    ...
    public static final int indexOf(@NotNull CharSequence charSequence, char c2, int i2, boolean z2) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
    ...
    private static final int indexOf$StringsKt__StringsKt(CharSequence charSequence, CharSequence charSequence2, int i2, int i3, boolean z2, boolean z3) {
        IntProgression intRange = !z3 ? new IntRange(RangesKt.coerceAtLeast(i2, 0), RangesKt.coerceAtMost(i3, charSequence.length())) : RangesKt.downTo(RangesKt.coerceAtMost(i2, StringsKt.getLastIndex(charSequence)), RangesKt.coerceAtLeast(i3, 0));
        if ((charSequence instanceof String) && (charSequence2 instanceof String)) {
            int first = intRange.getFirst();
            int last = intRange.getLast();
            int step = intRange.getStep();
    ...
    public static final int indexOfAny(@NotNull CharSequence charSequence, @NotNull char[] chars, int i2, boolean z2) {
        ...
        ?? Iterator2 = new IntRange(RangesKt.coerceAtLeast(i2, 0), StringsKt.getLastIndex(charSequence)).iterator();
    ...
    public static final int lastIndexOf(@NotNull CharSequence charSequence, char c2, int i2, boolean z2) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
    ...
    public static final List<String> split(@NotNull CharSequence charSequence, @NotNull String[] delimiters, boolean z2, int i2) {
        ...
        Iterable iterableAsIterable = SequencesKt.asIterable(c(charSequence, delimiters, 0, z2, i2, 2, null));
    ...
    public static final Sequence<String> splitToSequence(@NotNull final CharSequence charSequence, @NotNull String[] delimiters, boolean z2, int i2) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(delimiters, "delimiters");
        return SequencesKt.map(c(charSequence, delimiters, 0, z2, i2, 2, null), new Function1<IntRange, String>() { // from class: kotlin.text.StringsKt__StringsKt.splitToSequence.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
    ...
    public static final boolean startsWith(@NotNull CharSequence charSequence, char c2, boolean z2) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
    ...
    public static final boolean endsWith(@NotNull CharSequence charSequence, @NotNull CharSequence suffix, boolean z2) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(suffix, "suffix");
        return (!z2 && (charSequence instanceof String) && (suffix instanceof String)) ? StringsKt.endsWith$default((String) charSequence, (String) suffix, false, 2, (Object) null) : regionMatchesImpl(charSequence, charSequence.length() - suffix.length(), suffix, 0, suffix.length(), z2);
    }
    ...
    public static final Sequence<String> splitToSequence(@NotNull final CharSequence charSequence, @NotNull char[] delimiters, boolean z2, int i2) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(delimiters, "delimiters");
        return SequencesKt.map(b(charSequence, delimiters, 0, z2, i2, 2, null), new Function1<IntRange, String>() { // from class: kotlin.text.StringsKt__StringsKt.splitToSequence.2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
    ...
    public static final boolean startsWith(@NotNull CharSequence charSequence, @NotNull CharSequence prefix, boolean z2) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(prefix, "prefix");
        return (!z2 && (charSequence instanceof String) && (prefix instanceof String)) ? StringsKt.startsWith$default((String) charSequence, (String) prefix, false, 2, (Object) null) : regionMatchesImpl(charSequence, 0, prefix, 0, prefix.length(), z2);
    }
    ...
    public static final boolean contains(@NotNull CharSequence charSequence, char c2, boolean z2) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
    ...
    public static final int indexOf(@NotNull CharSequence charSequence, @NotNull String string, int i2, boolean z2) {
        ...
        return a(charSequence, string, i2, charSequence.length(), z2, false, 16, null);
    }
    ...
    public static final List<String> split(@NotNull CharSequence charSequence, @NotNull char[] delimiters, boolean z2, int i2) {
        ...
        Iterable iterableAsIterable = SequencesKt.asIterable(b(charSequence, delimiters, 0, z2, i2, 2, null));
        ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(iterableAsIterable, 10));
        Iterator it = iterableAsIterable.iterator();
        while (it.hasNext()) {
            arrayList.add(substring(charSequence, (IntRange) it.next()));
