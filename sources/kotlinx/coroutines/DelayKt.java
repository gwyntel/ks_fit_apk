    ...
    */
    ...
    public static final Object delay(long j2, @NotNull Continuation<? super Unit> continuation) {
        ...
        if (j2 < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl.getF25479a()).mo2381scheduleResumeAfterDelay(j2, cancellableContinuationImpl);
        }
    ...
    public static final Object m2315delayVtjQ1oo(long j2, @NotNull Continuation<? super Unit> continuation) {
        Object objDelay = delay(m2316toDelayMillisLRDsOJo(j2), continuation);
    ...
    public static final long m2316toDelayMillisLRDsOJo(long j2) {
        if (Duration.m2150compareToLRDsOJo(j2, Duration.INSTANCE.m2254getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m2169getInWholeMillisecondsimpl(j2), 1L);
        }
        return 0L;
    }
}
