...
public final class TimeoutKt {
    ...
    */
    public static final kotlinx.coroutines.TimeoutCancellationException TimeoutCancellationException(long r2, @org.jetbrains.annotations.NotNull kotlinx.coroutines.Delay r4, @org.jetbrains.annotations.NotNull kotlinx.coroutines.Job r5) {
        ...
        L8:
            ...
            java.lang.String r4 = r4.m2317timeoutMessageLRDsOJo(r0)
            if (r4 != 0) goto L2e
        L18:
    ...
    private static final <U, T extends U> Object setupTimeout(TimeoutCoroutine<U, ? super T> timeoutCoroutine, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2) {
        JobKt.disposeOnCompletion(timeoutCoroutine, DelayKt.getDelay(timeoutCoroutine.uCont.getF25396a()).invokeOnTimeout(timeoutCoroutine.time, timeoutCoroutine, timeoutCoroutine.getF25396a()));
    ...
    public static final <T> Object m2324withTimeoutKLykuaI(long j2, @NotNull Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, @NotNull Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m2316toDelayMillisLRDsOJo(j2), function2, continuation);
    }
    ...
    */
    ...
    public static final <T> Object m2325withTimeoutOrNullKLykuaI(long j2, @NotNull Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, @NotNull Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m2316toDelayMillisLRDsOJo(j2), function2, continuation);
    }
}
