...
final class SemaphoreSegment extends Segment<SemaphoreSegment> {
    ...
    public final boolean cas(int index, @Nullable Object expected, @Nullable Object value) {
        return i0.a(getAcquirers(), index, expected, value);
    }
