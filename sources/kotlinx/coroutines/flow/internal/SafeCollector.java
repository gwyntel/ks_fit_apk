...
public final class SafeCollector<T> extends ContinuationImpl implements FlowCollector<T>, CoroutineStackFrame {
    ...
    public Object emit(T t2, @NotNull Continuation<? super Unit> continuation) {
        try {
            ...
            this.lastEmissionContext = new DownstreamExceptionContext(th, continuation.getF25479a());
            throw th;
        }
    }
    ...
    public Object invokeSuspend(@NotNull Object result) {
        Throwable thM840exceptionOrNullimpl = Result.m840exceptionOrNullimpl(result);
        if (thM840exceptionOrNullimpl != null) {
            this.lastEmissionContext = new DownstreamExceptionContext(thM840exceptionOrNullimpl, getF25479a());
        }
        Continuation<? super Unit> continuation = this.completion;
    ...
    private final Object emit(Continuation<? super Unit> uCont, T value) {
        CoroutineContext context = uCont.getF25479a();
