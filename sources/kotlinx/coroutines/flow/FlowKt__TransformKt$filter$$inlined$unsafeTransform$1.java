...
public final class FlowKt__TransformKt$filter$$inlined$unsafeTransform$1<T> implements Flow<T> {
    ...
    final /* synthetic */ Flow f25656a;

    /* renamed from: b, reason: collision with root package name */
    final /* synthetic */ Function2 f25657b;
    ...
    public static final class AnonymousClass2<T> implements FlowCollector {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ FlowCollector f25658a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Function2 f25659b;
        ...
        public AnonymousClass2(FlowCollector flowCollector, Function2 function2) {
            this.f25658a = flowCollector;
            this.f25659b = function2;
        }
        ...
        */
        public final java.lang.Object emit(T r7, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> r8) throws java.lang.Throwable {
            ...
            L3e:
                kotlin.ResultKt.throwOnFailure(r8)
                kotlinx.coroutines.flow.FlowCollector r8 = r6.f25658a
                kotlin.jvm.functions.Function2 r2 = r6.f25659b
                r0.L$0 = r7
                r0.L$1 = r8
                r0.label = r4
        ...
        public final Object emit$$forInline(Object obj, @NotNull Continuation continuation) {
            ...
            InlineMarker.mark(5);
            FlowCollector flowCollector = this.f25658a;
            if (((Boolean) this.f25659b.mo1invoke(obj, continuation)).booleanValue()) {
                InlineMarker.mark(0);
    ...
    public FlowKt__TransformKt$filter$$inlined$unsafeTransform$1(Flow flow, Function2 function2) {
        this.f25656a = flow;
        this.f25657b = function2;
    }

    @Override // kotlinx.coroutines.flow.Flow
    @Nullable
    public Object collect(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        Object objCollect = this.f25656a.collect(new AnonymousClass2(flowCollector, this.f25657b), continuation);
    ...
    public Object collect$$forInline(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        ...
        InlineMarker.mark(5);
        Flow flow = this.f25656a;
        AnonymousClass2 anonymousClass2 = new AnonymousClass2(flowCollector, this.f25657b);
        InlineMarker.mark(0);
