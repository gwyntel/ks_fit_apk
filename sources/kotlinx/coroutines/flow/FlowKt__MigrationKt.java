...
final /* synthetic */ class FlowKt__MigrationKt {
    ...
    static final class C05771<T> extends SuspendLambda implements Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        final /* synthetic */ long $timeMillis;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C05771(long j2, Continuation<? super C05771> continuation) {
            super(2, continuation);
            this.$timeMillis = j2;
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C05771(this.$timeMillis, continuation);
        }
        ...
        public final Object mo1invoke(@NotNull FlowCollector<? super T> flowCollector, @Nullable Continuation<? super Unit> continuation) {
            return ((C05771) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public static final <T> Flow<T> delayFlow(@NotNull Flow<? extends T> flow, long j2) {
        return FlowKt.onStart(flow, new C05771(j2, null));
    }
    ...
    public static final <T> Flow<T> onErrorReturn(@NotNull Flow<? extends T> flow, T t2, @NotNull Function1<? super Throwable, Boolean> function1) {
        return FlowKt.m2354catch(flow, new AnonymousClass2(function1, t2, null));
    }
