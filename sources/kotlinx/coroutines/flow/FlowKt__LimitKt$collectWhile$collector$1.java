...
public final class FlowKt__LimitKt$collectWhile$collector$1<T> implements FlowCollector<T> {
    ...
    final /* synthetic */ Function2 f25619a;
    ...
    */
    public java.lang.Object emit(T r5, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> r6) throws java.lang.Throwable {
        ...
        L35:
            kotlin.ResultKt.throwOnFailure(r6)
            kotlin.jvm.functions.Function2 r6 = r4.f25619a
            r0.L$0 = r4
            r0.label = r3
    ...
    public Object emit$$forInline(T t2, @NotNull Continuation<? super Unit> continuation) {
        ...
        InlineMarker.mark(5);
        if (((Boolean) this.f25619a.mo1invoke(t2, continuation)).booleanValue()) {
