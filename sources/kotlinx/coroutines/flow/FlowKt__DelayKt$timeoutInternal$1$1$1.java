...
@DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__DelayKt$timeoutInternal$1$1$1", f = "Delay.kt", i = {0}, l = {Common.HTTP_STATUS_NOT_FOUND}, m = "invokeSuspend", n = {"$this$onSuccess_u2dWpGqRn0$iv"}, s = {"L$0"})
...
final class FlowKt__DelayKt$timeoutInternal$1$1$1<T> extends SuspendLambda implements Function2<ChannelResult<? extends T>, Continuation<? super Boolean>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object mo1invoke(Object obj, Continuation<? super Boolean> continuation) {
        return m2364invokeWpGqRn0(((ChannelResult) obj).getHolder(), continuation);
    }

    @Nullable
    /* renamed from: invoke-WpGqRn0, reason: not valid java name */
    public final Object m2364invokeWpGqRn0(@NotNull Object obj, @Nullable Continuation<? super Boolean> continuation) {
        return ((FlowKt__DelayKt$timeoutInternal$1$1$1) create(ChannelResult.m2335boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final java.lang.Object invokeSuspend(@org.jetbrains.annotations.NotNull java.lang.Object r5) throws java.lang.Throwable {
        ...
        L37:
            ...
            if (r0 == 0) goto L45
            kotlinx.coroutines.channels.ChannelResult.m2339exceptionOrNullimpl(r5)
            r5 = 0
