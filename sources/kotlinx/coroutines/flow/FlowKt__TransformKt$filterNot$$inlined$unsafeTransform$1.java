...
public final class FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1<T> implements Flow<T> {
    ...
    final /* synthetic */ Flow f25666a;

    /* renamed from: b, reason: collision with root package name */
    final /* synthetic */ Function2 f25667b;
    ...
    public static final class AnonymousClass2<T> implements FlowCollector {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ FlowCollector f25668a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Function2 f25669b;
        ...
        */
        public final java.lang.Object emit(T r7, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> r8) throws java.lang.Throwable {
            ...
            L3e:
                kotlin.ResultKt.throwOnFailure(r8)
                kotlinx.coroutines.flow.FlowCollector r8 = r6.f25668a
                kotlin.jvm.functions.Function2 r2 = r6.f25669b
                r0.L$0 = r7
                r0.L$1 = r8
                r0.label = r4
        ...
        public final Object emit$$forInline(Object obj, @NotNull Continuation continuation) {
            ...
            InlineMarker.mark(5);
            FlowCollector flowCollector = this.f25668a;
            if (!((Boolean) this.f25669b.mo1invoke(obj, continuation)).booleanValue()) {
                InlineMarker.mark(0);
    ...
    public FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1(Flow flow, Function2 function2) {
        this.f25666a = flow;
        this.f25667b = function2;
    }

    @Override // kotlinx.coroutines.flow.Flow
    @Nullable
    public Object collect(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        Object objCollect = this.f25666a.collect(new AnonymousClass2(flowCollector, this.f25667b), continuation);
    ...
    public Object collect$$forInline(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        ...
        InlineMarker.mark(5);
        Flow flow = this.f25666a;
        AnonymousClass2 anonymousClass2 = new AnonymousClass2(flowCollector, this.f25667b);
        InlineMarker.mark(0);
