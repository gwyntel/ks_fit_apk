...
@DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1", f = "Delay.kt", i = {}, l = {KeyType.QUERY_AI_WATCH_ENABLE}, m = "invokeSuspend", n = {}, s = {})
...
final class FlowKt__DelayKt$sample$2$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    static final class AnonymousClass1<T> implements FlowCollector {
        ...
        final /* synthetic */ ProducerScope f25586a;

        AnonymousClass1(ProducerScope producerScope) {
            this.f25586a = producerScope;
        }
        ...
        */
        public final java.lang.Object emit(T r5, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> r6) throws java.lang.Throwable {
            ...
            L31:
                kotlin.ResultKt.throwOnFailure(r6)
                kotlinx.coroutines.channels.ProducerScope r6 = r4.f25586a
                if (r5 != 0) goto L3a
