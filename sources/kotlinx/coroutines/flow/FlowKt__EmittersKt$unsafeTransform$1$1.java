...
public final class FlowKt__EmittersKt$unsafeTransform$1$1<T> implements FlowCollector {
    ...
    final /* synthetic */ Function3 f25599a;

    /* renamed from: b, reason: collision with root package name */
    final /* synthetic */ FlowCollector f25600b;
    ...
    public FlowKt__EmittersKt$unsafeTransform$1$1(Function3<? super FlowCollector<? super R>, ? super T, ? super Continuation<? super Unit>, ? extends Object> function3, FlowCollector<? super R> flowCollector) {
        this.f25599a = function3;
        this.f25600b = flowCollector;
    }
    ...
    */
    public final java.lang.Object emit(T r5, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> r6) throws java.lang.Throwable {
        ...
        L31:
            kotlin.ResultKt.throwOnFailure(r6)
            kotlin.jvm.functions.Function3 r6 = r4.f25599a
            kotlinx.coroutines.flow.FlowCollector r2 = r4.f25600b
            r0.label = r3
    ...
    public final Object emit$$forInline(T t2, @NotNull Continuation<? super Unit> continuation) {
        ...
        InlineMarker.mark(5);
        this.f25599a.invoke(this.f25600b, t2, continuation);
