...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM837constructorimpl = Result.m837constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM837constructorimpl = Result.m837constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m843isFailureimpl(objM837constructorimpl) ? null : objM837constructorimpl);
    ...
    private final void installSignalHandler() {
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: v0.a
            });
