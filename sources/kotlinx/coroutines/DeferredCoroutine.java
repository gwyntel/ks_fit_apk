...
class DeferredCoroutine<T> extends AbstractCoroutine<T> implements Deferred<T> {
    ...
    static /* synthetic */ Object n(DeferredCoroutine deferredCoroutine, Continuation continuation) throws Throwable {
        Object objB = deferredCoroutine.b(continuation);
    ...
    public SelectClause1<T> getOnAwait() {
        SelectClause1<T> selectClause1D = d();
        Intrinsics.checkNotNull(selectClause1D, "null cannot be cast to non-null type kotlinx.coroutines.selects.SelectClause1<T of kotlinx.coroutines.DeferredCoroutine>");
        return selectClause1D;
    }
}
