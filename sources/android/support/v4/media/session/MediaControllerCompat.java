...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements IBinder.DeathRecipient {
        ...
        final Object f1794a = MediaControllerCompatApi21.createCallback(new StubApi21(this));

        /* renamed from: b, reason: collision with root package name */
        MessageHandler f1795b;

        /* renamed from: c, reason: collision with root package name */
        IMediaControllerCallback f1796c;
        ...
        private static class StubApi21 implements MediaControllerCompatApi21.Callback {
            ...
            public void onPlaybackStateChanged(Object obj) {
                Callback callback = this.mCallback.get();
                if (callback == null || callback.f1796c != null) {
                    return;
                }
        ...
        private static class StubCompat extends IMediaControllerCallback.Stub {
            ...
            public void onCaptioningEnabledChanged(boolean z2) throws RemoteException {
                Callback callback = this.mCallback.get();
                if (callback != null) {
                    callback.a(11, Boolean.valueOf(z2), null);
                }
            }
        ...
        void a(int i2, Object obj, Bundle bundle) {
            MessageHandler messageHandler = this.f1795b;
        ...
        void b(Handler handler) {
            if (handler != null) {
                ...
                this.f1795b = messageHandler;
                messageHandler.f1797a = true;
            } else {
                MessageHandler messageHandler2 = this.f1795b;
                if (messageHandler2 != null) {
                    messageHandler2.f1797a = false;
    ...
    static class MediaControllerImplApi23 extends MediaControllerImplApi21 {
        ...
        public TransportControls getTransportControls() {
            Object transportControls = MediaControllerCompatApi21.getTransportControls(this.f1799a);
    ...
    static class TransportControlsApi23 extends TransportControlsApi21 {
        ...
        public void playFromUri(Uri uri, Bundle bundle) {
            MediaControllerCompatApi23.TransportControls.playFromUri(this.f1802a, uri, bundle);
        }
    }
    ...
    static class TransportControlsApi24 extends TransportControlsApi23 {
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControlsApi21, android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void prepare() {
            MediaControllerCompatApi24.TransportControls.prepare(this.f1802a);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControlsApi21, android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void prepareFromMediaId(String str, Bundle bundle) {
            MediaControllerCompatApi24.TransportControls.prepareFromMediaId(this.f1802a, str, bundle);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControlsApi21, android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void prepareFromSearch(String str, Bundle bundle) {
            MediaControllerCompatApi24.TransportControls.prepareFromSearch(this.f1802a, str, bundle);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControlsApi21, android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void prepareFromUri(Uri uri, Bundle bundle) {
            MediaControllerCompatApi24.TransportControls.prepareFromUri(this.f1802a, uri, bundle);
        }
    }
    ...
    public MediaControllerCompat(Context context, @NonNull MediaSessionCompat mediaSessionCompat) {
        ...
        try {
            mediaControllerImplApi24 = Build.VERSION.SDK_INT >= 24 ? new MediaControllerImplApi24(context, sessionToken) : new MediaControllerImplApi23(context, sessionToken);
        } catch (RemoteException e2) {
    ...
    static class TransportControlsApi21 extends TransportControls {
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void fastForward() {
            MediaControllerCompatApi21.TransportControls.fastForward(this.f1802a);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void pause() {
            MediaControllerCompatApi21.TransportControls.pause(this.f1802a);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void play() {
            MediaControllerCompatApi21.TransportControls.play(this.f1802a);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void playFromMediaId(String str, Bundle bundle) {
            MediaControllerCompatApi21.TransportControls.playFromMediaId(this.f1802a, str, bundle);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void playFromSearch(String str, Bundle bundle) {
            MediaControllerCompatApi21.TransportControls.playFromSearch(this.f1802a, str, bundle);
        }
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void rewind() {
            MediaControllerCompatApi21.TransportControls.rewind(this.f1802a);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void seekTo(long j2) {
            MediaControllerCompatApi21.TransportControls.seekTo(this.f1802a, j2);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void sendCustomAction(PlaybackStateCompat.CustomAction customAction, Bundle bundle) {
            MediaControllerCompat.a(customAction.getAction(), bundle);
            MediaControllerCompatApi21.TransportControls.sendCustomAction(this.f1802a, customAction.getAction(), bundle);
        }
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void setRating(RatingCompat ratingCompat) {
            MediaControllerCompatApi21.TransportControls.setRating(this.f1802a, ratingCompat != null ? ratingCompat.getRating() : null);
        }
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void skipToNext() {
            MediaControllerCompatApi21.TransportControls.skipToNext(this.f1802a);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void skipToPrevious() {
            MediaControllerCompatApi21.TransportControls.skipToPrevious(this.f1802a);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void skipToQueueItem(long j2) {
            MediaControllerCompatApi21.TransportControls.skipToQueueItem(this.f1802a, j2);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void stop() {
            MediaControllerCompatApi21.TransportControls.stop(this.f1802a);
        }
        ...
        public void sendCustomAction(String str, Bundle bundle) {
            MediaControllerCompat.a(str, bundle);
            MediaControllerCompatApi21.TransportControls.sendCustomAction(this.f1802a, str, bundle);
        }
    }
    ...
    static class MediaControllerImplBase implements MediaControllerImpl {
        ...
        public void registerCallback(Callback callback, Handler handler) throws RemoteException {
            ...
            try {
                ...
                this.mBinder.registerCallbackListener((IMediaControllerCallback) callback.f1794a);
                callback.a(13, null, null);
            } catch (RemoteException e2) {
        ...
        public void unregisterCallback(Callback callback) {
            ...
            try {
                this.mBinder.unregisterCallbackListener((IMediaControllerCallback) callback.f1794a);
    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        /* renamed from: a, reason: collision with root package name */
        protected final Object f1799a;

        /* renamed from: c, reason: collision with root package name */
        final MediaSessionCompat.Token f1801c;
        ...
        private static class ExtraBinderRequestResultReceiver extends ResultReceiver {
            ...
            protected void onReceiveResult(int i2, Bundle bundle) {
                ...
                synchronized (mediaControllerImplApi21.f1800b) {
                    mediaControllerImplApi21.f1801c.setExtraBinder(IMediaSession.Stub.asInterface(BundleCompat.getBinder(bundle, MediaSessionCompat.KEY_EXTRA_BINDER)));
                    mediaControllerImplApi21.f1801c.setSessionToken2Bundle(bundle.getBundle(MediaSessionCompat.KEY_SESSION_TOKEN2_BUNDLE));
        ...
        void a() {
            if (this.f1801c.getExtraBinder() == null) {
                return;
            }
            for (Callback callback : this.mPendingCallbacks) {
                ExtraCallback extraCallback = new ExtraCallback(callback);
                this.mCallbackMap.put(callback, extraCallback);
                callback.f1796c = extraCallback;
                try {
                    this.f1801c.getExtraBinder().registerCallbackListener(extraCallback);
                    callback.a(13, null, null);
                } catch (RemoteException e2) {
                    Log.e("MediaControllerCompat", "Dead object in registerCallback.", e2);
                }
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public void adjustVolume(int i2, int i3) {
            MediaControllerCompatApi21.adjustVolume(this.f1799a, i2, i3);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public boolean dispatchMediaButtonEvent(KeyEvent keyEvent) {
            return MediaControllerCompatApi21.dispatchMediaButtonEvent(this.f1799a, keyEvent);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public Bundle getExtras() {
            return MediaControllerCompatApi21.getExtras(this.f1799a);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public long getFlags() {
            return MediaControllerCompatApi21.getFlags(this.f1799a);
        }
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public MediaMetadataCompat getMetadata() {
            Object metadata = MediaControllerCompatApi21.getMetadata(this.f1799a);
            if (metadata != null) {
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public String getPackageName() {
            return MediaControllerCompatApi21.getPackageName(this.f1799a);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public PlaybackInfo getPlaybackInfo() {
            Object playbackInfo = MediaControllerCompatApi21.getPlaybackInfo(this.f1799a);
        ...
        public PlaybackStateCompat getPlaybackState() {
            if (this.f1801c.getExtraBinder() != null) {
                try {
                    return this.f1801c.getExtraBinder().getPlaybackState();
                } catch (RemoteException e2) {
                    Log.e("MediaControllerCompat", "Dead object in getPlaybackState.", e2);
                }
            }
            Object playbackState = MediaControllerCompatApi21.getPlaybackState(this.f1799a);
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public List<MediaSessionCompat.QueueItem> getQueue() {
            List<Object> queue = MediaControllerCompatApi21.getQueue(this.f1799a);
            if (queue != null) {
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public CharSequence getQueueTitle() {
            return MediaControllerCompatApi21.getQueueTitle(this.f1799a);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public int getRatingType() {
            return MediaControllerCompatApi21.getRatingType(this.f1799a);
        }
        ...
        public int getRepeatMode() {
            ...
            try {
                return this.f1801c.getExtraBinder().getRepeatMode();
            } catch (RemoteException e2) {
                Log.e("MediaControllerCompat", "Dead object in getRepeatMode.", e2);
                return -1;
            }
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public PendingIntent getSessionActivity() {
            return MediaControllerCompatApi21.getSessionActivity(this.f1799a);
        }
        ...
        public int getShuffleMode() {
            ...
            try {
                return this.f1801c.getExtraBinder().getShuffleMode();
            } catch (RemoteException e2) {
                Log.e("MediaControllerCompat", "Dead object in getShuffleMode.", e2);
                return -1;
            }
        ...
        public boolean isCaptioningEnabled() {
            ...
            try {
                return this.f1801c.getExtraBinder().isCaptioningEnabled();
            } catch (RemoteException e2) {
                Log.e("MediaControllerCompat", "Dead object in isCaptioningEnabled.", e2);
                return false;
            }
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public boolean isSessionReady() {
            return this.f1801c.getExtraBinder() != null;
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public final void registerCallback(Callback callback, Handler handler) {
            MediaControllerCompatApi21.registerCallback(this.f1799a, callback.f1794a, handler);
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public void sendCommand(String str, Bundle bundle, ResultReceiver resultReceiver) {
            MediaControllerCompatApi21.sendCommand(this.f1799a, str, bundle, resultReceiver);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public void setVolumeTo(int i2, int i3) {
            MediaControllerCompatApi21.setVolumeTo(this.f1799a, i2, i3);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public final void unregisterCallback(Callback callback) {
            MediaControllerCompatApi21.unregisterCallback(this.f1799a, callback.f1794a);
            synchronized (this.f1800b) {
                if (this.f1801c.getExtraBinder() != null) {
                    try {
                        ...
                        if (extraCallbackRemove != null) {
                            callback.f1796c = null;
                            this.f1801c.getExtraBinder().unregisterCallbackListener(extraCallbackRemove);
                        }
                    } catch (RemoteException e2) {
                        Log.e("MediaControllerCompat", "Dead object in unregisterCallback.", e2);
                    }
