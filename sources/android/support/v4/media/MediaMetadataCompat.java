...
public final class MediaMetadataCompat implements Parcelable {
    ...
    public Bitmap getBitmap(String str) {
        try {
            return (Bitmap) this.f1793a.getParcelable(str);
        } catch (Exception e2) {
    ...
    public MediaDescriptionCompat getDescription() {
        ...
        if (this.f1793a.containsKey(METADATA_KEY_BT_FOLDER_TYPE)) {
            bundle.putLong(MediaDescriptionCompat.EXTRA_BT_FOLDER_TYPE, getLong(METADATA_KEY_BT_FOLDER_TYPE));
        }
        if (this.f1793a.containsKey(METADATA_KEY_DOWNLOAD_STATUS)) {
    ...
    public long getLong(String str) {
        return this.f1793a.getLong(str, 0L);
    }
    ...
    public RatingCompat getRating(String str) {
        try {
            return RatingCompat.fromRating(this.f1793a.getParcelable(str));
        } catch (Exception e2) {
    ...
    public String getString(String str) {
        CharSequence charSequence = this.f1793a.getCharSequence(str);
    ...
    public CharSequence getText(String str) {
        return this.f1793a.getCharSequence(str);
    }

    public Set<String> keySet() {
        return this.f1793a.keySet();
    }
    ...
    public void writeToParcel(Parcel parcel, int i2) {
        parcel.writeBundle(this.f1793a);
    }
    ...
    public static final class Builder {
        ...
        public Builder putBitmap(String str, Bitmap bitmap) {
            ArrayMap arrayMap = MediaMetadataCompat.f1792b;
        ...
        public Builder(MediaMetadataCompat mediaMetadataCompat) {
            Bundle bundle = new Bundle(mediaMetadataCompat.f1793a);
            this.mBundle = bundle;
    ...
    MediaMetadataCompat(Parcel parcel) {
        this.f1793a = parcel.readBundle(MediaSessionCompat.class.getClassLoader());
    }
}
