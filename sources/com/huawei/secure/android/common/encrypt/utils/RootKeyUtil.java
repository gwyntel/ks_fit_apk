...
public class RootKeyUtil {
    ...
    private static final String f18351b = "RootKeyUtil";

    /* renamed from: a, reason: collision with root package name */
    private byte[] f18352a = null;
    ...
    public byte[] getRootKey() {
        return (byte[]) this.f18352a.clone();
    }

    public String getRootKeyHex() {
        return HexUtil.byteArray2HexStr(this.f18352a);
    }

    @SuppressLint({"NewApi"})
    private void a(String str, String str2, String str3, byte[] bArr) {
        if (Build.VERSION.SDK_INT < 26) {
            b.c(f18351b, "initRootKey: sha1");
            this.f18352a = BaseKeyUtil.exportRootKey(str, str2, str3, bArr, false);
        } else {
            b.c(f18351b, "initRootKey: sha256");
            this.f18352a = BaseKeyUtil.exportRootKey(str, str2, str3, bArr, true);
        }
    }
