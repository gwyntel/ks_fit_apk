...
public class IOUtil {
    ...
    private static final String f18509a = "IOUtil";

    /* renamed from: b, reason: collision with root package name */
    private static final int f18510b = 4096;
    ...
    public static void deleteSecure(File file) {
        ...
        Log.e(f18509a, "deleteSecure exception");
    }
    ...
    public static void closeSecure(Closeable closeable) throws IOException {
        if (closeable != null) {
            try {
                ...
                Log.e(f18509a, "closeSecure IOException");
            }
        }
    }
}
