...
public class HmsMsgService extends Service {
    ...
    private static class a extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (Objects.equals(this.f18111a.getApplicationContext().getPackageManager().getNameForUid(message.sendingUid), HMSPackageManager.getInstance(this.f18111a).getHMSPackageName()) && data != null) {
                if (HMSPackageManager.getInstance(this.f18111a).getHMSPackageStates() != PackageManagerHelper.PackageStates.ENABLED) {
