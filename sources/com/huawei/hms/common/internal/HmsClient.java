...
public abstract class HmsClient extends BaseHmsClient implements AnyClient {
    ...
    public void post(IMessageEntity iMessageEntity, String str, AnyClient.CallBack callBack) throws IllegalArgumentException {
        ...
        (z2 ? new BaseAdapter(this) : new BaseAdapter(this, cpActivity)).baseRequest(requestHeader.toJson(), str, requestHeader.getParcelable(), new a(this, callBack));
    }
    ...
    private static class a implements BaseAdapter.BaseCallBack {
        ...
        private final AnyClient.CallBack f15975a;

        /* renamed from: b, reason: collision with root package name */
        private final WeakReference<HmsClient> f15976b;

        a(HmsClient hmsClient, AnyClient.CallBack callBack) {
            this.f15975a = callBack;
            this.f15976b = new WeakReference<>(hmsClient);
        }

        private void a(String str) {
            HmsClient hmsClient = this.f15976b.get();
            if (hmsClient != null) {
        ...
        public void onError(String str) {
            ...
            if (!responseWrap.fromJson(str)) {
                this.f15975a.onCallback(new ResponseHeader(1, CommonCode.ErrorCode.ARGUMENTS_INVALID, "response header json error"), new JSONObject().toString());
                return;
            }
            ...
            this.f15975a.onCallback(responseHeader, responseWrap.getBody());
        }
        ...
        private void a(String str, String str2) {
            ...
            if (responseHeader.fromJson(str)) {
                ...
                a(responseHeader.getSessionId());
                this.f15975a.onCallback(responseHeader, str2);
                return;
            }
            this.f15975a.onCallback(new ResponseHeader(1, CommonCode.ErrorCode.ARGUMENTS_INVALID, "response header json error"), new JSONObject().toString());
        }
