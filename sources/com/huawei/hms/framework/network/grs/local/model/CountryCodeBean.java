...
public class CountryCodeBean {
    ...
    private void getLocaleCountryCode() throws ClassNotFoundException {
        String str;
        String str2;
        if (SystemPropUtils.getProperty(TmpConstant.PROPERTY_IDENTIFIER_GET, "ro.build.version.emui", ANDRIOD_SYSTEMPROP, "").isEmpty()) {
    ...
    private void getProductCountryCode() throws ClassNotFoundException {
        int iLastIndexOf;
        this.countryCode = SystemPropUtils.getProperty(TmpConstant.PROPERTY_IDENTIFIER_GET, LOCALE_REGION_COUNTRYSYSTEMPROP, ANDRIOD_SYSTEMPROP, "UNKNOWN");
        String str = TAG;
        ...
        if (TextUtils.isEmpty(this.countryCode) || "UNKNOWN".equals(this.countryCode)) {
            String property = SystemPropUtils.getProperty(TmpConstant.PROPERTY_IDENTIFIER_GET, LOCALE_COUNTRYSYSTEMPROP, ANDRIOD_SYSTEMPROP, "UNKNOWN");
    ...
    private void getVendorCountryCode() {
        ...
        this.countryCode = SystemPropUtils.getProperty(TmpConstant.PROPERTY_IDENTIFIER_GET, VENDORCOUNTRY_SYSTEMPROP, ANDRIOD_SYSTEMPROP, "UNKNOWN");
        String str = TAG;
