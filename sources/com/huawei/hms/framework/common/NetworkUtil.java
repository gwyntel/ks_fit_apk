...
public class NetworkUtil {
    ...
    private static int getMobileSingalStrengthUpPPlatfrom(Context context) {
        ...
        if (networkType == 3) {
            ...
            if (cellSignalStrengths.size() > 0) {
                ...
                List cellSignalStrengths2 = signalStrength.getCellSignalStrengths(g.a());
            ...
            if (networkType != 4) {
                if (networkType == 5) {
                    List cellSignalStrengths4 = signalStrength.getCellSignalStrengths(a.a());
                    if (cellSignalStrengths4.size() > 0) {
                        dbm = l.a(cellSignalStrengths4.get(0)).getDbm();
                    }
                }
                return dbm;
            }
    ...
    public static int getNrCsiRsrp(Context context) {
        ...
        List cellSignalStrengths = signalStrength.getCellSignalStrengths(a.a());
        if (cellSignalStrengths.size() > 0) {
            return l.a(cellSignalStrengths.get(0)).getCsiRsrp();
        }
        return Integer.MAX_VALUE;
    }
    ...
    public static int getNrCsiRsrq(Context context) {
        ...
        List cellSignalStrengths = signalStrength.getCellSignalStrengths(a.a());
        if (cellSignalStrengths.size() > 0) {
            return l.a(cellSignalStrengths.get(0)).getCsiRsrq();
        }
        return Integer.MAX_VALUE;
    }
    ...
    public static int getNrCsiSinr(Context context) {
        ...
        List cellSignalStrengths = signalStrength.getCellSignalStrengths(a.a());
        if (cellSignalStrengths.size() > 0) {
            return l.a(cellSignalStrengths.get(0)).getCsiSinr();
        }
        return Integer.MAX_VALUE;
    }
    ...
    public static Map<String, Integer> getNrSignalInfo(Context context) {
        ...
        try {
            if (Build.VERSION.SDK_INT > 28) {
                List cellSignalStrengths = signalStrength.getCellSignalStrengths(a.a());
                if (cellSignalStrengths.size() > 0) {
                    map.put(SignalType.NR_DBM, Integer.valueOf(l.a(cellSignalStrengths.get(0)).getDbm()));
                    map.put(SignalType.NR_CSIRSRP, Integer.valueOf(l.a(cellSignalStrengths.get(0)).getCsiRsrp()));
                    map.put(SignalType.NR_CSIRSRQ, Integer.valueOf(l.a(cellSignalStrengths.get(0)).getCsiRsrq()));
                    map.put(SignalType.NR_CSISINR, Integer.valueOf(l.a(cellSignalStrengths.get(0)).getCsiSinr()));
                    map.put(SignalType.NR_SSRSRP, Integer.valueOf(l.a(cellSignalStrengths.get(0)).getSsRsrp()));
                    map.put(SignalType.NR_SSRSRQ, Integer.valueOf(l.a(cellSignalStrengths.get(0)).getSsRsrq()));
                    map.put(SignalType.NR_SSSINR, Integer.valueOf(l.a(cellSignalStrengths.get(0)).getSsSinr()));
                }
            }
        } catch (Throwable th) {
            Logger.i(TAG, "getLteRssi: throwable:" + th.getClass());
    ...
    public static int getNrSsRsrp(Context context) {
        ...
        List cellSignalStrengths = signalStrength.getCellSignalStrengths(a.a());
        if (cellSignalStrengths.size() > 0) {
            return l.a(cellSignalStrengths.get(0)).getSsRsrp();
        }
        return Integer.MAX_VALUE;
    }
    ...
    public static int getNrSsRsrq(Context context) {
        ...
        List cellSignalStrengths = signalStrength.getCellSignalStrengths(a.a());
        if (cellSignalStrengths.size() > 0) {
            return l.a(cellSignalStrengths.get(0)).getSsRsrq();
        }
        return Integer.MAX_VALUE;
    }
    ...
    public static int getNrSsSinr(Context context) {
        ...
        List cellSignalStrengths = signalStrength.getCellSignalStrengths(a.a());
        if (cellSignalStrengths.size() > 0) {
            return l.a(cellSignalStrengths.get(0)).getSsSinr();
        }
        return Integer.MAX_VALUE;
    }
    ...
    public static boolean isUserUnlocked(Context context) {
        ...
        if (Build.VERSION.SDK_INT < 24 || (userManager = (UserManager) ContextCompat.getSystemService(context, ay.f21378m)) == null) {
            return true;
        }
        try {
