...
public class PushPreferences {
    ...
    protected SharedPreferences f15719a;
    ...
    public boolean removeKey(String str) {
        ...
        SharedPreferences sharedPreferences = this.f15719a;
        if (sharedPreferences == null || !sharedPreferences.contains(str) || (editorEdit = this.f15719a.edit()) == null) {
            return false;
        }
    ...
    public boolean write(ContentValues contentValues) {
        if (this.f15719a == null || contentValues == null) {
            return false;
        }
        boolean z2 = true;
    ...
    public boolean removeKey(String[] strArr) {
        ...
        for (String str : strArr) {
            if (this.f15719a.contains(str)) {
                this.f15719a.edit().remove(str);
            }
        }
        this.f15719a.edit().commit();
        return true;
    }
}
