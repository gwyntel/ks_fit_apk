...
public class AppSpoofResolution implements IBridgeActivityDelegate {
    ...
    class a implements AbstractDialog.Callback {
        ...
        public void onCancel(AbstractDialog abstractDialog) {
            com.huawei.hms.availableupdate.a.f15862c.a(true);
            AppSpoofResolution.this.f18159b = null;
    ...
    public void onBridgeActivityCreate(Activity activity) {
        ...
        com.huawei.hms.availableupdate.a aVar = com.huawei.hms.availableupdate.a.f15862c;
        aVar.a(activity);
        aVar.a(false);
        b();
    }
    ...
    public void a() {
        ...
        if (com.huawei.hms.availableupdate.a.f15862c.a().compareAndSet(true, false)) {
            SystemManager.getInstance().notifyNoticeResult(29);
        }
        activity.finish();
    }
