...
public class i extends PushPreferences {
    ...
    private static final String f16591c = "i";
    ...
    public String b(String str) {
        try {
            ...
            HMSLog.e(f16591c, "getSecureData" + e2.getMessage());
            return "";
        }
    }
    ...
    public boolean c(String str) {
        try {
            ...
            HMSLog.e(f16591c, "removeToken" + e2.getMessage());
            return false;
        }
    }
    ...
    public String a(String str) {
        ...
        try {
            return PushEncrypter.decrypter(this.f16592b, getString(str));
        } catch (Exception e2) {
            HMSLog.e(f16591c, "getSecureData" + e2.getMessage());
            return "";
        }
    ...
    public boolean a(String str, String str2) {
        ...
        try {
            return saveString(str, PushEncrypter.encrypter(this.f16592b, str2));
        } catch (Exception e2) {
            HMSLog.e(f16591c, "saveSecureData" + e2.getMessage());
            return false;
        }
    }
