...
public class OpenDeviceClientImpl extends HuaweiApi<OpenDeviceOptions> implements OpenDeviceClient {
    ...
    private static final OpenDeviceHmsClientBuilder f16579a = new OpenDeviceHmsClientBuilder();

    /* renamed from: b, reason: collision with root package name */
    private static final Api<OpenDeviceOptions> f16580b = new Api<>(HuaweiApiAvailability.HMS_API_NAME_OD);

    /* renamed from: c, reason: collision with root package name */
    private static OpenDeviceOptions f16581c = new OpenDeviceOptions();

    OpenDeviceClientImpl(Context context) {
        super(context, f16580b, f16581c, f16579a);
