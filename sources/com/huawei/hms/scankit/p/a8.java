...
public final class a8 {
    ...
    private static final int[] f16978e = {31892, 34236, 39577, 42195, 48118, 51042, 55367, 58893, 63784, 68472, 70749, 76311, 79154, 84390, 87683, 92361, 96236, 102084, 102881, 110507, 110734, 117786, 119615, 126325, 127568, 133589, 136944, 141498, 145311, 150283, 152622, 158308, 161089, 167017};

    /* renamed from: f, reason: collision with root package name */
    private static final a8[] f16979f = b();
    ...
    private a8(int i2, int[] iArr, b... bVarArr) {
        this.f16980a = i2;
        this.f16981b = iArr;
        this.f16982c = bVarArr;
        int iB = bVarArr[0].b();
        int iA = 0;
    ...
    public b a(c3 c3Var) {
        return this.f16982c[c3Var.ordinal()];
    }

    public int k() {
        return (this.f16980a * 4) + 17;
    }
    ...
    s a() {
        ...
        sVar.a(i2, 0, 8, 9);
        sVar.a(0, i2, 9, 8);
        int length = this.f16981b.length;
        for (int i3 = 0; i3 < length; i3++) {
            int i4 = this.f16981b[i3] - 2;
            for (int i5 = 0; i5 < length; i5++) {
                if ((i3 != 0 || (i5 != 0 && i5 != length - 1)) && (i3 != length - 1 || i5 != 0)) {
                    sVar.a(this.f16981b[i5] - 2, i4, 5, 5);
                }
            }
        }
        int i6 = iK - 17;
