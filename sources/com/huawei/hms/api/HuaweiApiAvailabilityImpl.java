...
final class HuaweiApiAvailabilityImpl extends HuaweiApiAvailability {
    ...
    private static final HuaweiApiAvailabilityImpl f15814a = new HuaweiApiAvailabilityImpl();

    class a implements BusResponseCallback {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ TaskCompletionSource[] f15815a;

        a(TaskCompletionSource[] taskCompletionSourceArr) {
            this.f15815a = taskCompletionSourceArr;
        }
        ...
        public BusResponseResult innerError(Activity activity, int i2, String str) {
            ...
            this.f15815a[0].setException(new AvailabilityException());
            return null;
        }
    ...
    public PendingIntent getResolveErrorPendingIntent(Activity activity, int i2) {
        ...
        if (resolveErrorIntent != null) {
            return PendingIntent.getActivity(activity, 0, resolveErrorIntent, AccessibilityEventCompat.TYPE_VIEW_TARGETED_BY_SCROLL);
        }
        return null;
    }
    ...
    public PendingIntent getResolveErrorPendingIntent(Context context, int i2) {
        ...
        if (resolveErrorIntent != null) {
            return PendingIntent.getActivity(context, 0, resolveErrorIntent, AccessibilityEventCompat.TYPE_VIEW_TARGETED_BY_SCROLL);
        }
        return null;
    }
    ...
    public PendingIntent getErrPendingIntent(Context context, int i2, int i3) {
        ...
        Intent resolveErrorIntent = getResolveErrorIntent(context, i2);
        if (resolveErrorIntent != null) {
            return PendingIntent.getActivity(context, i3, resolveErrorIntent, AccessibilityEventCompat.TYPE_VIEW_TARGETED_BY_SCROLL);
        }
        return null;
    }
