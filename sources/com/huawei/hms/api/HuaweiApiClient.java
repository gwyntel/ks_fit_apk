...
public abstract class HuaweiApiClient implements AidlApiClient {
    ...
    public static final class Builder {
        ...
        private final List<Scope> f15818b = new ArrayList();

        /* renamed from: c, reason: collision with root package name */
        private final List<PermissionInfo> f15819c = new ArrayList();

        /* renamed from: d, reason: collision with root package name */
        private final Map<Api<?>, Api.ApiOptions> f15820d = new HashMap();

        /* renamed from: e, reason: collision with root package name */
        private OnConnectionFailedListener f15821e;

        /* renamed from: f, reason: collision with root package name */
        private ConnectionCallbacks f15822f;

        /* renamed from: g, reason: collision with root package name */
        private int f15823g;

        /* renamed from: h, reason: collision with root package name */
        private Activity f15824h;
        ...
        public Builder addApi(Api<? extends Api.ApiOptions.NotRequiredOptions> api) {
            this.f15820d.put(api, null);
            if (HuaweiApiAvailability.HMS_API_NAME_GAME.equals(api.getApiName())) {
                HiAnalyticsUtil.getInstance().onEvent(this.f15817a.getApplicationContext(), HiAnalyticsConstant.KeyAndValue.GAME_INIT_KEY, "|" + System.currentTimeMillis());
            }
            return this;
        }
        ...
        public Builder allowLifeCycleManagement(Activity activity, int i2, OnConnectionFailedListener onConnectionFailedListener) {
            ...
            this.f15823g = i2;
            this.f15824h = (Activity) Preconditions.checkNotNull(activity, "activity must not be Null.");
            return this;
        }
        ...
        public HuaweiApiClient build() {
            ...
            HuaweiApiClientImpl huaweiApiClientImpl = new HuaweiApiClientImpl(this.f15817a);
            huaweiApiClientImpl.setScopes(this.f15818b);
            huaweiApiClientImpl.setPermissionInfos(this.f15819c);
            huaweiApiClientImpl.setApiMap(this.f15820d);
            huaweiApiClientImpl.setConnectionCallbacks(this.f15822f);
            huaweiApiClientImpl.setConnectionFailedListener(this.f15821e);
            huaweiApiClientImpl.setAutoLifecycleClientId(this.f15823g);
            if (this.f15823g >= 0) {
        ...
        private void a(HuaweiApiClient huaweiApiClient) {
            AutoLifecycleFragment.getInstance(this.f15824h).startAutoMange(this.f15823g, huaweiApiClient);
        }
        ...
        public <O extends Api.ApiOptions.HasOptions> Builder addApiWithScope(Api<O> api, O o2, Scope... scopeArr) {
            ...
            Checker.checkNonNull(scopeArr, "Scopes must not be null");
            this.f15820d.put(api, o2);
            if (api.getOptions() != null) {
                this.f15818b.addAll(api.getOptions().getScopeList(o2));
                this.f15819c.addAll(api.getOptions().getPermissionInfoList(o2));
            }
            this.f15818b.addAll(new ArrayList(Arrays.asList(scopeArr)));
            return this;
        }
