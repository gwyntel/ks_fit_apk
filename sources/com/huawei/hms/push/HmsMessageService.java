...
public class HmsMessageService extends Service {
    ...
    private final Messenger f16634a = new Messenger(new e(new b()));
    ...
    private void b(Intent intent) throws JSONException {
        ...
        try {
            ...
            for (int i2 = 0; i2 < jSONArray.length(); i2++) {
                ...
                String strOptString = jSONObject.optString(Constant.PARAM_TRANSACTION_ID);
