...
public class e {
    ...
    public static List<String> c(String str) {
        try {
            ...
            Log.e(f16168a, "Failed to getCertChain,JSONException:", e2);
            return Collections.emptyList();
        }
    }

    public static X509Certificate a() {
        return a(Base64.decode(f16173f, 2));
    }

    public static List<X509Certificate> b(List<String> list) {
        if (list == null) {
            Log.w(f16168a, "base64 CertChain is null.");
        ...
        while (it.hasNext()) {
            ...
            if (x509CertificateA == null) {
                Log.e(f16168a, "Failed to get cert from CertChain");
            } else {
    ...
    public static boolean b(X509Certificate x509Certificate, String str) {
        return a(x509Certificate, f16171d, str);
    }
    ...
    public static X509Certificate a(byte[] bArr) throws CertificateException {
        ...
        try {
            Certificate certificateGenerateCertificate = CertificateFactory.getInstance(f16169b).generateCertificate(new ByteArrayInputStream(bArr));
            if (certificateGenerateCertificate instanceof X509Certificate) {
                return (X509Certificate) certificateGenerateCertificate;
            }
        } catch (CertificateException e2) {
            Log.e(f16168a, "Failed to get cert,CertificateException:", e2);
        }
        return null;
    }
    ...
    public static boolean a(X509Certificate x509Certificate, byte[] bArr, byte[] bArr2) throws NoSuchAlgorithmException, SignatureException, InvalidKeyException {
        if (x509Certificate == null || bArr == null || bArr2 == null) {
            Log.w(f16168a, "checkSignature parameter is null");
            return false;
        }
        try {
            ...
            Log.e(f16168a, "failed checkSignature,Exception:", e2);
            return false;
        }
    }
