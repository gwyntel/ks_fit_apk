...
public class p1 {
    ...
    public static boolean b(String str) {
        if (p.f16447a.booleanValue()) {
            return true;
        }
        for (String str2 : f16455a) {
            if (a(str, str2, 2)) {
                return true;
            }
        }
