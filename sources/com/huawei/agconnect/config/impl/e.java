...
public class e implements g {
    ...
    private final d f15609a;

    /* renamed from: b, reason: collision with root package name */
    private SecretKey f15610b;
    ...
    public String a(String str, String str2) {
        ...
        if (this.f15610b == null) {
            ...
            try {
                return new String(i.a(this.f15610b, Hex.decodeHexString(b(str))), "UTF-8");
    ...
    private SecretKey a() {
        try {
            String strA = this.f15609a.a("/code/code1", null);
            String strA2 = this.f15609a.a("/code/code2", null);
            String strA3 = this.f15609a.a("/code/code3", null);
            String strA4 = this.f15609a.a("/code/code4", null);
            if (strA != null && strA2 != null && strA3 != null && strA4 != null) {
                this.f15610b = i.a(Hex.decodeHexString(strA), Hex.decodeHexString(strA2), Hex.decodeHexString(strA3), Hex.decodeHexString(strA4), 10000);
            }
