...
public final class i<TResult> extends Task<TResult> {
    ...
    private TResult f15687d;

    /* renamed from: e, reason: collision with root package name */
    private Exception f15688e;

    /* renamed from: a, reason: collision with root package name */
    private final Object f15684a = new Object();

    /* renamed from: f, reason: collision with root package name */
    private List<ExecuteResult<TResult>> f15689f = new ArrayList();
    ...
    private Task<TResult> a(ExecuteResult<TResult> executeResult) {
        ...
        synchronized (this.f15684a) {
            try {
                ...
                if (!zIsComplete) {
                    this.f15689f.add(executeResult);
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    private void b() {
        synchronized (this.f15684a) {
            Iterator<ExecuteResult<TResult>> it = this.f15689f.iterator();
            while (it.hasNext()) {
                try {
        ...
        synchronized (this.f15684a) {
            try {
                if (this.f15688e != null) {
                    throw new RuntimeException(this.f15688e);
                }
                tresult = this.f15687d;
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    public final <E extends Throwable> TResult getResultThrowException(Class<E> cls) throws Throwable {
        ...
        synchronized (this.f15684a) {
            if (cls != null) {
                try {
                    if (cls.isInstance(this.f15688e)) {
                        throw cls.cast(this.f15688e);
                    }
                } catch (Throwable th) {
                    throw th;
                }
    ...
    public final boolean isSuccessful() {
        ...
        synchronized (this.f15684a) {
            try {
                z2 = this.f15685b && !isCanceled() && this.f15688e == null;
            } finally {
            }
        }
        return z2;
