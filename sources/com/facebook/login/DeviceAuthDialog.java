...
public class DeviceAuthDialog extends DialogFragment {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void onSuccess(final String str, Long l2, Long l3) {
        Bundle bundle = new Bundle();
        ...
        new GraphRequest(new AccessToken(str, FacebookSdk.getApplicationId(), "0", null, null, null, null, date, null, date2), "me", bundle, HttpMethod.GET, new GraphRequest.Callback() { // from class: com.facebook.login.DeviceAuthDialog.7
            @Override // com.facebook.GraphRequest.Callback
            public void onCompleted(GraphResponse graphResponse) throws JSONException, Resources.NotFoundException {
                ...
                try {
                    ...
                    Utility.PermissionsLists permissionsListsHandlePermissionResponse = Utility.handlePermissionResponse(jSONObject);
                    ...
                    if (!FetchedAppSettingsManager.getAppSettingsWithoutQuery(FacebookSdk.getApplicationId()).getSmartLoginOptions().contains(SmartLoginOption.RequireConfirm) || DeviceAuthDialog.this.isRetry) {
                        DeviceAuthDialog.this.completeLogin(string, permissionsListsHandlePermissionResponse, str, date, date2);
                    } else {
                        DeviceAuthDialog.this.isRetry = true;
                        DeviceAuthDialog.this.presentConfirmation(string, permissionsListsHandlePermissionResponse, str, string2, date, date2);
                    }
                } catch (JSONException e2) {
                    DeviceAuthDialog.this.onError(new FacebookException(e2));
                }
    ...
    protected View initializeContentView(boolean z2) {
        View viewInflate = getActivity().getLayoutInflater().inflate(getLayoutResId(z2), (ViewGroup) null);
        this.progressBar = viewInflate.findViewById(R.id.progress_bar);
        this.confirmationCode = (TextView) viewInflate.findViewById(R.id.confirmation_code);
        ((Button) viewInflate.findViewById(R.id.cancel_button)).setOnClickListener(new View.OnClickListener() { // from class: com.facebook.login.DeviceAuthDialog.2
        ...
        new GraphRequest(null, DEVICE_LOGIN_ENDPOINT, bundle, HttpMethod.POST, new GraphRequest.Callback() { // from class: com.facebook.login.DeviceAuthDialog.1
            ...
            public void onCompleted(GraphResponse graphResponse) {
                ...
                try {
                    ...
                    requestState.setInterval(jSONObject.getLong(bc.ba));
