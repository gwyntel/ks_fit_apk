...
class LoginLogger {
    ...
    public void logAuthorizationMethodComplete(String str, String str2, String str3, String str4, String str5, Map<String, String> map) {
        ...
        this.logger.logEventImplicitly(EVENT_NAME_LOGIN_METHOD_COMPLETE, bundleNewAuthorizationLoggingBundle);
    }

    public void logAuthorizationMethodNotTried(String str, String str2) {
        Bundle bundleNewAuthorizationLoggingBundle = newAuthorizationLoggingBundle(str);
        bundleNewAuthorizationLoggingBundle.putString(EVENT_PARAM_METHOD, str2);
        this.logger.logEventImplicitly(EVENT_NAME_LOGIN_METHOD_NOT_TRIED, bundleNewAuthorizationLoggingBundle);
    }

    public void logAuthorizationMethodStart(String str, String str2) {
        Bundle bundleNewAuthorizationLoggingBundle = newAuthorizationLoggingBundle(str);
        bundleNewAuthorizationLoggingBundle.putString(EVENT_PARAM_METHOD, str2);
        this.logger.logEventImplicitly(EVENT_NAME_LOGIN_METHOD_START, bundleNewAuthorizationLoggingBundle);
    }

    public void logCompleteLogin(String str, Map<String, String> map, LoginClient.Result.Code code, Map<String, String> map2, Exception exc) throws JSONException {
        Bundle bundleNewAuthorizationLoggingBundle = newAuthorizationLoggingBundle(str);
        if (code != null) {
        ...
        this.logger.logEventImplicitly(EVENT_NAME_LOGIN_COMPLETE, bundleNewAuthorizationLoggingBundle);
    }
    ...
    public void logStartLogin(LoginClient.Request request) throws JSONException {
        ...
        this.logger.logEventImplicitly(EVENT_NAME_LOGIN_START, null, bundleNewAuthorizationLoggingBundle);
    }
