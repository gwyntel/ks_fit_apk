...
public final class Validate {
    ...
    public static void hasFacebookActivity(Context context, boolean z2) throws PackageManager.NameNotFoundException {
    ...
    public static void hasInternetPermissions(Context context, boolean z2) {
        notNull(context, f.X);
