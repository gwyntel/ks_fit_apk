...
public class UCropActivity extends AppCompatActivity {
    ...
    private void processOptions(@NonNull Intent intent) {
        ...
        if (floatExtra >= 0.0f && floatExtra2 >= 0.0f) {
            ...
            this.mGestureCropImageView.setTargetAspectRatio(Float.isNaN(f2) ? 0.0f : f2);
    ...
    private void setupViews(@NonNull Intent intent) throws Resources.NotFoundException {
    ...
    protected void u() {
        ...
        this.mGestureCropImageView.cropAndSaveImage(this.mCompressFormat, this.mCompressQuality, new BitmapCropCallback() { // from class: com.yalantis.ucrop.UCropActivity.8
            ...
            public void onBitmapCropped(@NonNull Uri uri, int i2, int i3, int i4, int i5) {
                ...
                uCropActivity.w(uri, uCropActivity.mGestureCropImageView.getTargetAspectRatio(), i2, i3, i4, i5);
                UCropActivity.this.finish();
            }
    ...
    protected void w(Uri uri, float f2, int i2, int i3, int i4, int i5) {
