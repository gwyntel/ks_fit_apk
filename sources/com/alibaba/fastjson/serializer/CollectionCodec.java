                ...
                if (obj3 == null) {
                    ...
                    if (cls == Integer.class) {
                        ...
                        if (SerializerFeature.isEnabled(i2, SerializerFeature.WriteClassName) && (objectWriter instanceof JavaBeanSerializer)) {
                            ((JavaBeanSerializer) objectWriter).writeNoneASM(jSONSerializer, obj3, Integer.valueOf(i3), collectionItemType, i2);
                        } else {
                            objectWriter.write(jSONSerializer, obj3, Integer.valueOf(i3), collectionItemType, i2);
                        }
                    }
                }
                i3 = i4;
