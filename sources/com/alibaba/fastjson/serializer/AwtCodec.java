...
public class AwtCodec implements ObjectSerializer, ObjectDeserializer {
    ...
    protected Rectangle parseRectangle(DefaultJSONParser defaultJSONParser) {
        ...
        while (jSONLexer.token() != 13) {
            ...
            if (strStringVal.equalsIgnoreCase("x")) {
                ...
                i3 = iFloatValue;
            } else if (strStringVal.equalsIgnoreCase(ViewHierarchyConstants.DIMENSION_WIDTH_KEY)) {
                i4 = iFloatValue;
            } else {
                if (!strStringVal.equalsIgnoreCase(ViewHierarchyConstants.DIMENSION_HEIGHT_KEY)) {
                    throw new JSONException("syntax error, " + strStringVal);
                }
                i5 = iFloatValue;
            }
    ...
    public void write(JSONSerializer jSONSerializer, Object obj, Object obj2, Type type, int i2) throws IOException {
        ...
        if (obj instanceof Point) {
            ...
            serializeWriter.writeFieldValue(',', ViewHierarchyConstants.DIMENSION_HEIGHT_KEY, rectangle.height);
        } else {
