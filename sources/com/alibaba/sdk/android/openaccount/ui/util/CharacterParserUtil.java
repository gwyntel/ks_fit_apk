    ...
    private int getChsAscii(String str) throws UnsupportedEncodingException {
        ...
        try {
            ...
            try {
                ...
                e = e2;
                b2 = b3;
                AliSDKLogger.e("CharacterParserUtil", "ERROR:ChineseSpelling.class-getChsAscii(String chs)" + e);
                return b2;
            }
        } catch (Exception e3) {
            e = e3;
