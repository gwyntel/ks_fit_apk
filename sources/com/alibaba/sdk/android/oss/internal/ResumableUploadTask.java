...
public class ResumableUploadTask extends BaseMultipartUploadTask<ResumableUploadRequest, ResumableUploadResult> implements Callable<ResumableUploadResult> {
    ...
    public void checkPartSize(int[] iArr) {
        long partSize = ((ResumableUploadRequest) this.mRequest).getPartSize();
    ...
    /* JADX WARN: Removed duplicated region for block: B:38:0x0156 A[Catch: ClientException -> 0x019c, ServiceException -> 0x019e, TryCatch #5 {ClientException -> 0x019c, ServiceException -> 0x019e, blocks: (B:35:0x0145, B:36:0x0150, B:38:0x0156, B:40:0x0172, B:42:0x0178, B:44:0x0186, B:49:0x01a0, B:51:0x01bd), top: B:80:0x0145 }] */
    ...
    */
    ...
    public ResumableUploadResult doMultipartUpload() throws Throwable {
        ...
        if (this.mPartETags.size() > 0 && this.mAlreadyUploadIndex.size() > 0) {
            ...
            long j4 = this.mFirstPartSize;
            if (j4 > 0 && j4 != iMin && j4 < j3) {
                throw new ClientException("current part size " + iMin + " setting is inconsistent with before " + this.mFirstPartSize);
            }
            ...
            if (oSSProgressCallback != 0) {
                oSSProgressCallback.onProgress(this.mRequest, j5, this.mFileLength);
            }
            ...
            if ((this.mAlreadyUploadIndex.size() == 0 || !this.mAlreadyUploadIndex.contains(Integer.valueOf(i3 + 1))) && this.mPoolExecutor != null) {
                ...
                this.mPoolExecutor.execute(new Runnable() { // from class: com.alibaba.sdk.android.oss.internal.ResumableUploadTask.1
                    ...
                    public void run() throws Throwable {
                        ResumableUploadTask.this.uploadPart(i3, iMin, i2);
                    }
                });
            }
        }
