...
public final class ap {
    ...
    private static Map<String, String> f20807a;
    ...
    public static String a(long j2) {
        try {
            return new SimpleDateFormat(CalendarUtils.yyyy_MM_dd_HH_mm_ss, Locale.US).format(new Date(j2));
    ...
    public static String a(Date date) {
        try {
            return new SimpleDateFormat(CalendarUtils.yyyy_MM_dd_HH_mm_ss, Locale.US).format(date);
        } catch (Exception unused) {
            return new Date().toString();
        }
    }
    ...
    public static String a(String str) {
        ...
        try {
            ...
            if (f20807a.containsKey(str)) {
                return f20807a.get(str);
            }
            String systemProperty = NativeCrashHandler.getInstance().getSystemProperty(str);
            if (!TextUtils.isEmpty(systemProperty) && !systemProperty.equals(ITagManager.FAIL)) {
                f20807a.put(str, systemProperty);
            }
    ...
    public static void a(Parcel parcel, Map<String, PlugInBean> map) {
        if (map != null && map.size() > 0) {
            ...
            for (int i3 = 0; i3 < arrayList.size(); i3++) {
                bundle.putString("pluginVal" + i3 + "plugInId", ((PlugInBean) arrayList2.get(i3)).f20594a);
                bundle.putString("pluginVal" + i3 + "plugInUUID", ((PlugInBean) arrayList2.get(i3)).f20596c);
                bundle.putString("pluginVal" + i3 + "plugInVersion", ((PlugInBean) arrayList2.get(i3)).f20595b);
            }
            parcel.writeBundle(bundle);
            return;
        }
