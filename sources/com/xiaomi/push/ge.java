...
public enum ge {
    ...
    GSLB_TCP_NOACCESS(UIMessageConstants.OPEN_ACCOUNT_RESET_PASSWORD_CANCEL),
    GSLB_TCP_NETUNREACH(UIMessageConstants.OPEN_ACCOUNT_NO_PASSWORD_LOGIN_CANCEL),
    GSLB_TCP_CONNREFUSED(UIMessageConstants.OPEN_ACCOUNT_CHANGE_MOBILE_CANCEL),
    ...
    CHANNEL_XMPPEXCEPTION(RpcServerBizConstants.PWD_ERROR_TO_TIME_EXPIRED),
        ...
        switch (i2) {
            ...
            default:
                switch (i2) {
                    ...
                    case RpcServerBizConstants.PWD_ERROR_TO_TIME_EXPIRED /* 40399 */:
                    ...
                    default:
                        switch (i2) {
                            case UIMessageConstants.OPEN_ACCOUNT_RESET_PASSWORD_CANCEL /* 10101 */:
                                return GSLB_TCP_NOACCESS;
                            case UIMessageConstants.OPEN_ACCOUNT_NO_PASSWORD_LOGIN_CANCEL /* 10102 */:
                                return GSLB_TCP_NETUNREACH;
                            case UIMessageConstants.OPEN_ACCOUNT_CHANGE_MOBILE_CANCEL /* 10103 */:
