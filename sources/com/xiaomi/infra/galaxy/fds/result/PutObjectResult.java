...
public class PutObjectResult {
    ...
    public String getRelativePreSignedUri() throws URISyntaxException {
        return new URI(null, null, null, -1, "/" + this.bucketName + "/" + this.objectName, "GalaxyAccessKeyId=" + this.accessKeyId + "&Expires" + ContainerUtils.KEY_VALUE_DELIMITER + this.expires + "&Signature" + ContainerUtils.KEY_VALUE_DELIMITER + this.signature, null).toString();
    }
