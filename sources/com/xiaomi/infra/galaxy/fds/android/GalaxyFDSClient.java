...
public interface GalaxyFDSClient {
    ...
    FDSObject getObject(String str, long j2, List<UserParam> list, ProgressListener progressListener) throws GalaxyFDSClientException;

    FDSObject getObject(String str, String str2) throws GalaxyFDSClientException;

    FDSObject getObject(String str, String str2, long j2, List<UserParam> list) throws GalaxyFDSClientException;

    FDSObject getObject(String str, String str2, long j2, List<UserParam> list, ProgressListener progressListener) throws GalaxyFDSClientException;

    FDSObject getObject(String str, String str2, long j2, List<UserParam> list, ProgressListener progressListener, boolean z2) throws GalaxyFDSClientException;
    ...
    ObjectMetadata getObject(String str, String str2, File file, List<UserParam> list, ProgressListener progressListener, boolean z2) throws GalaxyFDSClientException;
