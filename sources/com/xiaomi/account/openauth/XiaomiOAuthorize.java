...
public class XiaomiOAuthorize {
    ...
    private XiaomiOAuthFuture<XiaomiOAuthResults> oauth(final Activity activity) {
        ...
        XiaomiOAuthFutureImpl xiaomiOAuthFutureImpl = new XiaomiOAuthFutureImpl(new Callable<XiaomiOAuthResults>() { // from class: com.xiaomi.account.openauth.XiaomiOAuthorize.1
            ...
            public XiaomiOAuthResults call() throws Exception {
                OAuthConfig oAuthConfigBuild = new OAuthConfig.Builder(XiaomiOAuthorize.this.mConfigBuilder).build();
                return OAuthFactory.createOAuth(oAuthConfigBuild).startOAuth(activity, oAuthConfigBuild);
            }
        });
    ...
    @Deprecated
    private static void startGetOAuthorize(final Activity activity, long j2, String str, final String str2, Bundle bundle, final int i2) {
        if (bundle == null) {
            bundle = new Bundle();
        }
        XiaomiOAuthorize state = new XiaomiOAuthorize().setAppId(j2).setRedirectUrl(str).setScope(scopeStringToIntArray(bundle.getString(XiaomiOAuthConstants.EXTRA_SCOPE))).setState(bundle.getString(XiaomiOAuthConstants.EXTRA_STATE));
        ...
        final XiaomiOAuthFuture<XiaomiOAuthResults> xiaomiOAuthFutureStartGetOAuthCode = "code".equalsIgnoreCase(str2) ? state.startGetOAuthCode(activity) : state.startGetAccessToken(activity);
        new AsyncTask<Void, Void, XiaomiOAuthResults>() { // from class: com.xiaomi.account.openauth.XiaomiOAuthorize.4
            ...
            public XiaomiOAuthResults doInBackground(Void... voidArr) {
                try {
                    return (XiaomiOAuthResults) xiaomiOAuthFutureStartGetOAuthCode.getResult();
            ...
            public void onPostExecute(XiaomiOAuthResults xiaomiOAuthResults) {
                ...
                if (xiaomiOAuthResults == null) {
                    if (this.f23283e == null) {
                        ...
                        bundle2.putInt("error", i3);
                        bundle2.putString("error_description", this.f23283e.getMessage());
                    }
                } else if (xiaomiOAuthResults.hasError()) {
                    int i4 = AuthorizeActivityBase.RESULT_FAIL;
                    bundle2.putInt("error", xiaomiOAuthResults.getErrorCode());
                    bundle2.putString("error_description", xiaomiOAuthResults.getErrorMessage());
                    i3 = i4;
                } else {
                    int i5 = AuthorizeActivityBase.RESULT_SUCCESS;
                    if ("code".equalsIgnoreCase(str2)) {
                        bundle2.putString("code", xiaomiOAuthResults.getCode());
                        bundle2.putString("state", xiaomiOAuthResults.getState());
                ...
                activity2.startActivityForResult(AuthorizeActivityBase.asMiddleActivity(activity2, i3, bundle2, (Class<? extends AuthorizeActivityBase>) XiaomiOAuthorize.DEFAULT_AUTHORIZE_ACTIVITY_CLASS), i2);
            }
        }.execute(new Void[0]);
    }

    public XiaomiOAuthFuture<String> callOpenApi(final Context context, final long j2, final String str, final String str2, final String str3, final String str4) {
        final FutureTask futureTask = new FutureTask(new Callable<String>() { // from class: com.xiaomi.account.openauth.XiaomiOAuthorize.2
            ...
            public String call() throws Exception {
                return AuthorizeApi.doHttpGet(context, str, j2, str2, str3, str4);
            }
        });
    ...
    public XiaomiOAuthorize setHideSwitch(boolean z2) {
        this.mConfigBuilder.hideSwitch(z2);
        return this;
    }

    public XiaomiOAuthorize setKeepCookies(boolean z2) {
        this.mConfigBuilder.keepCookies(z2);
        return this;
    }
    ...
    public XiaomiOAuthorize setNoMiui(boolean z2) {
        this.mConfigBuilder.notUseMiui(z2);
        return this;
    }

    public XiaomiOAuthorize setPhoneNumAutoFill(Context context, boolean z2, long j2) {
        if (z2) {
            try {
                this.mConfigBuilder.phoneInfo(new MiAccountPhoneInfo(context, j2));
    ...
    public XiaomiOAuthorize setPlatform(int i2) {
        this.mConfigBuilder.platform(i2);
        return this;
    }
    ...
    public XiaomiOAuthorize setSkipConfirm(boolean z2) {
        this.mConfigBuilder.skipConfirm(z2);
        return this;
    }
    ...
    public XiaomiOAuthorize setUseSystemAccountLogin(boolean z2) {
        this.mConfigBuilder.useSystemAccountLogin(z2);
        return this;
    }
    ...
    public static void startGetAccessToken(Activity activity, long j2, String str, Bundle bundle, int i2) {
        ...
        startGetOAuthorize(activity, j2, str, "token", bundle, i2);
    }
    ...
    public static void startGetOAuthCode(Activity activity, long j2, String str, Bundle bundle, int i2) {
        ...
        startGetOAuthorize(activity, j2, str, "code", bundle, i2);
    }

    public XiaomiOAuthorize setPhoneNumAutoFill(Context context, boolean z2) {
        return setPhoneNumAutoFill(context, z2, ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS);
    }
}
