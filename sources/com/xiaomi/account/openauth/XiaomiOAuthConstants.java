...
public class XiaomiOAuthConstants {
    ...
    static {
        boolean zExists = new File("/data/system/oauth_staging_preview").exists();
        USE_PREVIEW = zExists;
        OAUTH2_HOST = zExists ? "http://account.preview.n.xiaomi.net" : "https://account.xiaomi.com";
        OAUTH2_API_URL_BASE = zExists ? "http://open.account.preview.n.xiaomi.net" : "https://open.account.xiaomi.com";
        OAUTH2_API_HOST = zExists ? "open.account.preview.n.xiaomi.net" : "open.account.xiaomi.com";
    }
}
