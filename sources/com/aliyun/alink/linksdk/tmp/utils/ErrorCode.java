...
public class ErrorCode {
    public static final int AUGHSIGN_ILLEGAL = 4106;
    public static final String AUGHSIGN_ILLEGAL_MSG = "authsign faild";
    public static final int CONNECT_NOT_EXIT = 517;
    public static final int ERROR_CODE = 300;
    public static final int ERROR_CODE_NOTSUPPORT = 305;
    public static final int ERROR_CODE_ONLINEFAIL = 306;
    public static final int ERROR_CODE_PARAMSINVALID = 302;
    public static final int ERROR_CODE_RESPONSEINVALID = 303;
    public static final int ERROR_CODE_SESSIONINVALID = 301;
    public static final int ERROR_CODE_TIMEOUT = 408;
    public static final int ERROR_CODE_UNKNOWN = 304;
    public static final String ERROR_MSG = "errror";
    public static final String ERROR_MSG_NOTFOUND = "not found";
    public static final String ERROR_MSG_NOTSUPPORT = "not support";
    public static final String ERROR_MSG_ONLINEFAILD = "online failed";
