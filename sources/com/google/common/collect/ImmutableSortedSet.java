...
public abstract class ImmutableSortedSet<E> extends ImmutableSet<E> implements NavigableSet<E>, SortedIterable<E> {
    ...
    public static final class Builder<E> extends ImmutableSet.Builder<E> {
        ...
        public Builder c(ImmutableSet.Builder builder) {
            super.c(builder);
            return this;
        }
        ...
        Builder(Comparator comparator, int i2) {
            super(i2, false);
            this.comparator = (Comparator) Preconditions.checkNotNull(comparator);
        }
        ...
        public ImmutableSortedSet<E> build() {
            ImmutableSortedSet<E> immutableSortedSetConstruct = ImmutableSortedSet.construct(this.comparator, this.f14002b, this.f14001a);
            this.f14002b = immutableSortedSetConstruct.size();
            this.f14003c = true;
    ...
    static <E> ImmutableSortedSet<E> construct(Comparator<? super E> comparator, int i2, E... eArr) {
        ...
        for (int i4 = 1; i4 < i2; i4++) {
            IsEnabledMessage isEnabledMessage = (Object) eArr[i4];
            if (comparator.compare(isEnabledMessage, (Object) eArr[i3 - 1]) != 0) {
                eArr[i3] = isEnabledMessage;
                i3++;
            }
        }
    ...
    public static <E> Collector<E, ?, ImmutableSortedSet<E>> toImmutableSortedSet(Comparator<? super E> comparator) {
        return CollectCollectors.V(comparator);
    }
    ...
    abstract ImmutableSortedSet<E> headSetImpl(E e2, boolean z2);
    ...
    abstract ImmutableSortedSet<E> subSetImpl(E e2, boolean z2, E e3, boolean z3);
    ...
    abstract ImmutableSortedSet<E> tailSetImpl(E e2, boolean z2);
