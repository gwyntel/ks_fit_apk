...
final class SortedLists {
    ...
    enum KeyPresentBehavior {
        ...
        FIRST_AFTER { // from class: com.google.common.collect.SortedLists.KeyPresentBehavior.4
            @Override // com.google.common.collect.SortedLists.KeyPresentBehavior
            public <E> int resultIndex(Comparator<? super E> comparator, @ParametricNullness E e2, List<? extends E> list, int i2) {
        ...
        abstract <E> int resultIndex(Comparator<? super E> comparator, @ParametricNullness E e2, List<? extends E> list, int i2);
    }
