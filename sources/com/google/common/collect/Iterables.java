...
public final class Iterables {
    ...
    static Object a(Iterable iterable, Predicate predicate) {
    ...
    static Object[] c(Iterable iterable, Object[] objArr) {
    ...
    public static boolean contains(Iterable<? extends Object> iterable, @CheckForNull Object obj) {
        return iterable instanceof Collection ? Collections2.d((Collection) iterable, obj) : Iterators.contains(iterable.iterator(), obj);
    }
    ...
    public static <T> Iterable<T> mergeSorted(final Iterable<? extends Iterable<? extends T>> iterable, final Comparator<? super T> comparator) {
        ...
        return new UnmodifiableIterable(new FluentIterable<T>() { // from class: com.google.common.collect.Iterables.9
            @Override // java.lang.Iterable
            public Iterator<T> iterator() {
                return Iterators.mergeSorted(Iterables.transform(iterable, new q2()), comparator);
            }
        });
    }
        ...
        return new FluentIterable<T>() { // from class: com.google.common.collect.Iterables.6
            ...
            public Iterator<T> iterator() {
                ...
                return new Iterator<T>(this) { // from class: com.google.common.collect.Iterables.6.1
                    ...
                    boolean f14058a = true;

                    /* renamed from: c, reason: collision with root package name */
                    final /* synthetic */ AnonymousClass6 f14060c;
                    ...
                    @Override // java.util.Iterator
                    public void remove() {
                        CollectPreconditions.e(!this.f14058a);
                        it.remove();
                    }
                };
            }
    ...
    public static <T> T get(Iterable<? extends T> iterable, int i2, @ParametricNullness T t2) {
        ...
        if (iterable instanceof List) {
            ...
            return i2 < listA.size() ? (T) listA.get(i2) : t2;
        }
