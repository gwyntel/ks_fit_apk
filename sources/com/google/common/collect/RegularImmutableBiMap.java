...
final class RegularImmutableBiMap<K, V> extends ImmutableBiMap<K, V> {
    ...
    RegularImmutableBiMap(Object[] objArr, int i2) {
        ...
        this.keyHashTable = RegularImmutableMap.createHashTableOrThrow(objArr, i2, iChooseTableSize, 0);
        this.inverse = new RegularImmutableBiMap<>(RegularImmutableMap.createHashTableOrThrow(objArr, i2, iChooseTableSize, 1), objArr, i2, this);
    }
