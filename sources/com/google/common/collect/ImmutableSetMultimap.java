...
public class ImmutableSetMultimap<K, V> extends ImmutableMultimap<K, V> implements SetMultimap<K, V> {
    ...
    public static final class Builder<K, V> extends ImmutableMultimap.Builder<K, V> {
        ...
        int c(int i2, Iterable iterable) {
            return iterable instanceof Set ? Math.max(i2, ((Set) iterable).size()) : i2;
        }

        @Override // com.google.common.collect.ImmutableMultimap.Builder
        ImmutableCollection.Builder d(int i2) {
            Comparator comparator = this.f14026c;
            return comparator == null ? ImmutableSet.builderWithExpectedSize(i2) : new ImmutableSortedSet.Builder(comparator, i2);
        }
        ...
        public ImmutableSetMultimap<K, V> build() {
            ...
            return ImmutableSetMultimap.fromMapBuilderEntries(collectionEntrySet, this.f14026c);
        }
    ...
    private static final class SetFieldSettersHolder {
        ...
        static final Serialization.FieldSetter f14044a = Serialization.a(ImmutableSetMultimap.class, "emptySet");
    ...
    private void readObject(ObjectInputStream objectInputStream) throws ClassNotFoundException, IOException {
        ...
        try {
            ...
            SetFieldSettersHolder.f14044a.b(this, emptySet(comparator));
    ...
    public static <T, K, V> Collector<T, ?, ImmutableSetMultimap<K, V>> toImmutableSetMultimap(Function<? super T, ? extends K> function, Function<? super T, ? extends V> function2) {
        return CollectCollectors.S(function, function2);
    }
