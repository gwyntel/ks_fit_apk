...
public class ImmutableRangeMap<K extends Comparable<?>, V> implements RangeMap<K, V>, Serializable {
    ...
    public static <T, K extends Comparable<? super K>, V> Collector<T, ?, ImmutableRangeMap<K, V>> toImmutableRangeMap(Function<? super T, Range<K>> function, Function<? super T, ? extends V> function2) {
        return CollectCollectors.P(function, function2);
    }
    ...
    @CheckForNull
    public V get(K k2) {
        int iBinarySearch = SortedLists.binarySearch(this.ranges, new u2(), Cut.belowValue(k2), SortedLists.KeyPresentBehavior.ANY_PRESENT, SortedLists.KeyAbsentBehavior.NEXT_LOWER);
    ...
    public ImmutableRangeMap<K, V> subRangeMap(final Range<K> range) {
        ...
        final int iBinarySearch = SortedLists.binarySearch(immutableList, t2Var, comparable, keyPresentBehavior, keyAbsentBehavior);
        int iBinarySearch2 = SortedLists.binarySearch(this.ranges, new u2(), range.upperBound, SortedLists.KeyPresentBehavior.ANY_PRESENT, keyAbsentBehavior);
        ...
        return (ImmutableRangeMap<K, V>) new ImmutableRangeMap<K, V>(this, new ImmutableList<Range<K>>(this) { // from class: com.google.common.collect.ImmutableRangeMap.1
            ...
            public Range<K> get(int i3) {
                ...
                return (i3 == 0 || i3 == i2 + (-1)) ? ((Range) this.this$0.ranges.get(i3 + iBinarySearch)).intersection(range) : (Range) this.this$0.ranges.get(i3 + iBinarySearch);
            }
