...
public class TreeRangeSet<C extends Comparable<?>> extends AbstractRangeSet<C> implements Serializable {
    ...
    final class AsRanges extends ForwardingCollection<Range<C>> implements Set<Range<C>> {
        ...
        final Collection f14388a;

        AsRanges(Collection collection) {
            this.f14388a = collection;
        }
    ...
    private static final class ComplementRangesByLowerBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        Iterator a() {
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>(this, cutBelowAll, peekingIterator) { // from class: com.google.common.collect.TreeRangeSet.ComplementRangesByLowerBound.1
                ...
                final /* synthetic */ Cut f14391b;

                /* renamed from: c, reason: collision with root package name */
                final /* synthetic */ PeekingIterator f14392c;

                /* renamed from: d, reason: collision with root package name */
                final /* synthetic */ ComplementRangesByLowerBound f14393d;

                {
                    this.f14391b = cutBelowAll;
                    this.f14392c = peekingIterator;
                    this.f14393d = this;
                    this.f14390a = cutBelowAll;
                }
                ...
                public Map.Entry computeNext() {
                    Range rangeCreate;
                    if (this.f14393d.complementLowerBoundWindow.upperBound.isLessThan(this.f14390a) || this.f14390a == Cut.aboveAll()) {
                        return (Map.Entry) a();
                    }
                    if (this.f14392c.hasNext()) {
                        Range range = (Range) this.f14392c.next();
                        rangeCreate = Range.create(this.f14390a, range.lowerBound);
                        this.f14390a = range.upperBound;
                    } else {
                        rangeCreate = Range.create(this.f14390a, Cut.aboveAll());
                        this.f14390a = Cut.aboveAll();
                    }
        ...
        Iterator b() {
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>(this, (Cut) MoreObjects.firstNonNull(cutHigherKey, Cut.aboveAll()), peekingIterator) { // from class: com.google.common.collect.TreeRangeSet.ComplementRangesByLowerBound.2
                ...
                /* renamed from: b, reason: collision with root package name */
                final /* synthetic */ Cut f14395b;

                /* renamed from: c, reason: collision with root package name */
                final /* synthetic */ PeekingIterator f14396c;

                /* renamed from: d, reason: collision with root package name */
                final /* synthetic */ ComplementRangesByLowerBound f14397d;

                {
                    this.f14395b = cut;
                    this.f14396c = peekingIterator;
                    this.f14397d = this;
                    this.f14394a = cut;
                }
                ...
                /* renamed from: b, reason: merged with bridge method [inline-methods] */
                public Map.Entry computeNext() {
                    if (this.f14394a == Cut.belowAll()) {
                        return (Map.Entry) a();
                    }
                    if (this.f14396c.hasNext()) {
                        Range range = (Range) this.f14396c.next();
                        Range rangeCreate = Range.create(range.upperBound, this.f14394a);
                        this.f14394a = range.lowerBound;
                        if (this.f14397d.complementLowerBoundWindow.lowerBound.isLessThan(rangeCreate.lowerBound)) {
                            return Maps.immutableEntry(rangeCreate.lowerBound, rangeCreate);
                        }
                    } else if (this.f14397d.complementLowerBoundWindow.lowerBound.isLessThan(Cut.belowAll())) {
                        Range rangeCreate2 = Range.create(Cut.belowAll(), this.f14394a);
                        this.f14394a = Cut.belowAll();
    ...
    static final class RangesByUpperBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        Iterator a() {
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>(this) { // from class: com.google.common.collect.TreeRangeSet.RangesByUpperBound.1
                ...
                /* renamed from: b, reason: collision with root package name */
                final /* synthetic */ RangesByUpperBound f14399b;
                ...
                public Map.Entry computeNext() {
                    ...
                    return this.f14399b.upperBoundWindow.upperBound.isLessThan(range.upperBound) ? (Map.Entry) a() : Maps.immutableEntry(range.upperBound, range);
                }
            };
        }
        ...
        Iterator b() {
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>(this) { // from class: com.google.common.collect.TreeRangeSet.RangesByUpperBound.2
                ...
                /* renamed from: b, reason: collision with root package name */
                final /* synthetic */ RangesByUpperBound f14401b;
                ...
                public Map.Entry computeNext() {
                    ...
                    return this.f14401b.upperBoundWindow.lowerBound.isLessThan(range.upperBound) ? Maps.immutableEntry(range.upperBound, range) : (Map.Entry) a();
                }
            };
        }
    ...
    private final class SubRangeSet extends TreeRangeSet<C> {
        ...
        public Range<C> rangeContaining(C c2) {
            ...
            if (this.restriction.contains(c2) && (rangeRangeContaining = TreeRangeSet.this.rangeContaining(c2)) != null) {
    ...
    private static final class SubRangeSetRangesByLowerBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        Iterator a() {
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>(this) { // from class: com.google.common.collect.TreeRangeSet.SubRangeSetRangesByLowerBound.1
                ...
                /* renamed from: c, reason: collision with root package name */
                final /* synthetic */ SubRangeSetRangesByLowerBound f14404c;
                ...
                public Map.Entry computeNext() {
                    ...
                    Range rangeIntersection = range.intersection(this.f14404c.restriction);
        ...
        Iterator b() {
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>(this) { // from class: com.google.common.collect.TreeRangeSet.SubRangeSetRangesByLowerBound.2
                ...
                /* renamed from: b, reason: collision with root package name */
                final /* synthetic */ SubRangeSetRangesByLowerBound f14406b;
                ...
                public Map.Entry computeNext() {
                    ...
                    Range range = (Range) it.next();
                    if (this.f14406b.restriction.lowerBound.compareTo((Cut) range.upperBound) >= 0) {
                        return (Map.Entry) a();
                    }
                    Range rangeIntersection = range.intersection(this.f14406b.restriction);
                    return this.f14406b.lowerBoundWindow.contains(rangeIntersection.lowerBound) ? Maps.immutableEntry(rangeIntersection.lowerBound, rangeIntersection) : (Map.Entry) a();
                }
            };
        }
    ...
    public Range<C> rangeContaining(C c2) {
        ...
        Map.Entry<Cut<C>, Range<C>> entryFloorEntry = this.rangesByLowerBound.floorEntry(Cut.belowValue(c2));
