...
final class ReaderInputStream extends InputStream {
    ...
    ReaderInputStream(Reader reader, Charset charset, int i2) {
    ...
    private void readMoreChars() throws IOException {
        if (availableCapacity(this.charBuffer) == 0) {
            if (this.charBuffer.position() > 0) {
                Java8Compatibility.b(this.charBuffer.compact());
            } else {
        ...
        if (i2 == -1) {
            ...
            Java8Compatibility.c(this.charBuffer, iLimit + i2);
        }
    }

    private void startDraining(boolean z2) {
        Java8Compatibility.b(this.byteBuffer);
