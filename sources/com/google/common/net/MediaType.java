...
public final class MediaType {
    ...
    private static final class Tokenizer {
        ...
        String c(CharMatcher charMatcher) {
            ...
            Preconditions.checkState(this.f14713b != i2);
            return strD;
        }
        ...
        String d(CharMatcher charMatcher) {
            Preconditions.checkState(e());
            int i2 = this.f14713b;
            this.f14713b = charMatcher.negate().indexIn(this.f14712a, i2);
            return e() ? this.f14712a.substring(i2, this.f14713b) : this.f14712a.substring(i2);
        }

        boolean e() {
            int i2 = this.f14713b;
            return i2 >= 0 && i2 < this.f14712a.length();
        }

        char f() {
            Preconditions.checkState(e());
            return this.f14712a.charAt(this.f14713b);
        }
    }
    ...
    private String computeToString() {
        ...
        if (!this.parameters.isEmpty()) {
            sb.append("; ");
            PARAMETER_JOINER.appendTo(sb, Multimaps.transformValues((ListMultimap) this.parameters, new Function() { // from class: com.google.common.net.a
    ...
    public static MediaType parse(String str) {
        ...
        try {
            ...
            while (tokenizer.e()) {
                ...
                consumeSeparator(tokenizer, com.alipay.sdk.m.n.a.f9565h);
                if ('\"' == tokenizer.f()) {
                ...
                builder.put((ImmutableListMultimap.Builder) strC4, strC);
            }
            return create(strC2, strC3, builder.build());
