...
public final class InetAddresses {
    ...
    public static final class TeredoInfo {
        ...
        public TeredoInfo(@CheckForNull Inet4Address inet4Address, @CheckForNull Inet4Address inet4Address2, int i2, int i3) {
            ...
            Preconditions.checkArgument(z2, "flags '%s' is out of range (0 <= flags <= 0xffff)", i3);
    ...
    private static InetAddress bytesToInetAddress(byte[] bArr, String str) throws SocketException, UnknownHostException {
        try {
    ...
    @CheckForNull
    private static InetAddress forUriStringOrNull(String str, boolean z2) {
        int i2;
    ...
    public static TeredoInfo getTeredoInfo(Inet6Address inet6Address) {
        ...
        int i2 = ByteStreams.newDataInput(address, 8).readShort() & UShort.MAX_VALUE;
    ...
    */
    ...
    private static short parseHextet(String str, int i2, int i3) {
        ...
        int iDigit = 0;
        while (i2 < i3) {
            iDigit = (iDigit << 4) | Character.digit(str.charAt(i2), 16);
            i2++;
        }
        return (short) iDigit;
    }
    ...
    private static byte[] textToNumericFormatV4(String str) {
        ...
        for (int i3 = 0; i3 < 4; i3++) {
            ...
            try {
                bArr[i3] = parseOctet(str, i2, iIndexOf);
                i2 = iIndexOf + 1;
            ...
            try {
                ...
                while (i2 < str.length()) {
                    ...
                    if (str.charAt(i2) == ':') {
                        ...
                        byteBufferAllocate.putShort(parseHextet(str, i2, iIndexOf));
                    }
                    i2 = iIndexOf + 1;
                }
    ...
    private static int tryParseDecimal(String str, int i2, int i3) {
        int i4 = 0;
        while (i2 < i3) {
            if (i4 > 214748364) {
                return -1;
