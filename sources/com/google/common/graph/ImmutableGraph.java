...
public class ImmutableGraph<N> extends ForwardingGraph<N> {
    ...
    private static <N> GraphConnections<N, GraphConstants.Presence> connectionsOf(Graph<N> graph, N n2) {
        ...
        return graph.isDirected() ? DirectedGraphConnections.k(n2, graph.incidentEdges(n2), functionConstant) : UndirectedGraphConnections.c(Maps.asMap(graph.adjacentNodes(n2), functionConstant));
    }
