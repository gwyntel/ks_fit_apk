...
public final class TypeAdapters {
    ...
    static {
        ...
        BOOLEAN_AS_STRING = new TypeAdapter<Boolean>() { // from class: com.google.gson.internal.bind.TypeAdapters.4
            ...
            @Override // com.google.gson.TypeAdapter
            public void write(JsonWriter jsonWriter, Boolean bool) throws IOException {
                jsonWriter.value(bool == null ? TmpConstant.GROUP_ROLE_UNKNOWN : bool.toString());
            }
        };
        ...
        TypeAdapter<URL> typeAdapter9 = new TypeAdapter<URL>() { // from class: com.google.gson.internal.bind.TypeAdapters.21
            ...
            public URL read2(JsonReader jsonReader) throws IOException {
                ...
                String strNextString = jsonReader.nextString();
                if (TmpConstant.GROUP_ROLE_UNKNOWN.equals(strNextString)) {
                    return null;
                }
        ...
        TypeAdapter<Locale> typeAdapter14 = new TypeAdapter<Locale>() { // from class: com.google.gson.internal.bind.TypeAdapters.27
            ...
            public Locale read2(JsonReader jsonReader) throws IOException {
                ...
                StringTokenizer stringTokenizer = new StringTokenizer(jsonReader.nextString(), OpenAccountUIConstants.UNDER_LINE);
