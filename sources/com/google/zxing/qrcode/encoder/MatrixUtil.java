...
final class MatrixUtil {
    ...
    static void a(BitArray bitArray, ErrorCorrectionLevel errorCorrectionLevel, Version version, int i2, ByteMatrix byteMatrix) throws WriterException {
        ...
        f(errorCorrectionLevel, i2, byteMatrix);
        j(version, byteMatrix);
        e(bitArray, i2, byteMatrix);
    }
    ...
    static void e(BitArray bitArray, int i2, ByteMatrix byteMatrix) throws WriterException {
        boolean z2;
            ...
            while (height >= 0 && height < byteMatrix.getHeight()) {
                for (int i5 = 0; i5 < 2; i5++) {
                    ...
                    if (isEmpty(byteMatrix.get(i6, height))) {
                        ...
                        if (i2 != -1 && MaskUtil.e(i2, i6, height)) {
                            z2 = !z2;
                        }
    ...
    static void f(ErrorCorrectionLevel errorCorrectionLevel, int i2, ByteMatrix byteMatrix) throws WriterException {
        BitArray bitArray = new BitArray();
        h(errorCorrectionLevel, i2, bitArray);
    ...
    static void h(ErrorCorrectionLevel errorCorrectionLevel, int i2, BitArray bitArray) throws WriterException {
        if (!QRCode.isValidMaskPattern(i2)) {
            throw new WriterException("Invalid mask pattern");
        }
        int bits = (errorCorrectionLevel.getBits() << 3) | i2;
        bitArray.appendBits(bits, 5);
        bitArray.appendBits(b(bits, TYPE_INFO_POLY), 10);
    ...
    static void i(Version version, BitArray bitArray) throws WriterException {
        bitArray.appendBits(version.getVersionNumber(), 6);
        bitArray.appendBits(b(version.getVersionNumber(), VERSION_INFO_POLY), 12);
    ...
    static void j(Version version, ByteMatrix byteMatrix) throws WriterException {
