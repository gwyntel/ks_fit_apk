...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{481}, "BY");
            add(new int[]{482}, "UA");
            add(new int[]{BuildConfig.VERSION_CODE}, "MD");
            add(new int[]{485}, "AM");
            add(new int[]{486}, "GE");
            add(new int[]{487}, "KZ");
            add(new int[]{489}, "HK");
            ...
            add(new int[]{DeviceCommonConstants.WHAT_DHCP_TIMEOUT}, "GR");
            ...
            add(new int[]{590}, "PL");
            add(new int[]{594}, SdkConstant.CLOUDAPI_COMMAND_REGISTER_SUCCESS_RESPONSE);
            add(new int[]{599}, "HU");
            ...
            add(new int[]{TypedValues.TransitionType.TYPE_DURATION, 709}, SdkConstant.CLOUDAPI_COMMAND_NOTIFY_RESPONSE);
            add(new int[]{729}, "IL");
            ...
            add(new int[]{742}, "HN");
            add(new int[]{743}, "NI");
            add(new int[]{744}, SdkConstant.CLOUDAPI_COMMAND_CONNECTION_RUNS_OUT);
            add(new int[]{745}, "PA");
            add(new int[]{746}, "DO");
            add(new int[]{750}, "MX");
