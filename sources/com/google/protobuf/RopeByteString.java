...
final class RopeByteString extends ByteString {
    ...
    public Iterator<Byte> iterator2() {
        return new ByteString.AbstractByteIterator() { // from class: com.google.protobuf.RopeByteString.1
            ...
            final PieceIterator f15316a;

            /* renamed from: b, reason: collision with root package name */
            ByteString.ByteIterator f15317b = nextPiece();

            {
                this.f15316a = new PieceIterator(RopeByteString.this);
            }

            /* JADX WARN: Type inference failed for: r0v5, types: [com.google.protobuf.ByteString$ByteIterator] */
            private ByteString.ByteIterator nextPiece() {
                if (this.f15316a.hasNext()) {
                    return this.f15316a.next().iterator2();
                }
                return null;
            }
            ...
            @Override // java.util.Iterator
            public boolean hasNext() {
                return this.f15317b != null;
            }

            @Override // com.google.protobuf.ByteString.ByteIterator
            public byte nextByte() {
                ByteString.ByteIterator byteIterator = this.f15317b;
                if (byteIterator == null) {
                    throw new NoSuchElementException();
                }
                byte bNextByte = byteIterator.nextByte();
                if (!this.f15317b.hasNext()) {
                    this.f15317b = nextPiece();
                }
                return bNextByte;
            }
        };
