...
public final class FieldType {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f15233b[JavaType.MESSAGE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f15233b[JavaType.STRING.ordinal()] = 3;
            ...
            try {
                f15232a[Collection.VECTOR.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f15232a[Collection.SCALAR.ordinal()] = 3;
    ...
    private FieldType(String str, int i2, int i3, Collection collection, JavaType javaType) {
        ...
        int i5 = AnonymousClass1.f15232a[collection.ordinal()];
        if (i5 == 1 || i5 == 2) {
            this.elementType = javaType.getBoxedType();
        } else {
            this.elementType = null;
        }
        this.primitiveScalar = (collection != Collection.SCALAR || (i4 = AnonymousClass1.f15233b[javaType.ordinal()]) == 1 || i4 == 2 || i4 == 3) ? false : true;
    }
