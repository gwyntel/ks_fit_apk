...
public abstract class CodedInputStream {
    ...
    CodedInputStreamReader f15187d;
    ...
    private static final class ArrayDecoder extends CodedInputStream {
        ...
        public String readString() throws IOException {
            ...
            if (rawVarint32 > 0) {
                ...
                int i3 = this.pos;
                if (rawVarint32 <= i2 - i3) {
                    String str = new String(this.buffer, i3, rawVarint32, Internal.f15296b);
                    this.pos += rawVarint32;
                    return str;
                }
            }
        ...
        public boolean skipField(int i2, CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (tagWireType == 3) {
                ...
                checkLastTagWas(iA);
                codedOutputStream.writeUInt32NoTag(iA);
                return true;
            }
            if (tagWireType == 4) {
                return false;
    ...
    private static final class IterableDirectByteBufferDecoder extends CodedInputStream {
        ...
        private void readRawBytesTo(byte[] bArr, int i2, int i3) throws IOException {
            ...
            while (i4 > 0) {
                ...
                long j2 = iMin;
                UnsafeUtil.m(this.currentByteBufferPos, bArr, (i3 - i4) + i2, j2);
                i4 -= iMin;
        ...
        private void tryGetNextByteBuffer() {
            ...
            long jK = UnsafeUtil.k(this.currentByteBuffer);
            this.currentAddress = jK;
            this.currentByteBufferPos += jK;
            this.currentByteBufferStartPos += jK;
            this.currentByteBufferLimit += jK;
        }
            ...
            if (rawVarint32 > 0) {
                ...
                if (j2 <= currentRemaining()) {
                    if (this.immutable || !this.enableAliasing) {
                        ...
                        UnsafeUtil.m(this.currentByteBufferPos, bArr, 0L, j2);
                        this.currentByteBufferPos += j2;
        ...
        public int readRawLittleEndian32() throws IOException {
            ...
            return ((UnsafeUtil.q(j2 + 3) & 255) << 24) | (UnsafeUtil.q(j2) & 255) | ((UnsafeUtil.q(1 + j2) & 255) << 8) | ((UnsafeUtil.q(2 + j2) & 255) << 16);
        }
        ...
        public long readRawLittleEndian64() throws IOException {
            ...
            if (currentRemaining() >= 8) {
                ...
                rawByte = (UnsafeUtil.q(j2) & 255) | ((UnsafeUtil.q(1 + j2) & 255) << 8) | ((UnsafeUtil.q(2 + j2) & 255) << 16) | ((UnsafeUtil.q(3 + j2) & 255) << 24) | ((UnsafeUtil.q(4 + j2) & 255) << 32) | ((UnsafeUtil.q(5 + j2) & 255) << 40) | ((UnsafeUtil.q(6 + j2) & 255) << 48);
                rawByte2 = UnsafeUtil.q(j2 + 7);
            } else {
        ...
        public int readRawVarint32() throws IOException {
            ...
            if (this.currentByteBufferLimit != j2) {
                ...
                if (this.currentByteBufferLimit - this.currentByteBufferPos >= 10) {
                    long j4 = 2 + j2;
                    int iQ = (UnsafeUtil.q(j3) << 7) ^ bQ;
                    if (iQ < 0) {
                        i2 = iQ ^ (-128);
                    } else {
                        long j5 = 3 + j2;
                        int iQ2 = (UnsafeUtil.q(j4) << 14) ^ iQ;
                        if (iQ2 >= 0) {
                            i2 = iQ2 ^ 16256;
                        } else {
                            long j6 = 4 + j2;
                            int iQ3 = iQ2 ^ (UnsafeUtil.q(j5) << Ascii.NAK);
                            if (iQ3 < 0) {
                                i2 = (-2080896) ^ iQ3;
                            } else {
                                j5 = 5 + j2;
                                byte bQ2 = UnsafeUtil.q(j6);
                                int i3 = (iQ3 ^ (bQ2 << Ascii.FS)) ^ 266354560;
                                if (bQ2 < 0) {
                                    j6 = 6 + j2;
                                    if (UnsafeUtil.q(j5) < 0) {
                                        j5 = 7 + j2;
                                        if (UnsafeUtil.q(j6) < 0) {
                                            j6 = 8 + j2;
                                            if (UnsafeUtil.q(j5) < 0) {
                                                j5 = 9 + j2;
                                                if (UnsafeUtil.q(j6) < 0) {
        ...
        public long readRawVarint64() throws IOException {
            ...
            if (this.currentByteBufferLimit != j5) {
                ...
                if (this.currentByteBufferLimit - this.currentByteBufferPos >= 10) {
                    long j7 = 2 + j5;
                    int iQ = (UnsafeUtil.q(j6) << 7) ^ bQ;
                    if (iQ < 0) {
                        j2 = iQ ^ (-128);
                    } else {
                        long j8 = 3 + j5;
                        int iQ2 = (UnsafeUtil.q(j7) << 14) ^ iQ;
                        if (iQ2 >= 0) {
                            j2 = iQ2 ^ 16256;
                            j7 = j8;
                        } else {
                            long j9 = 4 + j5;
                            int iQ3 = iQ2 ^ (UnsafeUtil.q(j8) << Ascii.NAK);
                            if (iQ3 < 0) {
                                j2 = (-2080896) ^ iQ3;
                                j7 = j9;
                            } else {
                                long j10 = 5 + j5;
                                long jQ = (UnsafeUtil.q(j9) << 28) ^ iQ3;
                                if (jQ >= 0) {
                                    j4 = 266354560;
                                } else {
                                    long j11 = 6 + j5;
                                    long jQ2 = jQ ^ (UnsafeUtil.q(j10) << 35);
                                    if (jQ2 < 0) {
                                        j3 = -34093383808L;
                                    } else {
                                        j10 = 7 + j5;
                                        jQ = jQ2 ^ (UnsafeUtil.q(j11) << 42);
                                        if (jQ >= 0) {
                                            j4 = 4363953127296L;
                                        } else {
                                            j11 = 8 + j5;
                                            jQ2 = jQ ^ (UnsafeUtil.q(j10) << 49);
                                            if (jQ2 < 0) {
                                                j3 = -558586000294016L;
                                            } else {
                                                j10 = 9 + j5;
                                                long jQ3 = (jQ2 ^ (UnsafeUtil.q(j11) << 56)) ^ 71499008037633920L;
                                                if (jQ3 < 0) {
                                                    long j12 = j5 + 10;
                                                    if (UnsafeUtil.q(j10) >= 0) {
                                                        j2 = jQ3;
                                                        j7 = j12;
                                                    }
                                                } else {
        ...
        public String readString() throws IOException {
            ...
            if (rawVarint32 > 0) {
                ...
                if (j2 <= j3 - j4) {
                    byte[] bArr = new byte[rawVarint32];
                    UnsafeUtil.m(j4, bArr, 0L, j2);
                    String str = new String(bArr, Internal.f15296b);
                    this.currentByteBufferPos += j2;
                    return str;
                }
            }
            if (rawVarint32 > 0 && rawVarint32 <= remaining()) {
                byte[] bArr2 = new byte[rawVarint32];
                readRawBytesTo(bArr2, 0, rawVarint32);
                return new String(bArr2, Internal.f15296b);
            }
            if (rawVarint32 == 0) {
                return "";
            }
    ...
    private static final class StreamDecoder extends CodedInputStream {
        ...
        private void refillBuffer(int i2) throws IOException {
            ...
            if (i2 <= (this.f15186c - this.totalBytesRetired) - this.pos) {
                throw InvalidProtocolBufferException.truncatedMessage();
            }
            throw InvalidProtocolBufferException.sizeLimitExceeded();
        }
        ...
        private boolean tryRefillBuffer(int i2) throws IOException {
            ...
            int i9 = read(inputStream, bArr2, i8, Math.min(bArr2.length - i8, (this.f15186c - this.totalBytesRetired) - i8));
        ...
        public String readString() throws IOException {
            ...
            if (rawVarint32 > this.bufferSize) {
                return new String(readRawBytesSlowPath(rawVarint32, false), Internal.f15296b);
            }
            refillBuffer(rawVarint32);
            String str2 = new String(this.buffer, this.pos, rawVarint32, Internal.f15296b);
            this.pos += rawVarint32;
            return str2;
        }
    ...
    private static final class UnsafeDirectNioDecoder extends CodedInputStream {
        ...
        public ByteBuffer readByteBuffer() throws IOException {
            ...
            if (this.immutable || !this.enableAliasing) {
                byte[] bArr = new byte[rawVarint32];
                long j2 = rawVarint32;
                UnsafeUtil.m(this.pos, bArr, 0L, j2);
                this.pos += j2;
                return ByteBuffer.wrap(bArr);
            }
            long j3 = this.pos;
        ...
        public ByteString readBytes() throws IOException {
            ...
            byte[] bArr = new byte[rawVarint32];
            long j4 = rawVarint32;
            UnsafeUtil.m(this.pos, bArr, 0L, j4);
            this.pos += j4;
            return ByteString.wrap(bArr);
        }
        ...
        public long readRawLittleEndian64() throws IOException {
            ...
            this.pos = 8 + j2;
            return ((UnsafeUtil.q(j2 + 7) & 255) << 56) | (UnsafeUtil.q(j2) & 255) | ((UnsafeUtil.q(1 + j2) & 255) << 8) | ((UnsafeUtil.q(2 + j2) & 255) << 16) | ((UnsafeUtil.q(3 + j2) & 255) << 24) | ((UnsafeUtil.q(4 + j2) & 255) << 32) | ((UnsafeUtil.q(5 + j2) & 255) << 40) | ((UnsafeUtil.q(6 + j2) & 255) << 48);
        }

        /* JADX WARN: Code restructure failed: missing block: B:33:0x008c, code lost:
        
            if (com.google.protobuf.UnsafeUtil.q(r3) < 0) goto L34;
         */
        @Override // com.google.protobuf.CodedInputStream
        /*
        ...
        */
        public int readRawVarint32() throws java.io.IOException {
            ...
            La:
                r2 = 1
                long r2 = r2 + r0
                byte r4 = com.google.protobuf.UnsafeUtil.q(r0)
                if (r4 < 0) goto L16
                r9.pos = r2
                return r4
            L16:
            ...
            L21:
                r5 = 2
                long r5 = r5 + r0
                byte r2 = com.google.protobuf.UnsafeUtil.q(r2)
                int r2 = r2 << 7
                r2 = r2 ^ r4
                if (r2 >= 0) goto L31
            ...
            L31:
                r3 = 3
                long r3 = r3 + r0
                byte r5 = com.google.protobuf.UnsafeUtil.q(r5)
                int r5 = r5 << 14
                r2 = r2 ^ r5
                if (r2 < 0) goto L41
            ...
            L41:
                r5 = 4
                long r5 = r5 + r0
                byte r3 = com.google.protobuf.UnsafeUtil.q(r3)
                int r3 = r3 << 21
                r2 = r2 ^ r3
                if (r2 >= 0) goto L52
            ...
            L52:
                ...
                r5 = 10
                long r5 = r5 + r0
                byte r0 = com.google.protobuf.UnsafeUtil.q(r3)
                if (r0 >= 0) goto L94
            L8e:
                long r0 = r9.h()
                int r0 = (int) r0
                    ...
                    if (iQ >= 0) {
                        ...
                        if (iQ2 >= 0) {
                            ...
                            if (iQ3 < 0) {
                                ...
                                long j9 = 5 + j5;
                                long jQ = iQ3 ^ (UnsafeUtil.q(j7) << 28);
                                if (jQ >= 0) {
                                    j4 = 266354560;
                                } else {
                                    long j10 = 6 + j5;
                                    long jQ2 = jQ ^ (UnsafeUtil.q(j9) << 35);
                                    if (jQ2 < 0) {
                                        j3 = -34093383808L;
                                    } else {
                                        j9 = 7 + j5;
                                        jQ = jQ2 ^ (UnsafeUtil.q(j10) << 42);
                                        if (jQ >= 0) {
                                            j4 = 4363953127296L;
                                        } else {
                                            j10 = 8 + j5;
                                            jQ2 = jQ ^ (UnsafeUtil.q(j9) << 49);
                                            if (jQ2 < 0) {
                                                j3 = -558586000294016L;
                                            } else {
                                                long j11 = j5 + 9;
                                                long jQ3 = (jQ2 ^ (UnsafeUtil.q(j10) << 56)) ^ 71499008037633920L;
                                                if (jQ3 < 0) {
                                                    long j12 = j5 + 10;
                                                    if (UnsafeUtil.q(j11) >= 0) {
                                                        j7 = j12;
                                                        j2 = jQ3;
                                                    }
                                                } else {
        ...
        private UnsafeDirectNioDecoder(ByteBuffer byteBuffer, boolean z2) {
            ...
            this.address = jK;
            this.limit = byteBuffer.limit() + jK;
    ...
    static CodedInputStream b(Iterable iterable, boolean z2) {
    ...
    static CodedInputStream c(ByteBuffer byteBuffer, boolean z2) {
        if (byteBuffer.hasArray()) {
            return d(byteBuffer.array(), byteBuffer.arrayOffset() + byteBuffer.position(), byteBuffer.remaining(), z2);
        }
        if (byteBuffer.isDirect() && UnsafeDirectNioDecoder.g()) {
            return new UnsafeDirectNioDecoder(byteBuffer, z2);
        }
        int iRemaining = byteBuffer.remaining();
        byte[] bArr = new byte[iRemaining];
        byteBuffer.duplicate().get(bArr);
        return d(bArr, 0, iRemaining, true);
    }

    static CodedInputStream d(byte[] bArr, int i2, int i3, boolean z2) {
    ...
    private CodedInputStream() {
        this.f15185b = defaultRecursionLimit;
