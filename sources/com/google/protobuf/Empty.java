...
public final class Empty extends GeneratedMessageV3 implements EmptyOrBuilder {
    ...
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return EmptyProto.f15218b.ensureFieldAccessorsInitialized(Empty.class, Builder.class);
    }
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements EmptyOrBuilder {
        ...
        public Empty build() {
            ...
            throw AbstractMessage.Builder.f(emptyBuildPartial);
        }
            ...
            while (!z2) {
                try {
                    try {
                        ...
                        if (tag == 0 || !super.q(codedInputStream, extensionRegistryLite, tag)) {
                            z2 = true;
                        }
                    } catch (InvalidProtocolBufferException e2) {
