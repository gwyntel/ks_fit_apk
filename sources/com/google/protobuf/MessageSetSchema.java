...
final class MessageSetSchema<T> implements Schema<T> {
    ...
    private MessageSetSchema(UnknownFieldSchema<?, ?> unknownFieldSchema, ExtensionSchema<?> extensionSchema, MessageLite messageLite) {
        ...
        this.hasExtensions = extensionSchema.d(messageLite);
    ...
    private <UT, UB, ET extends FieldSet.FieldDescriptorLite<ET>> void mergeFromHelper(UnknownFieldSchema<UT, UB> unknownFieldSchema, ExtensionSchema<ET> extensionSchema, T t2, Reader reader, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        ...
        FieldSet<ET> fieldSetC = extensionSchema.c(t2);
        while (reader.getFieldNumber() != Integer.MAX_VALUE) {
            try {
                if (!parseMessageSetItemOrUnknownField(reader, extensionRegistryLite, extensionSchema, fieldSetC, unknownFieldSchema, objF)) {
                    return;
                }
            } finally {
    ...
    private <UT, UB, ET extends FieldSet.FieldDescriptorLite<ET>> boolean parseMessageSetItemOrUnknownField(Reader reader, ExtensionRegistryLite extensionRegistryLite, ExtensionSchema<ET> extensionSchema, FieldSet<ET> fieldSet, UnknownFieldSchema<UT, UB> unknownFieldSchema, UB ub) throws IOException {
        ...
        if (tag != WireFormat.f15368a) {
            ...
            extensionSchema.g(reader, objB, extensionRegistryLite, fieldSet);
            return true;
        }
        Object objB2 = null;
        int uInt32 = 0;
        ...
        while (reader.getFieldNumber() != Integer.MAX_VALUE) {
            ...
            if (tag2 == WireFormat.f15370c) {
                uInt32 = reader.readUInt32();
                objB2 = extensionSchema.b(extensionRegistryLite, this.defaultInstance, uInt32);
            } else if (tag2 == WireFormat.f15371d) {
                if (objB2 != null) {
                    extensionSchema.g(reader, objB2, extensionRegistryLite, fieldSet);
                } else {
        ...
        if (reader.getTag() != WireFormat.f15369b) {
            throw InvalidProtocolBufferException.invalidEndTag();
        }
        if (bytes != null) {
            if (objB2 != null) {
                extensionSchema.h(bytes, objB2, extensionRegistryLite, fieldSet);
            } else {
    ...
    */
    public void mergeFrom(T r11, byte[] r12, int r13, int r14, com.google.protobuf.ArrayDecoders.Registers r15) throws java.io.IOException {
        ...
        L11:
            ...
            com.google.protobuf.FieldSet r11 = r11.a()
            r0 = 0
            r2 = r0
        L19:
            if (r13 >= r14) goto Ld7
            ...
            int r13 = r15.int1
            int r3 = com.google.protobuf.WireFormat.f15368a
            r5 = 2
            if (r13 == r3) goto L6b
            ...
            com.google.protobuf.GeneratedMessageLite$ExtensionDescriptor r2 = r8.f15282d
        ...
        L83:
            ...
            com.google.protobuf.GeneratedMessageLite$ExtensionDescriptor r6 = r2.f15282d
        ...
        Lac:
            ...
            goto L6d
        Lc1:
            int r7 = com.google.protobuf.WireFormat.f15369b
            if (r6 != r7) goto Lc6
            goto Lcb
        Lc6:
            int r4 = com.google.protobuf.ArrayDecoders.P(r6, r12, r4, r14, r15)
