...
public final class Timestamps {
    ...
    public static Timestamp add(Timestamp timestamp, Duration duration) {
        ...
        return c(LongMath.checkedAdd(timestamp.getSeconds(), duration.getSeconds()), IntMath.checkedAdd(timestamp.getNanos(), duration.getNanos()));
    }
    ...
    public static Duration between(Timestamp timestamp, Timestamp timestamp2) {
        ...
        return Durations.a(LongMath.checkedSubtract(timestamp2.getSeconds(), timestamp.getSeconds()), IntMath.checkedSubtract(timestamp2.getNanos(), timestamp.getNanos()));
    }

    static Timestamp c(long j2, int i2) {
        ...
        return checkValid(Timestamp.newBuilder().setSeconds(j2).setNanos(i2).build());
    }
    ...
    static int d(String str) throws ParseException {
        int iCharAt = 0;
    ...
    public static Timestamp fromMicros(long j2) {
        return c(j2 / 1000000, (int) ((j2 % 1000000) * 1000));
    }
    ...
    public static Timestamp fromNanos(long j2) {
        return c(j2 / C.NANOS_PER_SECOND, (int) (j2 % C.NANOS_PER_SECOND));
    }

    public static Timestamp fromSeconds(long j2) {
        return c(j2, 0);
    }

    public static boolean isValid(long j2, int i2) {
        return j2 >= -62135596800L && j2 <= 253402300799L && i2 >= 0 && i2 < 1000000000;
    }
    ...
    public static Timestamp subtract(Timestamp timestamp, Duration duration) {
        checkValid(timestamp);
        Durations.checkValid(duration);
        return c(LongMath.checkedSubtract(timestamp.getSeconds(), duration.getSeconds()), IntMath.checkedSubtract(timestamp.getNanos(), duration.getNanos()));
    }
    ...
    public static long toNanos(Timestamp timestamp) {
        checkValid(timestamp);
        return LongMath.checkedAdd(LongMath.checkedMultiply(timestamp.getSeconds(), C.NANOS_PER_SECOND), timestamp.getNanos());
    }
