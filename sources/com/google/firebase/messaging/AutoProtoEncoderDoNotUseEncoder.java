...
public final class AutoProtoEncoderDoNotUseEncoder implements Configurator {
    ...
    private static final class MessagingClientEventEncoder implements ObjectEncoder<MessagingClientEvent> {
        ...
        static final MessagingClientEventEncoder f15096a = new MessagingClientEventEncoder();
        ...
        private static final FieldDescriptor MESSAGEID_DESCRIPTOR = FieldDescriptor.builder(TmpConstant.RRESPONSE_MESSAGEID).withProperty(AtProtobuf.builder().tag(2).build()).build();
        ...
        private static final FieldDescriptor PRIORITY_DESCRIPTOR = FieldDescriptor.builder(RemoteMessageConst.Notification.PRIORITY).withProperty(AtProtobuf.builder().tag(8).build()).build();
    ...
    private static final class MessagingClientEventExtensionEncoder implements ObjectEncoder<MessagingClientEventExtension> {
        ...
        /* renamed from: a, reason: collision with root package name */
        static final MessagingClientEventExtensionEncoder f15097a = new MessagingClientEventExtensionEncoder();
    ...
    private static final class ProtoEncoderDoNotUseEncoder implements ObjectEncoder<ProtoEncoderDoNotUse> {
        ...
        /* renamed from: a, reason: collision with root package name */
        static final ProtoEncoderDoNotUseEncoder f15098a = new ProtoEncoderDoNotUseEncoder();
    ...
    public void configure(EncoderConfig<?> encoderConfig) {
        encoderConfig.registerEncoder(ProtoEncoderDoNotUse.class, ProtoEncoderDoNotUseEncoder.f15098a);
        encoderConfig.registerEncoder(MessagingClientEventExtension.class, MessagingClientEventExtensionEncoder.f15097a);
        encoderConfig.registerEncoder(MessagingClientEvent.class, MessagingClientEventEncoder.f15096a);
    }
}
