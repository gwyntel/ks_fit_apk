...
public final class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    public static Snackbar make(@NonNull View view, @NonNull CharSequence charSequence, int i2) {
        ...
        SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(viewGroupFindSuitableParent.getContext()).inflate(m(viewGroupFindSuitableParent.getContext()) ? R.layout.mtrl_layout_snackbar_include : R.layout.design_layout_snackbar_include, viewGroupFindSuitableParent, false);
    ...
    public Snackbar setActionTextColor(ColorStateList colorStateList) {
        ((SnackbarContentLayout) this.f13534a.getChildAt(0)).getActionView().setTextColor(colorStateList);
        return this;
    }
    ...
    public Snackbar setText(@NonNull CharSequence charSequence) {
        ((SnackbarContentLayout) this.f13534a.getChildAt(0)).getMessageView().setText(charSequence);
        return this;
    }
    ...
    public Snackbar setAction(CharSequence charSequence, final View.OnClickListener onClickListener) {
        Button actionView = ((SnackbarContentLayout) this.f13534a.getChildAt(0)).getActionView();
    ...
    public Snackbar setActionTextColor(@ColorInt int i2) {
        ((SnackbarContentLayout) this.f13534a.getChildAt(0)).getActionView().setTextColor(i2);
        return this;
    }
