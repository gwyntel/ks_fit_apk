...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private void createTranslationAnimation(View view, View view2, boolean z2, boolean z3, FabTransformationSpec fabTransformationSpec, List<Animator> list, List<Animator.AnimatorListener> list2, RectF rectF) {
        ...
        } else if ((!z2 || fCalculateTranslationY >= 0.0f) && (z2 || fCalculateTranslationY <= 0.0f)) {
    ...
    protected AnimatorSet e(final View view, final View view2, final boolean z2, boolean z3) {
        FabTransformationSpec fabTransformationSpecF = f(view2.getContext(), z2);
        ArrayList arrayList = new ArrayList();
        ArrayList arrayList2 = new ArrayList();
        createElevationAnimation(view, view2, z2, z3, fabTransformationSpecF, arrayList, arrayList2);
        RectF rectF = this.tmpRectF1;
        createTranslationAnimation(view, view2, z2, z3, fabTransformationSpecF, arrayList, arrayList2, rectF);
        float fWidth = rectF.width();
        float fHeight = rectF.height();
        createIconFadeAnimation(view, view2, z2, z3, fabTransformationSpecF, arrayList, arrayList2);
        createExpansionAnimation(view, view2, z2, z3, fabTransformationSpecF, fWidth, fHeight, arrayList, arrayList2);
        createColorAnimation(view, view2, z2, z3, fabTransformationSpecF, arrayList, arrayList2);
        createChildrenFadeAnimation(view, view2, z2, z3, fabTransformationSpecF, arrayList, arrayList2);
    ...
    protected abstract FabTransformationSpec f(Context context, boolean z2);
