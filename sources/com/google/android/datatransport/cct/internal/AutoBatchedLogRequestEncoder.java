...
public final class AutoBatchedLogRequestEncoder implements Configurator {
    ...
    private static final class AndroidClientInfoEncoder implements ObjectEncoder<AndroidClientInfo> {
        ...
        static final AndroidClientInfoEncoder f12515a = new AndroidClientInfoEncoder();
    ...
    private static final class BatchedLogRequestEncoder implements ObjectEncoder<BatchedLogRequest> {
        ...
        /* renamed from: a, reason: collision with root package name */
        static final BatchedLogRequestEncoder f12516a = new BatchedLogRequestEncoder();
    ...
    private static final class ClientInfoEncoder implements ObjectEncoder<ClientInfo> {
        ...
        /* renamed from: a, reason: collision with root package name */
        static final ClientInfoEncoder f12517a = new ClientInfoEncoder();
    ...
    private static final class LogEventEncoder implements ObjectEncoder<LogEvent> {
        ...
        /* renamed from: a, reason: collision with root package name */
        static final LogEventEncoder f12518a = new LogEventEncoder();
    ...
    private static final class LogRequestEncoder implements ObjectEncoder<LogRequest> {
        ...
        /* renamed from: a, reason: collision with root package name */
        static final LogRequestEncoder f12519a = new LogRequestEncoder();
    ...
    private static final class NetworkConnectionInfoEncoder implements ObjectEncoder<NetworkConnectionInfo> {
        ...
        /* renamed from: a, reason: collision with root package name */
        static final NetworkConnectionInfoEncoder f12520a = new NetworkConnectionInfoEncoder();
    ...
    public void configure(EncoderConfig<?> encoderConfig) {
        BatchedLogRequestEncoder batchedLogRequestEncoder = BatchedLogRequestEncoder.f12516a;
        ...
        LogRequestEncoder logRequestEncoder = LogRequestEncoder.f12519a;
        ...
        ClientInfoEncoder clientInfoEncoder = ClientInfoEncoder.f12517a;
        ...
        AndroidClientInfoEncoder androidClientInfoEncoder = AndroidClientInfoEncoder.f12515a;
        ...
        LogEventEncoder logEventEncoder = LogEventEncoder.f12518a;
        ...
        NetworkConnectionInfoEncoder networkConnectionInfoEncoder = NetworkConnectionInfoEncoder.f12520a;
