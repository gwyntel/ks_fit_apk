...
public final class zak extends Drawable implements Drawable.Callback {
    ...
    public zak(@Nullable Drawable drawable, @Nullable Drawable drawable2) {
        ...
        zaj zajVar = this.zai;
        zajVar.f13035b = drawable.getChangingConfigurations() | zajVar.f13035b;
        drawable2 = drawable2 == null ? zai.zaa : drawable2;
        this.zak = drawable2;
        drawable2.setCallback(this);
        zaj zajVar2 = this.zai;
        zajVar2.f13035b = drawable2.getChangingConfigurations() | zajVar2.f13035b;
    }
    ...
    */
    ...
    public final int getChangingConfigurations() {
        ...
        zaj zajVar = this.zai;
        return changingConfigurations | zajVar.f13034a | zajVar.f13035b;
    }
    ...
    public final Drawable.ConstantState getConstantState() {
        ...
        this.zai.f13034a = getChangingConfigurations();
        return this.zai;
    }
