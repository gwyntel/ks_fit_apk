...
public final class zzbe extends GmsClient {
    ...
    public final boolean requiresSignIn() {
        ClientSettings clientSettingsB = B();
        return (TextUtils.isEmpty(clientSettingsB.getAccountName()) || clientSettingsB.getApplicableScopes(AuthProxy.API).isEmpty()) ? false : true;
    }
