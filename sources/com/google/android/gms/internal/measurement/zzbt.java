...
public final class zzbt extends zzay {
    protected zzbt() {
        this.f13178a.add(zzbv.ASSIGN);
        this.f13178a.add(zzbv.CONST);
        this.f13178a.add(zzbv.CREATE_ARRAY);
        this.f13178a.add(zzbv.CREATE_OBJECT);
        this.f13178a.add(zzbv.EXPRESSION_LIST);
        this.f13178a.add(zzbv.GET);
        this.f13178a.add(zzbv.GET_INDEX);
        this.f13178a.add(zzbv.GET_PROPERTY);
        this.f13178a.add(zzbv.NULL);
        this.f13178a.add(zzbv.SET_PROPERTY);
        this.f13178a.add(zzbv.TYPEOF);
        this.f13178a.add(zzbv.UNDEFINED);
        this.f13178a.add(zzbv.VAR);
    }
    ...
    public final zzaq zza(String str, zzh zzhVar, List<zzaq> list) {
        String str2;
        int i2 = 0;
        switch (zzbs.f13186a[zzg.zza(str).ordinal()]) {
            case 1:
            ...
            case 2:
                ...
                for (int i3 = 0; i3 < list.size() - 1; i3 += 2) {
                    ...
                    zzhVar.zzb(zzaqVarZza3.zzf(), zzhVar.zza(list.get(i3 + 1)));
                }
                return zzaq.zzc;
            case 3:
                if (list.isEmpty()) {
