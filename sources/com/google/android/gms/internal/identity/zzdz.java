        ...
        synchronized (this.zzh) {
            try {
                ...
                if (zzdqVar == null) {
                    ...
                    zzdqVar.b(listenerHolder);
                }
                ((zzv) getService()).zzF(new zzj(1, new zzh(deviceOrientationRequest, zzh.f13167d, null), zzdqVar, new zzdn(null, taskCompletionSource)));
            } catch (Throwable th) {
                throw th;
            }
        }
