...
public class WorkSourceUtil {
    ...
    static {
        ...
        Method method8;
        try {
            method = WorkSource.class.getMethod(TmpConstant.GROUP_OP_ADD, Integer.TYPE);
        ...
        if (PlatformVersion.isAtLeastJellyBeanMR2()) {
            try {
                method2 = WorkSource.class.getMethod(TmpConstant.GROUP_OP_ADD, Integer.TYPE, String.class);
        ...
        zzd = method3;
        try {
            method4 = WorkSource.class.getMethod(TmpConstant.PROPERTY_IDENTIFIER_GET, Integer.TYPE);
    ...
    @KeepForSdk
    public static void add(@NonNull WorkSource workSource, int i2, @NonNull String str) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        Method method = zzc;
        if (method != null) {
            if (str == null) {
                str = "";
    ...
    @KeepForSdk
    public static int get(@NonNull WorkSource workSource, int i2) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        Method method = zze;
        if (method != null) {
            try {
