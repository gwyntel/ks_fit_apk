...
final class zzs extends GmsClientSupervisor {
    ...
    protected final void a(zzo zzoVar, ServiceConnection serviceConnection, String str) {
    ...
    @Override // com.google.android.gms.common.internal.GmsClientSupervisor
    protected final boolean b(zzo zzoVar, ServiceConnection serviceConnection, String str, Executor executor) {
        boolean zZzj;
        Preconditions.checkNotNull(serviceConnection, "ServiceConnection must not be null");
        synchronized (this.zzb) {
            try {
