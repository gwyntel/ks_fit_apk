...
public final class zak implements Handler.Callback {
    ...
    final ArrayList f12839a = new ArrayList();
    ...
    public final void zad(@Nullable Bundle bundle) {
        ...
        synchronized (this.zai) {
            try {
                ...
                this.zah.removeMessages(1);
                this.zag = true;
                Preconditions.checkState(this.f12839a.isEmpty());
                ...
                while (it.hasNext()) {
                    ...
                    if (!this.zae || !this.zab.isConnected() || this.zaf.get() != i2) {
                        break;
                    } else if (!this.f12839a.contains(connectionCallbacks)) {
        ...
        synchronized (this.zai) {
            try {
                if (!this.zac.remove(connectionCallbacks)) {
                    ...
                    this.f12839a.add(connectionCallbacks);
                }
            } catch (Throwable th) {
                throw th;
            }
