    ...
    public final void onClick(DialogInterface dialogInterface, int i2) {
        try {
            try {
                ...
                Log.e("DialogRedirect", true == Build.FINGERPRINT.contains(MessengerShareContentUtility.TEMPLATE_GENERIC_TYPE) ? "Failed to start resolution intent. This may occur when resolving Google Play services connection issues on emulators with Google APIs but not Google Play Store." : "Failed to start resolution intent.", e2);
            }
        } finally {
