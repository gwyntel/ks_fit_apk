...
public class FastParser<T extends FastJsonResponse> {
    ...
    */
    ...
    public final int zal(BufferedReader bufferedReader) throws ParseException, IOException {
        ...
        char c2 = cArr[0];
        int i4 = c2 == '-' ? Integer.MIN_VALUE : C.RATE_UNSET_INT;
        int i5 = c2 == '-' ? 1 : 0;
        if (i5 < iZam) {
            i3 = i5 + 1;
    ...
    public final long zan(BufferedReader bufferedReader) throws ParseException, IOException {
        ...
        char c2 = cArr[0];
        long j3 = c2 == '-' ? Long.MIN_VALUE : C.TIME_UNSET;
        int i3 = c2 == '-' ? 1 : 0;
        if (i3 < iZam) {
            i2 = i3 + 1;
    ...
    */
    ...
    @KeepForSdk
    public void parse(@NonNull InputStream inputStream, @NonNull T t2) throws ParseException, IOException {
        ...
        try {
            try {
                ...
                if (cZai == '[') {
                    ...
                    t2.addConcreteTypeArrayInternal(value, value.f12884e, zav(bufferedReader, value));
                } else {
                    if (cZai != '{') {
                        throw new ParseException("Unexpected token: " + cZai);
                    }
