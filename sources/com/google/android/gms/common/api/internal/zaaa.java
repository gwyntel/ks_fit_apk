...
final class zaaa implements zaca {
    ...
    static /* bridge */ /* synthetic */ void h(zaaa zaaaVar, int i2, boolean z2) {
        zaaaVar.zab.zac(i2, z2);
        zaaaVar.zak = null;
        zaaaVar.zaj = null;
    }

    static /* bridge */ /* synthetic */ void i(zaaa zaaaVar, Bundle bundle) {
    ...
    static /* bridge */ /* synthetic */ void j(zaaa zaaaVar) {
        ...
        if (!zaE(zaaaVar.zaj)) {
            ...
            if (zaaaVar.zae.f12737f < zaaaVar.zad.f12737f) {
