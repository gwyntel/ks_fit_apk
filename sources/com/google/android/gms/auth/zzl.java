...
public class zzl {
    ...
    static /* synthetic */ TokenData a(Account account, String str, Bundle bundle, Context context, IBinder iBinder) throws RemoteException, IOException {
    ...
    static /* bridge */ /* synthetic */ Object b(Object obj) throws IOException {
        zzj(obj);
        return obj;
    }
    ...
    static void d(Intent intent) throws URISyntaxException {
        if (intent == null) {
    ...
    public static TokenData zza(final Context context, final Account account, final String str, Bundle bundle, long j2, @Nullable Executor executor) throws GoogleAuthException, IOException {
        ...
        return (TokenData) zzh(context, zzc, new zzk() { // from class: com.google.android.gms.auth.zzg
            ...
            public final Object zza(IBinder iBinder) {
                return zzl.a(account, str, bundle2, context, iBinder);
            }
        }, 0L, null);
    }
