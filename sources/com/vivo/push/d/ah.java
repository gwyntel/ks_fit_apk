...
final class ah extends com.vivo.push.l {
    ...
    protected final void a(com.vivo.push.o oVar) throws PackageManager.NameNotFoundException {
        ...
        int iB = oVar.b();
        if (iB == 2009) {
            com.vivo.push.util.p.a(ClientConfigManagerImpl.getInstance(this.f23178a).isDebug());
            if (com.vivo.push.util.p.a()) {
                com.vivo.push.e.a().i();
                com.vivo.push.util.b bVar = new com.vivo.push.util.b();
                bVar.a(this.f23178a, "com.vivo.push_preferences.hybridapptoken_v1");
                bVar.a();
                com.vivo.push.util.b bVar2 = new com.vivo.push.util.b();
                bVar2.a(this.f23178a, "com.vivo.push_preferences.appconfig_v1");
                bVar2.a();
                if (!com.vivo.push.e.a().e()) {
                    ClientConfigManagerImpl.getInstance(this.f23178a).clearPush();
                }
            }
        } else if (iB != 2011) {
            switch (iB) {
            ...
            com.vivo.push.util.p.a(ClientConfigManagerImpl.getInstance(this.f23178a).isDebug(((com.vivo.push.b.w) oVar).d()));
        }
        if (bVarA == null) {
        ...
        com.vivo.push.a.a.a(this.f23178a, strA, oVar);
    }
}
