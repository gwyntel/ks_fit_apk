...
final class p extends z {
    ...
    protected final void a(com.vivo.push.o oVar) throws PackageManager.NameNotFoundException {
        ...
        if (!ClientConfigManagerImpl.getInstance(this.f23178a).isEnablePush()) {
            ...
            map.put(IntentConstant.MESSAGE_ID, String.valueOf(oVar2.f()));
        ...
        if (com.vivo.push.e.a().g() && !a(com.vivo.push.util.z.c(this.f23178a), oVar2.d(), oVar2.i())) {
            com.vivo.push.b.x xVar2 = new com.vivo.push.b.x(1021L);
            HashMap<String, String> map2 = new HashMap<>();
            map2.put(IntentConstant.MESSAGE_ID, String.valueOf(oVar2.f()));
