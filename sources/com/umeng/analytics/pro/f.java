...
public class f {
    ...
    public static final String f21679a = "appkey";
    ...
    public static final String f21680b = "channel";

    /* renamed from: c, reason: collision with root package name */
    public static final String f21681c = "secret";

    /* renamed from: d, reason: collision with root package name */
    public static final String f21682d = "app_version";

    /* renamed from: e, reason: collision with root package name */
    public static final String f21683e = "version_code";

    /* renamed from: f, reason: collision with root package name */
    public static final String f21684f = "wrapper_type";

    /* renamed from: g, reason: collision with root package name */
    public static final String f21685g = "wrapper_version";

    /* renamed from: h, reason: collision with root package name */
    public static final String f21686h = "sdk_version";

    /* renamed from: i, reason: collision with root package name */
    public static final String f21687i = "vertical_type";

    /* renamed from: j, reason: collision with root package name */
    public static final String f21688j = "device_id";

    /* renamed from: k, reason: collision with root package name */
    public static final String f21689k = "device_model";

    /* renamed from: l, reason: collision with root package name */
    public static final String f21690l = "$pr_ve";

    /* renamed from: m, reason: collision with root package name */
    public static final String f21691m = "$ud_da";

    /* renamed from: n, reason: collision with root package name */
    public static final String f21692n = "sessions";

    /* renamed from: o, reason: collision with root package name */
    public static final String f21693o = "id";

    /* renamed from: p, reason: collision with root package name */
    public static final String f21694p = "start_time";

    /* renamed from: q, reason: collision with root package name */
    public static final String f21695q = "end_time";

    /* renamed from: r, reason: collision with root package name */
    public static final String f21696r = "duration";

    /* renamed from: s, reason: collision with root package name */
    public static final String f21697s = "duration_old";

    /* renamed from: t, reason: collision with root package name */
    public static final String f21698t = "pages";

    /* renamed from: u, reason: collision with root package name */
    public static final String f21699u = "autopages";

    /* renamed from: v, reason: collision with root package name */
    public static final String f21700v = "page_name";

    /* renamed from: w, reason: collision with root package name */
    public static final String f21701w = "duration";

    /* renamed from: x, reason: collision with root package name */
    public static final String f21702x = "page_start";

    /* renamed from: y, reason: collision with root package name */
    public static final String f21703y = "type";

    /* renamed from: z, reason: collision with root package name */
    public static final String f21704z = "$page_num";
    public static final String ar = ay.b().b("bl");
    public static final String as = ay.b().b(ay.f21386u);
    ...
    public static final String[] aN = {ay, az, "_$!du", "_$!c", ae, "_$!sp", MeasurementEvent.MEASUREMENT_EVENT_NAME_KEY, "token", "time", "ip", "country", "region", "city", "browser", "os", bc.F, "device_version", bc.ai, "screen_width", "screen_height", "referrer", "referrer_domain", "initial_referrer", "initial_referrer_domain", "initial_view_time", "search_engine", "keyword", "ali_lib", "utm_source", "utm_medium", "utm_term", "utm_content", "utm_campaign", "date", "hour", "minute", "app_version", KsProperty.Sp};
}
