...
public class UMProcessDBDatasSender implements UMLogDataProtocol {
    ...
    private class ReplaceCallback implements FileLockCallback {
        ...
        public boolean onFileLock(String str) throws Throwable {
            ...
            String str2 = a.f21976c;
            if (str.startsWith(str2)) {
                str = str.replaceFirst(str2, "");
            }
            UMProcessDBHelper.getInstance(UMProcessDBDatasSender.this.mContext).deleteEventDatas(str.replace(a.f21977d, ""), null, null);
            return true;
        }
    }
    ...
    private int defconProcesserHandler() throws Throwable {
        ...
        if (iA != 0) {
            ...
            UMProcessDBHelper.getInstance(this.mContext).deleteEventDatas(a.f21981h, null, null);
        }
        return iA;
    }
    ...
    private JSONObject generalHeader() {
        ...
        try {
            ...
            jSONObject.put(f.f21687i, AnalyticsConfig.getVerticalType(this.mContext));
            String str2 = "9.7.4.1+000";
            if (AnalyticsConfig.getVerticalType(this.mContext) == 1) {
                ...
                jSONObject.put("sdk_version", "9.7.4.1+000");
            }
            ...
            SharedPreferences sharedPreferences = PreferenceWrapper.getDefault(this.mContext);
            jSONObject.put(f.f21690l, UMEnvelopeBuild.imprintProperty(this.mContext, "pr_ve", null));
            jSONObject.put(f.f21691m, UMEnvelopeBuild.imprintProperty(this.mContext, "ud_da", null));
            jSONObject.put(f.an, "1.0.0");
            if (TextUtils.isEmpty(strImprintProperty)) {
                jSONObject.put(f.f21690l, sharedPreferences.getString("vers_pre_version", "0"));
                jSONObject.put(f.f21691m, sharedPreferences.getString("vers_date", new SimpleDateFormat(CalendarUtils.yyyy_MM_dd, Locale.getDefault()).format(new Date(System.currentTimeMillis()))));
            }
        } catch (Throwable th) {
            th.printStackTrace();
        }
