...
class c extends X509ExtendedTrustManager {
    ...
    private static TrustManager[] f22987a;
    ...
    static synchronized TrustManager[] getTrustManagers() {
        try {
            if (f22987a == null) {
                f22987a = new TrustManager[]{new c()};
            }
        } catch (Throwable th) {
            throw th;
        }
    ...
    public void checkClientTrusted(X509Certificate[] x509CertificateArr, String str) throws CertificateException {
        com.umeng.ut.a.c.e.m85a("UtExtendTrustManager", "checkClientTrusted1");
    }
    ...
    public void checkServerTrusted(X509Certificate[] x509CertificateArr, String str) throws NoSuchAlgorithmException, KeyStoreException, CertificateException {
        com.umeng.ut.a.c.e.m85a("UtExtendTrustManager", "checkServerTrusted1");
    ...
    public void checkClientTrusted(X509Certificate[] x509CertificateArr, String str, Socket socket) throws CertificateException {
        com.umeng.ut.a.c.e.m85a("UtExtendTrustManager", "checkClientTrusted2");
        if (x509CertificateArr == null || x509CertificateArr.length == 0) {
    ...
    public void checkClientTrusted(X509Certificate[] x509CertificateArr, String str, SSLEngine sSLEngine) throws CertificateException {
        com.umeng.ut.a.c.e.m85a("UtExtendTrustManager", "checkClientTrusted3");
    }

    @Override // javax.net.ssl.X509ExtendedTrustManager
    public void checkServerTrusted(X509Certificate[] x509CertificateArr, String str, Socket socket) throws CertificateException {
        com.umeng.ut.a.c.e.m85a("UtExtendTrustManager", "checkServerTrusted2");
    }

    @Override // javax.net.ssl.X509ExtendedTrustManager
    public void checkServerTrusted(X509Certificate[] x509CertificateArr, String str, SSLEngine sSLEngine) throws CertificateException {
        com.umeng.ut.a.c.e.m85a("UtExtendTrustManager", "checkServerTrusted3");
    }
}
