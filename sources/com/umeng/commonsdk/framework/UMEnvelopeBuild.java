...
public class UMEnvelopeBuild {
    ...
    private static JSONObject add2CacheTable(Context context, JSONObject jSONObject, JSONObject jSONObject2, String str, String str2, String str3) throws JSONException {
        ...
        contentValues.put(bg.f21484e, str2);
        contentValues.put(bg.f21485f, kVarA.c(jSONObject.toString()));
        contentValues.put(bg.f21486g, kVarA.c(jSONObject2.toString()));
        contentValues.put(bg.f21487h, String.valueOf(jCurrentTimeMillis));
        contentValues.put(bg.f21488i, uuidRandomUUID.toString());
        contentValues.put(bg.f21489j, str);
        contentValues.put(bg.f21490k, str3);
        be.a(context).a(bg.f21482c, contentValues);
    ...
    public static JSONObject buildEnvelopeWithExtHeader(Context context, JSONObject jSONObject, JSONObject jSONObject2) {
        return buildEnvelopeWithExtHeader(context, jSONObject, jSONObject2, UMServerURL.PATH_ANALYTICS, jSONObject.has("st") ? "t" : jSONObject2.has(bc.aA) ? "i" : "a", "9.7.4.1+000");
    }
    ...
    */
    ...
    public static JSONObject buildEnvelopeWithExtHeader(Context context, JSONObject jSONObject, JSONObject jSONObject2, String str, String str2, String str3) throws JSONException {
        ...
        if (!UMWorkDispatch.eventHasExist(com.umeng.commonsdk.internal.a.f22256t)) {
            UMWorkDispatch.sendEvent(context, com.umeng.commonsdk.internal.a.f22256t, com.umeng.commonsdk.internal.b.a(context).a(), null);
        }
