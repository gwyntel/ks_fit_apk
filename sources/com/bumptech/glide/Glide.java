...
public class Glide implements ComponentCallbacks2 {
    ...
    Glide(Context context, Engine engine, MemoryCache memoryCache, BitmapPool bitmapPool, ArrayPool arrayPool, RequestManagerRetriever requestManagerRetriever, ConnectivityMonitorFactory connectivityMonitorFactory, int i2, RequestOptionsFactory requestOptionsFactory, Map map, List list, GlideExperiments glideExperiments) {
        ...
        if (i3 >= 28 && glideExperiments.isEnabled(GlideBuilder.EnableImageDecoderForAnimatedWebp.class)) {
            registry2.append("Animation", InputStream.class, Drawable.class, AnimatedWebpDecoder.streamDecoder(imageHeaderParsers, arrayPool));
            registry2.append("Animation", ByteBuffer.class, Drawable.class, AnimatedWebpDecoder.byteBufferDecoder(imageHeaderParsers, arrayPool));
        }
        ...
        registry2.append(ByteBuffer.class, new ByteBufferEncoder()).append(InputStream.class, new StreamEncoder(arrayPool)).append(Registry.BUCKET_BITMAP, ByteBuffer.class, Bitmap.class, byteBufferBitmapImageDecoderResourceDecoder).append(Registry.BUCKET_BITMAP, InputStream.class, Bitmap.class, streamBitmapDecoder);
    ...
    void c(RequestManager requestManager) {
    ...
    void e(RequestManager requestManager) {
        synchronized (this.managers) {
            try {
                if (!this.managers.contains(requestManager)) {
    ...
    private static void initializeGlide(@NonNull Context context, @NonNull GlideBuilder glideBuilder, @Nullable GeneratedAppGlideModule generatedAppGlideModule) {
        ...
        Glide glideA = glideBuilder.a(applicationContext);
        for (GlideModule glideModule : listEmptyList) {
            try {
                glideModule.registerComponents(applicationContext, glideA, glideA.registry);
        ...
        if (generatedAppGlideModule != null) {
            generatedAppGlideModule.registerComponents(applicationContext, glideA, glideA.registry);
        }
        applicationContext.registerComponentCallbacks(glideA);
        glide = glideA;
    }
