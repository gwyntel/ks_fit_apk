...
public class ResourceDrawableDecoder implements ResourceDecoder<Uri, Drawable> {
    ...
    public Resource<Drawable> decode(@NonNull Uri uri, int i2, int i3, @NonNull Options options) {
        ...
        return NonOwnedDrawableResource.a(DrawableDecoderCompat.getDrawable(this.context, contextFindContextForPackage, findResourceIdFromUri(contextFindContextForPackage, uri)));
    }
