...
public final class DefaultImageHeaderParser implements ImageHeaderParser {
    ...
    static final byte[] f12386a = JPEG_EXIF_SEGMENT_PREAMBLE.getBytes(Charset.forName("UTF-8"));
    ...
    private boolean hasJpegExifPreamble(byte[] bArr, int i2) {
        boolean z2 = bArr != null && i2 > f12386a.length;
        if (z2) {
            int i3 = 0;
            while (true) {
                byte[] bArr2 = f12386a;
    ...
    private boolean sniffAvif(Reader reader, int i2) throws IOException {
    ...
    private static int parseExifSegment(RandomAccessReader randomAccessReader) {
        ...
        int iB = randomAccessReader.b(10) + 6;
        short sA2 = randomAccessReader.a(iB);
        for (int i2 = 0; i2 < sA2; i2++) {
            int iCalcTagOffset = calcTagOffset(iB, i2);
            short sA3 = randomAccessReader.a(iCalcTagOffset);
            if (sA3 == 274) {
                short sA4 = randomAccessReader.a(iCalcTagOffset + 2);
                if (sA4 >= 1 && sA4 <= 12) {
                    int iB2 = randomAccessReader.b(iCalcTagOffset + 4);
                    if (iB2 < 0) {
                        if (Log.isLoggable(TAG, 3)) {
                        ...
                        int i3 = iB2 + BYTES_PER_FORMAT[sA4];
                        if (i3 > 4) {
                            if (Log.isLoggable(TAG, 3)) {
