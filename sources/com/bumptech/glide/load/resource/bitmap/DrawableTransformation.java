...
public class DrawableTransformation implements Transformation<Drawable> {
    ...
    public Resource<Drawable> transform(@NonNull Context context, @NonNull Resource<Drawable> resource, int i2, int i3) {
        ...
        Resource<Bitmap> resourceA = DrawableToBitmapConverter.a(bitmapPool, drawable, i2, i3);
        if (resourceA != null) {
            Resource<Bitmap> resourceTransform = this.wrapped.transform(context, resourceA, i2, i3);
            if (!resourceTransform.equals(resourceA)) {
