...
public final class GlideBuilder {
    ...
    Glide a(Context context) {
        ...
        GlideExperiments glideExperimentsC = this.glideExperimentsBuilder.c();
        return new Glide(context, this.engine, this.memoryCache, this.bitmapPool, this.arrayPool, new RequestManagerRetriever(this.requestManagerFactory, glideExperimentsC), this.connectivityMonitorFactory, this.logLevel, this.defaultRequestOptionsFactory, this.defaultTransitionOptions, this.defaultRequestListeners, glideExperimentsC);
    }
    ...
    void b(RequestManagerRetriever.RequestManagerFactory requestManagerFactory) {
    ...
    public GlideBuilder setEnableImageDecoderForAnimatedWebp(boolean z2) {
        this.glideExperimentsBuilder.d(new EnableImageDecoderForAnimatedWebp(), z2);
        return this;
    }

    public GlideBuilder setImageDecoderEnabledForBitmaps(boolean z2) {
        this.glideExperimentsBuilder.d(new EnableImageDecoderForBitmaps(), z2 && Build.VERSION.SDK_INT >= 29);
        return this;
    }
    ...
    public GlideBuilder setLogRequestOrigins(boolean z2) {
        this.glideExperimentsBuilder.d(new LogRequestOrigins(), z2);
        return this;
    }
