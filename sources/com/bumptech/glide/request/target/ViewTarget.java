...
public abstract class ViewTarget<T extends View, Z> extends BaseTarget<Z> {
    ...
    static final class SizeDeterminer {
        ...
        private static int getMaxDisplayLength(@NonNull Context context) {
            if (f12432b == null) {
                ...
                f12432b = Integer.valueOf(Math.max(point.x, point.y));
            }
            return f12432b.intValue();
        }
        ...
        private int getTargetDimen(int i2, int i3, int i4) {
            ...
            if (this.f12433a && this.view.isLayoutRequested()) {
                return 0;
            }
            int i6 = i2 - i4;
            if (i6 > 0) {
    ...
    public ViewTarget(@NonNull T t2) {
        this.f12430a = (View) Preconditions.checkNotNull(t2);
        this.sizeDeterminer = new SizeDeterminer(t2);
    }

    @Nullable
    private Object getTag() {
        return this.f12430a.getTag(tagId);
    }
    ...
    private void maybeAddAttachStateListener() {
        ...
        this.f12430a.addOnAttachStateChangeListener(onAttachStateChangeListener);
    ...
    private void maybeRemoveAttachStateListener() {
        ...
        this.f12430a.removeOnAttachStateChangeListener(onAttachStateChangeListener);
        this.isAttachStateListenerAdded = false;
    }

    private void setTag(@Nullable Object obj) {
        isTagUsedAtLeastOnce = true;
        this.f12430a.setTag(tagId, obj);
    }
    ...
    public String toString() {
        return "Target for: " + this.f12430a;
    }

    @NonNull
    public final ViewTarget<T, Z> waitForLayout() {
        this.sizeDeterminer.f12433a = true;
        return this;
    }
