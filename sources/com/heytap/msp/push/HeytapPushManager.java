...
public class HeytapPushManager {
    ...
    public static void init(Context context, boolean z2) throws PackageManager.NameNotFoundException {
    ...
    public static void setPushTime(List<Integer> list, int i2, int i3, int i4, int i5, JSONObject jSONObject) throws JSONException, IllegalArgumentException {
    ...
    public static void setPushTime(List<Integer> list, int i2, int i3, int i4, int i5) throws JSONException, IllegalArgumentException {
