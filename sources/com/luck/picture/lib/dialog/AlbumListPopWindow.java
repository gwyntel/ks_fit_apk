...
public class AlbumListPopWindow extends PopupWindow {
    ...
    public void changeSelectedAlbumStyle() {
        ...
        for (int i2 = 0; i2 < albumList.size(); i2++) {
            ...
            for (int i3 = 0; i3 < this.selectorConfig.getSelectCount(); i3++) {
                if (TextUtils.equals(localMediaFolder.getFolderName(), this.selectorConfig.getSelectedResult().get(i3).getParentFolderName()) || localMediaFolder.getBucketId() == -1) {
