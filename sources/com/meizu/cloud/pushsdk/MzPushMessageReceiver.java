...
public abstract class MzPushMessageReceiver extends BroadcastReceiver {
    ...
    class a implements Runnable {
        ...
        final /* synthetic */ Intent f19161b;
        ...
        public void run() {
            if (!MzPushMessageReceiver.bInitLog) {
                ...
                DebugLogger.init(this.f19160a);
            }
            MzPushMessageReceiver.this.onHandleIntent(this.f19160a, this.f19161b);
        }
    }

    class b extends com.meizu.cloud.pushsdk.handler.a {
        b() {
        }
