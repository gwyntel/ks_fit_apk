...
public class PushManager {
    ...
    public static void enableCacheRequest(Context context, boolean z2) {
        com.meizu.cloud.pushsdk.platform.c.b.a(context).a(z2);
    }

    public static String getPushId(Context context) {
        int i2 = com.meizu.cloud.pushsdk.util.b.i(context, context.getPackageName());
    ...
    public static void register(Context context) {
        ...
        String packageName = PushConstants.PUSH_PACKAGE_NAME;
        String appVersionName = MzSystemUtils.getAppVersionName(context, PushConstants.PUSH_PACKAGE_NAME);
    ...
    public static void switchPush(Context context, String str, String str2, String str3, int i2, boolean z2) {
        if (MzSystemUtils.isBrandMeizu(context)) {
            com.meizu.cloud.pushsdk.platform.c.b.a(context).a(str, str2, context.getPackageName(), str3, i2, z2);
        } else {
    ...
    public static void switchPush(Context context, String str, String str2, String str3, boolean z2) {
        if (MzSystemUtils.isBrandMeizu(context)) {
            com.meizu.cloud.pushsdk.platform.c.b.a(context).a(str, str2, context.getPackageName(), str3, z2);
        } else {
            DebugLogger.e(TAG, "please invoke switchPush on meizu device Build-in FlymeOS");
        }
    }
