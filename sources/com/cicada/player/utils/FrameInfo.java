...
public class FrameInfo {
    ...
    public enum PixelFormat {
        ...
        AF_PIX_FMT_D3D11(TypedValues.Custom.TYPE_INT),
        AF_PIX_FMT_DXVA2_VLD(TypedValues.Custom.TYPE_FLOAT),
    ...
    @NativeUsed
    private void setSEIData(int i2, byte[] bArr, byte[] bArr2) {
        this.sei_type = i2;
        this.sei_uuid = bArr;
        this.sei_data = bArr2;
    }
    ...
    public String toString() {
        ...
        Object objValueOf = TmpConstant.GROUP_ROLE_UNKNOWN;
        ...
        if (bArr2 != null) {
            objValueOf = Integer.valueOf(bArr2.length);
        }
