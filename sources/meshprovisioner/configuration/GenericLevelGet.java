...
public class GenericLevelGet extends GenericMessageState {
    public static final String TAG = "GenericLevelGet";
    public final byte[] dstAddress;
    public final int mAszmic;

    public GenericLevelGet(Context context, ProvisionedMeshNode provisionedMeshNode, InterfaceC0328c interfaceC0328c, MeshModel meshModel, boolean z2, byte[] bArr, int i2) {
    ...
    private void createAccessMessage() {
        ...
        a aVarCreateMeshMessage = this.mMeshTransport.createMeshMessage(this.mProvisionedMeshNode, this.mSrc, this.dstAddress, byteArray, 1, SecureUtils.calculateK4(byteArray), this.mAszmic, 33285, null);
    ...
    public void executeSend() {
        q qVar;
        a.a.a.a.b.m.a.a(TAG, "Sending Generic Level get");
        super.executeSend();
        if (this.mPayloads.isEmpty() || (qVar = this.mMeshStatusCallbacks) == null) {
            return;
        }
        qVar.onGenericLevelGetSent(this.mProvisionedMeshNode);
    }
