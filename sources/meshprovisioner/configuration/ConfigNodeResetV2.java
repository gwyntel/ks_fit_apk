...
public class ConfigNodeResetV2 extends ConfigMessageState {
    public static final String TAG = ConfigNodeReset.class.getSimpleName();
    public final int mAszmic;

    public ConfigNodeResetV2(Context context, ProvisionedMeshNode provisionedMeshNode, boolean z2, InterfaceC0328c interfaceC0328c) {
    ...
    private void createAccessMessage() {
        a aVarA = i.c().a(this.mProvisionedMeshNode, this.mSrc, this.mProvisionedMeshNode.getDeviceKey(), 0, 0, this.mAszmic, 32841, null);
        this.message = aVarA;
