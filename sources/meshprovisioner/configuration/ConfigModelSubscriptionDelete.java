...
public final class ConfigModelSubscriptionDelete extends ConfigMessageState {
    ...
    public ConfigModelSubscriptionDelete(Context context, ProvisionedMeshNode provisionedMeshNode, InterfaceC0328c interfaceC0328c, int i2, byte[] bArr, byte[] bArr2, int i3) {
    ...
    private void createAccessMessage() {
        ...
        a aVarCreateMeshMessage = this.mMeshTransport.createMeshMessage(this.mProvisionedMeshNode, this.mSrc, this.mProvisionedMeshNode.getDeviceKey(), 0, 0, this.mAszmic, 32796, bArrArray);
    ...
    public final void executeSend() {
        q qVar;
        a.a.a.a.b.m.a.a(TAG, "Sending config model subscription delete");
        super.executeSend();
