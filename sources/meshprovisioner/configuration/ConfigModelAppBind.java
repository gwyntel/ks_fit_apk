...
public final class ConfigModelAppBind extends ConfigMessageState {
    ...
    public static final String TAG = "ConfigModelAppBind";
    ...
    public ConfigModelAppBind(Context context, ProvisionedMeshNode provisionedMeshNode, InterfaceC0328c interfaceC0328c, int i2, byte[] bArr, int i3, int i4) {
    ...
    private void createAccessMessage() {
        ...
        a aVarCreateMeshMessage = this.mMeshTransport.createMeshMessage(this.mProvisionedMeshNode, this.mSrc, this.mProvisionedMeshNode.getDeviceKey(), 0, 0, this.mAszmic, 32829, bArrArray);
    ...
    public final void executeSend() {
        q qVar;
        a.a.a.a.b.m.a.a(TAG, "Sending config app bind");
        super.executeSend();
        if (this.mPayloads.isEmpty() || (qVar = this.mMeshStatusCallbacks) == null) {
            return;
        }
        qVar.onAppKeyBindSent(this.mProvisionedMeshNode);
    }
