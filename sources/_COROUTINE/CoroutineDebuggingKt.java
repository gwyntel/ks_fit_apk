...
public final class CoroutineDebuggingKt {
    ...
    public static final StackTraceElement artificialFrame(Throwable th, String str) {
        ...
        return new StackTraceElement(ARTIFICIAL_FRAME_PACKAGE_NAME + '.' + str, OpenAccountUIConstants.UNDER_LINE, stackTraceElement.getFileName(), stackTraceElement.getLineNumber());
    }
